...
!function(){function e(e,r,t,n,a){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}},d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],l=p?"bdAccessToken":"bdDashAccessToken";"localhost"===e.$$host&&(l+="_dev");var f=function(e,r,t,s){if(console.log("Token prop"+l),accessToken=a.localStorage.getItem(l),console.log(accessToken),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](r).success(function(r){console.log(e+" was a success:"),console.log(r),t&&t(r),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),s&&s(e)})},g=function(e,t,n){var s=c.headers,o=a.localStorage.getItem(l);o&&(s.Authorization="Bearer "+o);var i={method:e,url:c.url+t,headers:s};if(n){var u="POST"==e?"data":"params";i[u]=n}return r(i)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},P=function(e){return g("POST","/api/passwordreset",e)},O=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],a=s(t);a&&(r+="-"+a+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var b=function(e){console.log("CREATING THUMB!!!");var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),a=[],s=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<s.length;i++)a.push(o(s[i],n));return t.all(a).then(function(e){console.log("ALL PROMISES"),u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},_=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),g("POST",r,e)},E=function(e){return g("DELETE","/api/users/current/addresses/"+e)},S=function(e){return g("POST","/api/users/current/jeans",e)},w=function(){return g("GET","/api/users/current")},v=function(){return g("GET","/api/users/current/jeans")},C=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),g("GET",r)},k=function(e){return g("POST","/api/users/current",e)},v=function(){return g("GET","/api/users/current/jeans")},y=function(e){return g("DELETE","/api/users/current/jeans/"+e)},G=function(e){return g("POST","/api/users/current/orders",e)},$=function(){return g("GET","/api/users/current/cc")},I=function(e){return g("POST","/api/users/current/cc",e)},M=function(e){return g("POST","/api/users/current/fitmatch",e)},D=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),g("POST",r,e)},j=function(e){return g("GET","/api/users",e)},A=function(e){return g("GET","/api/users/"+e)},L=function(e){return g("DELETE","/api/users/"+e)},q=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},z=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},J=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},R=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},U=function(e){return g("GET","/api/users/"+e+"/cc")},x=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),g("POST",r,e)},H=function(e){return g("GET","/api/orders",e)},X=function(e){return g("GET","/api/orders/"+e)},B=function(e){return g("DELETE","/api/orders/"+e)},F=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),g("POST",r,e)},N=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},W=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),g("POST",r,e.address)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},K=function(e){return g("POST","/api/swipe",e)},Q=function(e){return g("GET","/api/fitmatchrequests",e)},V=function(e){return g("GET","/api/fitmatchrequests/"+e)},Y=function(e){return g("DELETE","/api/fitmatchrequests/"+e)},ee=function(e){var r="/api/fitmatchrequests";return e.id&&(r+="/"+e.id),g("POST",r,e)},re=function(e){return g("POST","/api/fitmatchrequests/"+e.fitmatchId+"/charge",e)},te={};te.loaded=!1;var ne=function(e){g("GET","/api/data").then(function(r){for(key in r.data)r.data.hasOwnProperty(key)&&(te[key]=r.data[key]);te.belt_loop_options=[{id:1,label:"Centered"},{id:2,label:"Split"},{id:3,label:"X-Pattern"}],te.payment_statuses=[{id:1,label:"Awaiting Payment"},{id:2,label:"Paid"},{id:3,label:"Comped"}],te.pocket_options=[{id:1,label:"Normal"},{id:2,label:"Watch Pocket"},{id:3,label:"Fake Pocket"}],te.lookup=function(e,r,t,n){var a=this[e];if(a){n=n||!1;for(var s=0;s<a.length;s++)if(a[s][r]==t)return n?a[s][n]:a[s]}},te.loaded=!0,e&&e(te)})};return{getData:function(){return te},getAppData:ne,call:f,login:h,register:m,getResetToken:T,resetPassword:P,getJean:O,createThumb:b,getDataCode:getDataCode,getCurrentUser:w,createMyJeans:S,getMyOrders:C,getMyJeans:v,updateMe:k,postMyAddress:_,deleteMyJean:y,deleteMyAddress:E,placeMyOrder:G,getMyCreditCards:$,createMyCreditCard:I,createMyFitMatch:M,postOrderItem:D,usersList:j,userGet:A,usersCreateCreditCard:R,usersGetUserCreditCards:U,usersDelete:L,usersCreateJean:z,usersCreateAddress:q,usersCreateOrder:J,usersPost:x,ordersPost:F,ordersList:H,orderGet:X,ordersDelete:B,ordersCharge:N,postAddress:W,commentsCreate:Z,swipeCallback:K,fitmatchList:Q,fitmatchGet:V,fitmatchDelete:Y,fitmatchPost:ee,fitmatchCharge:re}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
