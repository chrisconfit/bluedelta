...
!function(){function e(e,t,o){function n(e,o){t.localStorage.setItem(l,e.access_token),d(function(e){t.localStorage.setItem(a,e.role_id),t.localStorage.setItem(c,e.id),o&&o(e)})}var r="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],a=r?"bdUserRole":"bdDashUserRole";"localhost"==e.$$host&&(a+="_dev");var l=r?"bdAccessToken":"bdDashAccessToken";"localhost"==e.$$host&&(l+="_dev");var c=r?"bdUserId":"bdDashUserId";"localhost"==e.$$host&&(c+="_dev");var s={},i=function(){return parseInt(t.localStorage.getItem(a))>1},u=function(){return!!t.localStorage.getItem(l)},f=function(){return t.localStorage.getItem(l)},g=function(e,t){if(null==e)return!1;if("object"==typeof e){var o=e;for(obKey in o)o.hasOwnProperty(obKey)&&(s[obKey]=e[obKey])}else s[e]=t;return s},d=function(e){o.call("getCurrentUser",{},function(o){t.localStorage.setItem(a,o.role_id),g(o),e&&e(o)})},m=function(e,t,r,a){var l={username:e,password:t};o.call("login",l,function(e){n(e,r)},function(e){a&&a(e)})},$=function(e,t,r,a,l,c){var s={email:e,password:t,first_name:r,last_name:a};o.call("register",s,function(e){n(e,l)},function(e){c&&c(e)})},h=function(e,t,n){o.call("getResetToken",e,function(e){t(e)},function(e){n&&n(e)})},v=function(e,t,n){o.call("resetPassword",e,function(e){t(e)},function(e){n&&n(e)})},I=function(o,n){t.localStorage.removeItem(l),t.localStorage.removeItem(a),t.localStorage.removeItem(c),s={},o&&o(),n!==!1&&e.path("/login")},p=function(e,t,n){o.call("updateMe",e,t,n)};return{get:function(){return s},isLoggedIn:u,isAdmin:i,set:g,login:m,register:$,update:p,logout:I,setup:d,getToken:f,getResetToken:h,resetPassword:v}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
