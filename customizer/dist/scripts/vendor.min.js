...
!function(){function e(e,r,n,t){var o={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}},s=["login","register","forgotPassword"],c=function(e,r,o,c){if(accessToken=t.localStorage.getItem("bdAccessToken"),s.indexOf(e)<0&&!accessToken){var a="Request being made with no access token.",i=new Error(a);throw i}this[e](r).success(function(e){o&&o(e),n.$$phase||n.$apply()}).error(function(e,r,n){console.log(e.message),c&&c(e)})},a=function(r,n,s){var c=o.headers,a=t.localStorage.getItem("bdAccessToken");a&&(c.Authorization="Bearer "+a),console.log(c),console.log(s);var i={method:r,url:o.url+n,headers:c,data:s};return console.log(i),e(i)},i=function(e){return a("POST","/api/login",e)},u=function(e){return a("POST","/api/register",e)},l=function(e){return a("POST","/api/users/current/jeans",e)},p=function(){return a("GET","/api/users/current")},g=function(){return a("GET","/api/users/current/jeans")},d=function(){return a("GET","/api/users/current/orders")},f=function(e){return a("POST","/api/users/current",e)},T=function(e){return a("POST","/api/fabrics",e)},h=function(e){return a("POST","/api/threads",e)};return{call:c,login:i,register:u,createFabric:T,postThread:h,getCurrentUser:p,createMyJeans:l,getMyOrders:d,getMyJeans:g,updateMe:f}}angular.module("api",[]).service("api",e),e.$inject=["$http","$q","$rootScope","$window"]}();
