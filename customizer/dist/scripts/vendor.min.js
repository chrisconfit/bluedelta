...
!function(){function e(e,r,t,n,s){function a(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}};"localhost"==e.$$host&&(c.url="http://bluedelta.local");var d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port,f=p?"bdAccessToken":"bdDashAccessToken",l=function(e,r,t,a){if(accessToken=s.localStorage.getItem(f),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](r).success(function(e){t&&t(e),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),a&&a(e)})},g=function(e,t,n){var a=c.headers,o=s.localStorage.getItem(f);o&&(a.Authorization="Bearer "+o);var i={method:e,url:c.url+t,headers:a};if(n){var u="POST"==e?"data":"params";i[u]=n}return r(i)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},O=function(e){return g("POST","/api/passwordreset",e)},_=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],s=a(t);s&&(r+="-"+s+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var w=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),s=[],a=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<a.length;i++)s.push(o(a[i],n));return t.all(s).then(function(e){u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},P=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),g("POST",r,e)},b=function(e){return g("DELETE","/api/users/current/addresses/"+e)},E=function(e){return g("POST","/api/users/current/jeans",e)},v=function(){return g("GET","/api/users/current")},S=function(){return g("GET","/api/users/current/jeans")},C=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),g("GET",r)},G=function(e){return g("POST","/api/users/current",e)},S=function(){return g("GET","/api/users/current/jeans")},y=function(e){return g("DELETE","/api/users/current/jeans/"+e)},$=function(e){return g("POST","/api/users/current/orders",e)},k=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),g("POST",r,e)},I=function(e){return g("GET","/api/users",e)},j=function(e){return g("GET","/api/users/"+e)},D=function(e){return g("DELETE","/api/users/"+e)},M=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},A=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},L=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},z=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},J=function(e){return g("GET","/api/users/"+e+"/cc")},q=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),g("POST",r,e)},x=function(e){return g("GET","/api/orders",e)},R=function(e){return g("GET","/api/orders/"+e)},U=function(e){return g("DELETE","/api/orders/"+e)},H=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),g("POST",r,e)},X=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},B=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),g("POST",r,e.address)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},F=function(e){return g("POST","/api/swipe",e)},K=function(e){return g("GET","/api/fitmatchrequests",e)},N=function(e){return g("GET","/api/fitmatchrequests/"+e)},Q=function(){r.get("https://api.bluedeltajeans.com/api/data").then(function(e){for(key in e.data)e.data.hasOwnProperty(key)&&(V[key]=e.data[key])})},V={};return V.lookup=function(e,r,t,n){var s=this[e];if(s){n=n||!1;for(var a=0;a<s.length;a++)if(s[a][r]==t)return n?s[a][n]:s[a]}},{getData:function(){return V},getAppData:Q,call:l,login:h,register:m,getResetToken:T,resetPassword:O,getJean:_,createThumb:w,getDataCode:getDataCode,getCurrentUser:v,createMyJeans:E,getMyOrders:C,getMyJeans:S,updateMe:G,postMyAddress:P,deleteMyJean:y,deleteMyAddress:b,placeMyOrder:$,postOrderItem:k,usersList:I,userGet:j,usersCreateCreditCard:z,usersGetUserCreditCards:J,usersDelete:D,usersCreateJean:A,usersCreateAddress:M,usersCreateOrder:L,usersPost:q,ordersPost:H,ordersList:x,orderGet:R,ordersDelete:U,ordersCharge:X,postAddress:B,commentsCreate:Z,swipeCallback:F,fitmatchList:K,fitmatchGet:N}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
!function(){function e(){return{restrict:"EA",template:'<div class="clearfix"><label>Card Number</label>\n    <div id="sq-card-number"></div>\n    <small style="display:block; margin-bottom:10px;" ng-show="errors.cardNumber" class="text-danger">{{errors.cardNumber}}</small>\n    <label>CVV</label>\n    <div id="sq-cvv"></div>\n    <small style="display:block; margin-bottom:10px;" ng-show="errors.cvv" class="text-danger">{{errors.cvv}}</small>\n    <label>Expiration Date</label>\n    <div id="sq-expiration-date"></div>\n    <small style="display:block; margin-bottom:10px;" ng-show="errors.expirationDate" class="text-danger">{{errors.expirationDate}}</small>\n    <label>Postal Code</label>\n    <div id="sq-postal-code"></div>\n    <small style="display:block; margin-bottom:10px;" ng-show="errors.postalCode" class="text-danger">{{errors.postalCode}}</small>\n    <small style="display:block; margin-bottom:10px;" ng-show="errors.request" class="text-danger">{{errors.request}}</small>\n      <button ng-if="!externalControl" class="btn btn-flat btn-primary pull-right"        type="submit" ng-click="requestCardNonce()">Submit</button>\n    </div>',replace:!0,scope:{nonceReceivedCallback:"=",externalControl:"=?"},link:function(e){var a="sandbox-sq0idp-Ix0BKq70y9xTbYuMuBPZkQ",n="sq0idp-Ix0BKq70y9xTbYuMuBPZkQ";n=a;var t="CBASEN9Li-GLHOlc4cpGQaL58MogAQ",r="9PZNFDJTA6SQ4";r=t,console.log("INIT!"),console.log(n,r),e.requestCardNonce=function(){e.errors={},e.paymentForm.requestCardNonce()},e.externalControl&&(e.externalControl=e.requestCardNonce),e.methodsSupported=function(e){if(e.applePay===!0){var a=document.getElementById("sq-apple-pay");a.style.display="inline-block"}},e.createPaymentRequest=function(){return{requestShippingAddress:!0,currencyCode:"USD",countryCode:"US",total:{label:"{{ MERCHANT NAME }}",amount:"{{TOTAL AMOUNT}}",pending:!1},lineItems:[{label:"Subtotal",amount:"{{SUBTOTAL AMOUNT}}",pending:!1},{label:"Shipping",amount:"{{SHIPPING AMOUNT}}",pending:!0},{label:"Tax",amount:"{{TAX AMOUNT}}",pending:!1}]}},e.cardNonceResponseReceived=function(a,n,t){return a?(a.forEach(function(a){e.errors[a.field]=a.message}),void e.$apply()):void e.nonceReceivedCallback(n,function(a){e.errors.request=a.message})},e.unsupportedBrowserDetected=function(){console.log("unsupported browser")},e.inputEventReceived=function(e){switch(e.eventType){case"focusClassAdded":break;case"focusClassRemoved":break;case"errorClassAdded":break;case"errorClassRemoved":break;case"cardBrandChanged":break;case"postalCodeChanged":}},e.paymentFormLoaded=function(){},e.paymentForm=new SqPaymentForm({applicationId:n,locationId:r,inputClass:"sq-input",inputStyles:[{backgroundColor:"#FFFFFF",padding:"6px 12px",fontSize:"14px",lineHeight:"18px"}],cardNumber:{elementId:"sq-card-number",placeholder:"•••• •••• •••• ••••"},cvv:{elementId:"sq-cvv",placeholder:"CVV"},expirationDate:{elementId:"sq-expiration-date",placeholder:"MM/YY"},postalCode:{elementId:"sq-postal-code"},applePay:{elementId:"sq-apple-pay"},callbacks:{methodsSupported:e.methodsSupported,cardNonceResponseReceived:e.cardNonceResponseReceived,unsupportedBrowserDetected:e.unsupportedBrowserDetected,inputEventReceived:e.inputEventReceived,paymentFormLoaded:e.paymentFormLoaded,createPaymentRequest:e.createPaymentRequest}}),e.$evalAsync(function(){e.paymentForm.build()})}}}angular.module("sqPaymentForm",[]).directive("sqPaymentForm",e),e.$inject=[]}();
!function(){function e(e,t,o){function n(e,o){t.localStorage.setItem(c,e.access_token),d(function(e){t.localStorage.setItem(a,e.role_id),t.localStorage.setItem(l,e.id),o&&o(e)})}var r="localhost"==e.$$host&&4e3==e.$$port,a=r?"bdUserRole":"bdDashUserRole",c=r?"bdAccessToken":"bdDashAccessToken",l=r?"bdUserId":"bdDashUserId",i={},s=function(){return t.localStorage.getItem(a)>1},u=function(){return!!t.localStorage.getItem(c)},f=function(){return t.localStorage.getItem(c)},g=function(e,t){if(null==e)return!1;if("object"==typeof e){var o=e;for(obKey in o)o.hasOwnProperty(obKey)&&(i[obKey]=e[obKey])}else i[e]=t;return i},d=function(e){o.call("getCurrentUser",{},function(o){t.localStorage.setItem(a,o.roleId),g(o),e&&e(o)})},m=function(e,t,r,a){var c={username:e,password:t};o.call("login",c,function(e){n(e,r)},function(e){a&&a(e)})},I=function(e,t,r,a,c,l){var i={email:e,password:t,first_name:r,last_name:a};o.call("register",i,function(e){n(e,c)},function(e){l&&l(e)})},b=function(e,t,n){o.call("getResetToken",e,function(e){t(e)},function(e){n&&n(e)})},p=function(e,t,n){o.call("resetPassword",e,function(e){t(e)},function(e){n&&n(e)})},S=function(){t.localStorage.removeItem(c),t.localStorage.removeItem(a),t.localStorage.removeItem(l),i={},e.path("/login")},v=function(e,t,n){o.call("updateMe",e,t,n)};return{get:function(){return i},isLoggedIn:u,isAdmin:s,set:g,login:m,register:I,update:v,logout:S,setup:d,getToken:f,getResetToken:b,resetPassword:p}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
