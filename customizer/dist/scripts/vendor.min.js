...
!function(){function e(e,r,t,n){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function a(e){return r(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function o(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var u={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}},c=["login","register","getResetToken","resetPassword","forgotPassword","getJean"],d=function(e,r,s,a){if(accessToken=n.localStorage.getItem("bdAccessToken"),c.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](r).success(function(e){s&&s(e),t.$$phase||t.$apply()}).error(function(e,r,t){console.log(e),a&&a(e)})},p=function(r,t,s){var a=u.headers,o=n.localStorage.getItem("bdAccessToken");o&&(a.Authorization="Bearer "+o);var i={method:r,url:u.url+t,headers:a};if(s){var c="POST"==r?"data":"params";i[c]=s}return e(i)},f=function(e){return p("POST","/api/login",e)},g=function(e){return p("POST","/api/register",e)},l=function(e){return p("POST","/api/passwordtoken",{email:e})},m=function(e){return p("POST","/api/passwordreset",e)},T=function(e){return p("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],a=s(t);a&&(r+="_"+a+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var h=function(e){var t=document.createElement("canvas");t.width=600,t.height=600;for(var n=t.getContext("2d"),s=[],i=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],u=0;u<i.length;u++)s.push(a(i[u],n));return r.all(s).then(function(e){o("fabrics",n,e),o("tb",n,e),o("tt",n,e),o("ta",n,e);var r=t.toDataURL("image/jpeg");return r},function(e){console.log(e)})},_=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),p("POST",r,e)},w=function(e){return p("DELETE","/api/users/current/addresses/"+e)},E=function(e){return p("POST","/api/users/current/jeans",e)},O=function(){return p("GET","/api/users/current")},b=function(){return p("GET","/api/users/current/jeans")},P=function(){return p("GET","/api/users/current/orders")},v=function(e){return p("POST","/api/users/current",e)},b=function(){return p("GET","/api/users/current/jeans")},P=function(){return p("GET","/api/users/current/orders")},S=function(e){return p("DELETE","/api/users/current/jeans/"+e)},y=function(e){return p("POST","/api/users/current/orders",e)},G=function(e){return p("GET","/api/users",e)},M=function(e){return p("GET","/api/users/"+e)},D=function(e){return p("DELETE","/api/users/"+e)},C=function(e){return p("POST","/api/users/"+e.userId+"/address",e.address)},j=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),p("POST",r,e)},$=function(e){return p("GET","/api/orders",e)},k=function(e){return p("GET","/api/orders/"+e)},z=function(e){return p("DELETE","/api/orders/"+e)},A=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),console.log(r),console.log(e),p("POST",r,e)},I=function(e){return p("POST","/api/users/"+e.userId+"/addresses",e.address)},L=function(e){return p("POST","/api/orders/"+e.orderId+"/comments",e.comment)},J={};return{getData:function(){return J},call:d,login:f,register:g,getResetToken:l,resetPassword:m,getJean:T,createThumb:h,getDataCode:getDataCode,getCurrentUser:O,createMyJeans:E,getMyOrders:P,getMyJeans:b,updateMe:v,postMyAddress:_,getMyJeans:b,getMyOrders:P,deleteMyJean:S,deleteMyAddress:w,placeMyOrder:y,usersList:G,userGet:M,usersDelete:D,usersCreateAddress:C,usersPost:j,ordersPost:A,ordersList:$,orderGet:k,ordersDelete:z,postAddress:I,commentsCreate:L}}angular.module("api",[]).service("api",e),e.$inject=["$http","$q","$rootScope","$window"]}();
