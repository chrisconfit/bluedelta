...
!function(){function e(e,r,n,t){var s={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}},u=["login","register","forgotPassword","getJean"],i=function(e,r,s,i){if(console.log("calling "+e),console.log("with..."),console.log(r),accessToken=t.localStorage.getItem("bdAccessToken"),u.indexOf(e)<0&&!accessToken){var a="Request being made with no access token.",o=new Error(a);throw o}this[e](r).success(function(e){s&&s(e),n.$$phase||n.$apply()}).error(function(e,r,n){console.log(e),i&&i(e)})},a=function(r,n,u){var i=s.headers,a=t.localStorage.getItem("bdAccessToken");a&&(i.Authorization="Bearer "+a);var o={method:r,url:s.url+n,headers:i};if(u){var c="POST"==r?"data":"params";o[c]=u}return e(o)},o=function(e){return a("POST","/api/login",e)},c=function(e){return a("POST","/api/register",e)},d=function(e){return a("GET","/api/jean/"+e)},p=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),a("POST",r,e)},f=function(e){return a("DELETE","/api/users/current/addresses/"+e)},l=function(e){return a("POST","/api/users/current/jeans",e)},T=function(){return a("GET","/api/users/current")},g=function(){return a("GET","/api/users/current/jeans")},E=function(){return a("GET","/api/users/current/orders")},O=function(e){return a("POST","/api/users/current",e)},S=function(e){return a("POST","/api/fabrics",e)},P=function(e){return a("POST","/api/threads",e)},h=function(e){return a("POST","/api/tailors",e)},g=function(){return a("GET","/api/users/current/jeans")},E=function(){return a("GET","/api/users/current/orders")},G=function(e){return a("DELETE","/api/users/current/jeans/"+e)},M=function(e){return a("POST","/api/users/current/orders",e)},m=function(e){return a("GET","/api/users",e)},w=function(e){return a("GET","/api/users/"+e)},y=function(e){return a("DELETE","/api/users/"+e)},v=function(e){return a("POST","/api/users/"+e.userId+"/address",e.address)},$=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),a("POST",r,e)},j=function(e){return a("GET","/api/orders",e)},A=function(e){return a("GET","/api/orders/"+e)},J={};return{getData:function(){return J},call:i,login:o,register:c,createFabric:S,postThread:P,postTailor:h,getJean:d,getCurrentUser:T,createMyJeans:l,getMyOrders:E,getMyJeans:g,updateMe:O,postAddress:p,getMyJeans:g,getMyOrders:E,deleteMyJean:G,deleteAddress:f,placeMyOrder:M,usersList:m,userGet:w,usersDelete:y,usersCreateAddress:v,usersPost:$,ordersList:j,orderGet:A}}angular.module("api",[]).service("api",e),e.$inject=["$http","$q","$rootScope","$window"]}();
!function(){function e(e,o,t){function n(e,t){o.localStorage.setItem("bdAccessToken",e.access_token),s(function(e){o.localStorage.setItem("bdUserRole",e.role_id),o.localStorage.setItem("bdUserId",e.id),t&&t(e)})}var r={},c=function(){return o.localStorage.getItem("bdUserRole")>0},l=function(){return!!o.localStorage.getItem("bdAccessToken")},a=function(){return o.localStorage.getItem("bdAccessToken")},i=function(e,o){if(null==e)return!1;if("object"==typeof e){var t=e;for(obKey in t)t.hasOwnProperty(obKey)&&(r[obKey]=e[obKey])}else r[e]=o;return r},s=function(e){t.call("getCurrentUser",{},function(t){o.localStorage.setItem("userRole",t.roleId),i(t),e&&e(t)})},u=function(e,o,r,c){var l={username:e,password:o};t.call("login",l,function(e){n(e,r)},function(e){c&&c(e)})},g=function(e,o,r,c,l,a){var i={email:e,password:o,first_name:r,last_name:c};t.call("register",i,function(e){n(e,l)},function(e){a&&a(e)})},f=function(){o.localStorage.removeItem("bdAccessToken"),o.localStorage.removeItem("bdUserRole"),o.localStorage.removeItem("bdUserId"),r={},e.path("/login")},d=function(e,o,n){t.call("updateMe",e,o,n)};return{get:function(){return r},isLoggedIn:l,isAdmin:c,set:i,login:u,register:g,update:d,logout:f,setup:s,getToken:a}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
