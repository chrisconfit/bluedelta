...
!function(){function e(e,t,r,n,a){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return r(function(t,r){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){t(n)},n.onerror=function(e){r(e)}})}function u(e,t,r){for(i=0;i<r.length;i++){var n=r[i];n.src.indexOf("/"+e+"/")>-1&&t.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}};"localhost"==e.$$host&&(c.url="http://bluedelta.local");var d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],l=p?"bdAccessToken":"bdDashAccessToken";"localhost"===e.$$host&&(l+="_dev");var f=function(e,t,r,s){if(console.log("Token prop"+l),accessToken=a.localStorage.getItem(l),console.log(accessToken),console.log("calling "+e+" with..."),console.log(t),d.indexOf(e)<0&&!accessToken){var i="Request being made with no access token.",o=new Error(i);throw o}this[e](t).success(function(t){console.log(e+" was a success:"),console.log(t),r&&r(t),n.$$phase||n.$apply()}).error(function(e,t,r){console.log(e),s&&s(e)})},g=function(e,r,n){var s=c.headers,i=a.localStorage.getItem(l);i&&(s.Authorization="Bearer "+i);var o={method:e,url:c.url+r,headers:s};if(n){var u="POST"==e?"data":"params";o[u]=n}return t(o)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},P=function(e){return g("POST","/api/passwordreset",e)},b=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var t="";for(var r in e)if(e.hasOwnProperty(r)){var n=e[r],a=s(r);a&&(t+="-"+a+":"+n)}return t=t.replace(/(^[_\s]+)|([_\s]+$)/g,""),t.replace("-","")};var O=function(e){var t=document.createElement("canvas");t.width=600,t.height=600;for(var n=t.getContext("2d"),a=[],s=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<s.length;i++)a.push(o(s[i],n));return r.all(a).then(function(e){u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var r=t.toDataURL("image/jpeg");return r},function(e){console.log(e)})},_=function(e){var t="/api/users/current/addresses";return e.id&&(t+="/"+e.id),g("POST",t,e)},E=function(e){return g("DELETE","/api/users/current/addresses/"+e)},w=function(e){return g("POST","/api/users/current/jeans",e)},S=function(){return g("GET","/api/users/current")},v=function(){return g("GET","/api/users/current/jeans")},C=function(e){var t="/api/users/current/orders";return e&&(t+="/"+e),g("GET",t)},k=function(e){return g("POST","/api/users/current",e)},v=function(){return g("GET","/api/users/current/jeans")},y=function(e){return g("DELETE","/api/users/current/jeans/"+e)},$=function(e){return g("POST","/api/users/current/orders",e)},G=function(){return g("GET","/api/users/current/cc")},D=function(e){return g("POST","/api/users/current/cc",e)},I=function(e){return g("POST","/api/users/current/fitmatch",e)},M=function(e){var t="/api/orderItem";return e.id&&(t+="/"+e.id),g("POST",t,e)},j=function(e){return g("GET","/api/users",e)},A=function(e){return g("GET","/api/users/"+e)},L=function(e){return g("DELETE","/api/users/"+e)},q=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},z=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},J=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},x=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},R=function(e){return g("GET","/api/users/"+e+"/cc")},U=function(e){var t="/api/users";return e.id&&(t+="/"+e.id),g("POST",t,e)},X=function(e){return g("GET","/api/orders",e)},F=function(e){return g("GET","/api/orders/"+e)},H=function(e){return g("DELETE","/api/orders/"+e)},B=function(e){var t="/api/orders";return e.id&&(t+="/"+e.id),g("POST",t,e)},N=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},W=function(e){var t="/api/users/"+e.userId+"/addresses";return e.address.id&&(t+="/"+e.address.id),g("POST",t,e.address)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},K=function(e){return g("POST","/api/swipe",e)},Q=function(e){return g("GET","/api/fitmatchrequests",e)},V=function(e){return g("GET","/api/fitmatchrequests/"+e)},Y=function(e){return g("DELETE","/api/fitmatchrequests/"+e)},ee=function(e){var t="/api/fitmatchrequests";return e.id&&(t+="/"+e.id),g("POST",t,e)},te=function(e){return g("POST","/api/fitmatchrequests/"+e.fitmatchId+"/charge",e)},re=function(){g("GET","/api/data").then(function(e){for(key in e.data)e.data.hasOwnProperty(key)&&(ne[key]=e.data[key]);ne.belt_loop_options=[{id:1,label:"Centered"},{id:2,label:"Split"},{id:3,label:"X-Pattern"}],ne.payment_statuses=[{id:1,label:"Awaiting Payment"},{id:2,label:"Paid"},{id:3,label:"Comped"}],ne.pocket_options=[{id:1,label:"Normal"},{id:2,label:"Watch Pocket"},{id:3,label:"Fake Pocket"}]})},ne={};return ne.lookup=function(e,t,r,n){var a=this[e];if(a){n=n||!1;for(var s=0;s<a.length;s++)if(a[s][t]==r)return n?a[s][n]:a[s]}},{getData:function(){return ne},getAppData:re,call:f,login:h,register:m,getResetToken:T,resetPassword:P,getJean:b,createThumb:O,getDataCode:getDataCode,getCurrentUser:S,createMyJeans:w,getMyOrders:C,getMyJeans:v,updateMe:k,postMyAddress:_,deleteMyJean:y,deleteMyAddress:E,placeMyOrder:$,getMyCreditCards:G,createMyCreditCard:D,createMyFitMatch:I,postOrderItem:M,usersList:j,userGet:A,usersCreateCreditCard:x,usersGetUserCreditCards:R,usersDelete:L,usersCreateJean:z,usersCreateAddress:q,usersCreateOrder:J,usersPost:U,ordersPost:B,ordersList:X,orderGet:F,ordersDelete:H,ordersCharge:N,postAddress:W,commentsCreate:Z,swipeCallback:K,fitmatchList:Q,fitmatchGet:V,fitmatchDelete:Y,fitmatchPost:ee,fitmatchCharge:te}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
