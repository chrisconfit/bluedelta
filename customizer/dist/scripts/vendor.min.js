...
!function(){function e(e,r,n,t){var o={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}},s=["login","register","forgotPassword"],a=function(e,r,o,a){if(accessToken=t.localStorage.getItem("bdAccessToken"),s.indexOf(e)<0&&!accessToken){var c="Request being made with no access token.",i=new Error(c);throw i}this[e](r).success(function(e){o&&o(e),n.$$phase||n.$apply()}).error(function(e,r,n){console.log(e.message),a&&a(e)})},c=function(r,n,s){var a=o.headers,c=t.localStorage.getItem("bdAccessToken");c&&(a.Authorization="Bearer "+c),console.log(a),console.log(s);var i={method:r,url:o.url+n,headers:a,data:s};return console.log(i),e(i)},i=function(e){return c("POST","/api/login",e)},u=function(e){return c("POST","/api/register",e)},l=function(e){return c("POST","/api/users/current/jeans",e)},p=function(){return c("GET","/api/users/current")},g=function(){return c("GET","/api/users/current/jeans")},f=function(){return c("GET","/api/users/current/orders")},d=function(e){return c("POST","/api/users/current",e)},T=function(e){return c("POST","/api/fabrics",e)},h=function(e){return c("POST","/api/threads",e)},O=function(e){return c("POST","/api/tailors",e)};return{call:a,login:i,register:u,createFabric:T,postThread:h,postTailor:O,getCurrentUser:p,createMyJeans:l,getMyOrders:f,getMyJeans:g,updateMe:d}}angular.module("api",[]).service("api",e),e.$inject=["$http","$q","$rootScope","$window"]}();
!function(){function e(e,o,n){function t(e,n){o.localStorage.setItem("bdAccessToken",e.access_token),s(function(e){o.localStorage.setItem("bdUserRole",e.role_id),n&&n(e)})}var r={},c=function(){return o.localStorage.getItem("bdUserRole")>0},l=function(){return!!o.localStorage.getItem("bdAccessToken")},a=function(){return o.localStorage.getItem("bdAccessToken")},i=function(e,o){if(null==e)return!1;if("object"==typeof e){var n=e;for(obKey in n)n.hasOwnProperty(obKey)&&(r[obKey]=e[obKey])}else r[e]=o;return r},s=function(e){n.call("getCurrentUser",{},function(n){o.localStorage.setItem("userRole",n.roleId),i(n),e&&e(n)})},u=function(e,o,r,c){var l={username:e,password:o};n.call("login",l,function(e){t(e,r)},function(e){c&&c(e)})},g=function(e,o,r,c,l,a){var i={email:e,password:o,first_name:r,last_name:c};console.log("user register"),console.log(i),n.call("register",i,function(e){t(e,l)},function(e){a&&a(e)})},f=function(){o.localStorage.removeItem("bdAccessToken"),o.localStorage.removeItem("bdUserRole"),r={},e.path("/login")},d=function(e,o,t){n.call("updateMe",e,o,t)};return{get:function(){return r},isLoggedIn:l,isAdmin:c,set:i,login:u,register:g,update:d,logout:f,setup:s,getToken:a}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
