...
!function(){function e(e,r,t,n,s){function a(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}};"localhost"==e.$$host&&(c.url="http://bluedelta.local");var d=["login","register","getResetToken","resetPassword","forgotPassword","getJean"],p="localhost"==e.$$host&&4e3==e.$$port,f=p?"bdAccessToken":"bdDashAccessToken",l=function(e,r,t,a){if(accessToken=s.localStorage.getItem(f),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](r).success(function(e){t&&t(e),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),a&&a(e)})},g=function(e,t,n){var a=c.headers,o=s.localStorage.getItem(f);o&&(a.Authorization="Bearer "+o);var i={method:e,url:c.url+t,headers:a};if(n){var u="POST"==e?"data":"params";i[u]=n}return r(i)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},O=function(e){return g("POST","/api/passwordreset",e)},_=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],s=a(t);s&&(r+="-"+s+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var w=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),s=[],a=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<a.length;i++)s.push(o(a[i],n));return t.all(s).then(function(e){u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},P=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),g("POST",r,e)},v=function(e){return g("DELETE","/api/users/current/addresses/"+e)},E=function(e){return g("POST","/api/users/current/jeans",e)},b=function(){return g("GET","/api/users/current")},S=function(){return g("GET","/api/users/current/jeans")},y=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),g("GET",r)},C=function(e){return g("POST","/api/users/current",e)},S=function(){return g("GET","/api/users/current/jeans")},$=function(e){return g("DELETE","/api/users/current/jeans/"+e)},G=function(e){return g("POST","/api/users/current/orders",e)},k=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),g("POST",r,e)},D=function(e){return g("GET","/api/users",e)},I=function(e){return g("GET","/api/users/"+e)},M=function(e){return g("DELETE","/api/users/"+e)},j=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},z=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},A=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},J=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},L=function(e){return g("GET","/api/users/"+e+"/cc")},x=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),g("POST",r,e)},R=function(e){return g("GET","/api/orders",e)},U=function(e){return g("GET","/api/orders/"+e)},q=function(e){return g("DELETE","/api/orders/"+e)},H=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),g("POST",r,e)},X=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),g("POST",r,e.address)},B=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},Z=function(){r.get("http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com/api/data").then(function(e){for(key in e.data)e.data.hasOwnProperty(key)&&(F[key]=e.data[key])})},F={};return F.lookup=function(e,r,t,n){var s=this[e];if(s){n=n||!1;for(var a=0;a<s.length;a++)if(s[a][r]==t)return n?s[a][n]:s[a]}},{getData:function(){return F},getAppData:Z,call:l,login:h,register:m,getResetToken:T,resetPassword:O,getJean:_,createThumb:w,getDataCode:getDataCode,getCurrentUser:b,createMyJeans:E,getMyOrders:y,getMyJeans:S,updateMe:C,postMyAddress:P,getMyJeans:S,getMyOrders:y,deleteMyJean:$,deleteMyAddress:v,placeMyOrder:G,postOrderItem:k,usersList:D,userGet:I,usersCreateCreditCard:J,usersGetUserCreditCards:L,usersDelete:M,usersCreateJean:z,usersCreateAddress:j,usersCreateOrder:A,usersPost:x,ordersPost:H,ordersList:R,orderGet:U,ordersDelete:q,postAddress:X,commentsCreate:B}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
!function(){function e(){return{restrict:"EA",template:'<div><label>Card Number</label>\n    <div id="sq-card-number"></div>\n    <label>CVV</label>\n    <div id="sq-cvv"></div>\n    <label>Expiration Date</label>\n    <div id="sq-expiration-date"></div>\n    <label>Postal Code</label>\n    <div id="sq-postal-code"></div>\n    <form id="nonce-form" novalidate method="post">\n    <input type="hidden" id="card-nonce" name="nonce">\n      <input type="submit" ng-click="requestCardNonce($event)">\n    </form></div>',replace:!0,scope:{nonceReceivedCallback:"="},link:function(e){var n="sq0idp-Ix0BKq70y9xTbYuMuBPZkQ",a="9PZNFDJTA6SQ4";e.methodsSupported=function(e){if(e.applePay===!0){var n=document.getElementById("sq-apple-pay");n.style.display="inline-block"}},e.createPaymentRequest=function(){return{requestShippingAddress:!0,currencyCode:"USD",countryCode:"US",total:{label:"{{ MERCHANT NAME }}",amount:"{{TOTAL AMOUNT}}",pending:!1},lineItems:[{label:"Subtotal",amount:"{{SUBTOTAL AMOUNT}}",pending:!1},{label:"Shipping",amount:"{{SHIPPING AMOUNT}}",pending:!0},{label:"Tax",amount:"{{TAX AMOUNT}}",pending:!1}]}},e.cardNonceResponseReceived=function(n,a,t){return n?(console.log("Encountered errors:"),void n.forEach(function(e){console.log("  "+e.message)})):void e.nonceReceivedCallback(a)},e.unsupportedBrowserDetected=function(){console.log("unsupported browser")},e.inputEventReceived=function(e){switch(e.eventType){case"focusClassAdded":break;case"focusClassRemoved":break;case"errorClassAdded":break;case"errorClassRemoved":break;case"cardBrandChanged":break;case"postalCodeChanged":}},e.paymentFormLoaded=function(){},e.paymentForm=new SqPaymentForm({applicationId:n,locationId:a,inputClass:"sq-input",cardNumber:{elementId:"sq-card-number",placeholder:"•••• •••• •••• ••••"},cvv:{elementId:"sq-cvv",placeholder:"CVV"},expirationDate:{elementId:"sq-expiration-date",placeholder:"MM/YY"},postalCode:{elementId:"sq-postal-code"},applePay:{elementId:"sq-apple-pay"},callbacks:{methodsSupported:e.methodsSupported,createPaymentRequest:e.createPaymentRequest,cardNonceResponseReceived:e.cardNonceResponseReceived,unsupportedBrowserDetected:e.unsupportedBrowserDetected,inputEventReceived:e.inputEventReceived,paymentFormLoaded:e.paymentFormLoaded}}),e.$evalAsync(function(){e.paymentForm.build()}),e.requestCardNonce=function(n){n.preventDefault(),e.paymentForm.requestCardNonce()}}}}angular.module("sqPaymentForm",[]).directive("sqPaymentForm",e),e.$inject=[]}();
