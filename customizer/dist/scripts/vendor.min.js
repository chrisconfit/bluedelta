...
!function(){function e(e,t,r,n){var o={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/form-data; charset=UTF-8"}},c=function(e,t,o,c){if(accessToken=n.localStorage.getItem("bdAccessToken"),!accessToken){var a="Request being made with no access token.",s=new Error(a);throw s}this[e](t).success(function(e){o&&o(e),r.$$phase||r.$apply()}).error(function(e,t,r){console.log(e.message),c&&c(e)})},a=function(t,r,c){var a=o.headers;a.Authorization="Bearer "+n.localStorage.getItem("bdAccessToken");var s={method:t,url:o.url+r,headers:a};return e(s,c)},s=function(t,r){return postData={username:t,password:r,scope:"",grant_type:"password",client_id:o.client_id,client_secret:o.client_secret},e.post(o.url+"/oauth/token",postData)},i=function(){return a("GET","/api/users/current")};return{call:c,login:s,getCurrentUser:i}}angular.module("api",[]).service("api",e),e.$inject=["$http","$q","$rootScope","$window"]}();
!function(){function e(e,o,n){var t={},c=function(){console.log("IS ADMIN"),console.log(o.localStorage),console.log(o.localStorage.getItem("userRole"))},l=function(){return!!o.localStorage.getItem("bdAccessToken")},r=function(e,o){if(null==e)return!1;if("object"==typeof e){var n=e;for(obKey in n)n.hasOwnProperty(obKey)&&(t[obKey]=e[obKey])}else t[e]=o;return t},s=function(e){n.call("getCurrentUser",{},function(n){o.localStorage.setItem("userRole",n.roleId),r(n),e&&e(n)})},u=function(e,t,c,l){n.login(e,t).success(function(e){o.localStorage.setItem("bdAccessToken",e.access_token),s(c)}).error(function(e){console.log(e),l&&l(e)})},i=function(){o.localStorage.removeItem("bdAccessToken"),o.localStorage.removeItem("userRole"),t={},e.path("/login")};return{get:function(){return t},isLoggedIn:l,isAdmin:c,set:r,login:u,logout:i,setup:s}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
