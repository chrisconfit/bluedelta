...
!function(){function e(e,r,n,t){var s={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}},u=["login","register","forgotPassword","getJean"],a=function(e,r,s,a){if(console.log("calling "+e),console.log("with..."),console.log(r),accessToken=t.localStorage.getItem("bdAccessToken"),u.indexOf(e)<0&&!accessToken){var i="Request being made with no access token.",o=new Error(i);throw o}this[e](r).success(function(e){s&&s(e),n.$$phase||n.$apply()}).error(function(e,r,n){console.log(e),a&&a(e)})},i=function(r,n,u){var a=s.headers,i=t.localStorage.getItem("bdAccessToken");i&&(a.Authorization="Bearer "+i);var o={method:r,url:s.url+n,headers:a};if(u){var c="POST"==r?"data":"params";o[c]=u}return console.log(o),e(o)},o=function(e){return i("POST","/api/login",e)},c=function(e){return i("POST","/api/register",e)},d=function(e){return i("GET","/api/jean/"+e)},p=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),i("POST",r,e)},l=function(e){return i("DELETE","/api/users/current/addresses/"+e)},f=function(e){return i("POST","/api/users/current/jeans",e)},T=function(){return i("GET","/api/users/current")},g=function(){return i("GET","/api/users/current/jeans")},E=function(){return i("GET","/api/users/current/orders")},O=function(e){return i("POST","/api/users/current",e)},S=function(e){return i("POST","/api/fabrics",e)},P=function(e){return i("POST","/api/threads",e)},h=function(e){return i("POST","/api/tailors",e)},g=function(){return i("GET","/api/users/current/jeans")},E=function(){return i("GET","/api/users/current/orders")},G=function(e){return i("DELETE","/api/users/current/jeans/"+e)},M=function(e){return i("POST","/api/users/current/orders",e)},m=function(e){return i("GET","/api/users",e)},w=function(e){return i("GET","/api/users/"+e)},y=function(e){return i("DELETE","/api/users/"+e)},v=function(e){return i("POST","/api/users/"+e.userId+"/address",e.address)},$=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),i("POST",r,e)},j=function(e){return i("GET","/api/orders",e)},A={};return{getData:function(){return A},call:a,login:o,register:c,createFabric:S,postThread:P,postTailor:h,getJean:d,getCurrentUser:T,createMyJeans:f,getMyOrders:E,getMyJeans:g,updateMe:O,postAddress:p,getMyJeans:g,getMyOrders:E,deleteMyJean:G,deleteAddress:l,placeMyOrder:M,usersList:m,userGet:w,usersDelete:y,usersCreateAddress:v,usersPost:$,ordersList:j}}angular.module("api",[]).service("api",e),e.$inject=["$http","$q","$rootScope","$window"]}();
!function(){function e(e,o,t){function n(e,t){o.localStorage.setItem("bdAccessToken",e.access_token),i(function(e){o.localStorage.setItem("bdUserRole",e.role_id),o.localStorage.setItem("bdUserId",e.id),t&&t(e)})}var r={},l=function(){return o.localStorage.getItem("bdUserRole")>0},c=function(){return!!o.localStorage.getItem("bdAccessToken")},a=function(){return o.localStorage.getItem("bdAccessToken")},s=function(e,o){if(null==e)return!1;if("object"==typeof e){var t=e;for(obKey in t)t.hasOwnProperty(obKey)&&(r[obKey]=e[obKey])}else r[e]=o;return r},i=function(e){t.call("getCurrentUser",{},function(t){o.localStorage.setItem("userRole",t.roleId),s(t),e&&e(t)})},u=function(e,o,r,l){var c={username:e,password:o};t.call("login",c,function(e){n(e,r)},function(e){l&&l(e)})},g=function(e,o,r,l,c,a){var s={email:e,password:o,first_name:r,last_name:l};console.log("user register"),console.log(s),t.call("register",s,function(e){n(e,c)},function(e){a&&a(e)})},f=function(){o.localStorage.removeItem("bdAccessToken"),o.localStorage.removeItem("bdUserRole"),o.localStorage.removeItem("bdUserId"),r={},e.path("/login")},d=function(e,o,n){t.call("updateMe",e,o,n)};return{get:function(){return r},isLoggedIn:c,isAdmin:l,set:s,login:u,register:g,update:d,logout:f,setup:i,getToken:a}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
