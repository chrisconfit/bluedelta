...
!function(){function e(e,r,t,n,a){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}},d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","uploadJeanThumb","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],l=p?"bdAccessToken":"bdDashAccessToken";"localhost"===e.$$host&&(l+="_dev");var f=function(e,r,t,s){if(console.log("Token prop"+l),accessToken=a.localStorage.getItem(l),console.log(accessToken),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var i="Request being made with no access token.",o=new Error(i);throw o}this[e](r).success(function(r){console.log(e+" was a success:"),console.log(r),t&&t(r),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),s&&s(e)})},g=function(e,t,n){var s=c.headers,i=a.localStorage.getItem(l);i&&(s.Authorization="Bearer "+i);var o={method:e,url:c.url+t,headers:s};if(n){var u="POST"==e?"data":"params";o[u]=n}return r(o)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},P=function(e){return g("POST","/api/passwordreset",e)},O=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],a=s(t);a&&(r+="-"+a+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var b=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),a=[],s=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<s.length;i++)a.push(o(s[i],n));return t.all(a).then(function(e){console.log("IMAGES RESULTS!!!"),console.log(e),u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},S=function(e){return g("POST","/api/thumbnail",e)},_=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),g("POST",r,e)},E=function(e){return g("DELETE","/api/users/current/addresses/"+e)},v=function(e){var r="/api/users/current/jeans";return e.id&&(r+="/"+e.id),g("POST",r,e)},w=function(){return g("GET","/api/users/current")},C=function(){return g("GET","/api/users/current/jeans")},y=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),g("GET",r)},k=function(e){return g("POST","/api/users/current",e)},C=function(){return g("GET","/api/users/current/jeans")},G=function(e){return g("DELETE","/api/users/current/jeans/"+e)},$=function(e){return g("POST","/api/users/current/orders",e)},I=function(e){return!!e.id&&g("POST","/api/users/current/orders/"+e.id,e)},M=function(){return g("GET","/api/users/current/cc")},D=function(e){return g("POST","/api/users/current/cc",e)},j=function(e){return g("POST","/api/users/current/fitmatch",e)},A=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),g("POST",r,e)},L=function(e){return g("GET","/api/users",e)},J=function(e){return g("GET","/api/users/"+e)},q=function(e){return g("DELETE","/api/users/"+e)},z=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},R=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},U=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},x=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},X=function(e){return g("GET","/api/users/"+e+"/cc")},F=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),g("POST",r,e)},H=function(e){return g("GET","/api/orders",e)},B=function(e){return g("GET","/api/orders/"+e)},N=function(e){return g("DELETE","/api/orders/"+e)},W=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),g("POST",r,e)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},K=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),g("POST",r,e.address)},Q=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},V=function(e){return g("POST","/api/swipe",e)},Y=function(e){return g("GET","/api/fitmatchrequests",e)},ee=function(e){return g("GET","/api/fitmatchrequests/"+e)},re=function(e){return g("DELETE","/api/fitmatchrequests/"+e)},te=function(e){var r="/api/fitmatchrequests";return e.id&&(r+="/"+e.id),g("POST",r,e)},ne=function(e){return g("POST","/api/fitmatchrequests/"+e.fitmatchId+"/charge",e)},ae=function(e){return g("POST","/api/orders/"+e+"/invoice")},se={};se.loaded=!1;var ie=function(e){g("GET","/api/data").then(function(r){for(key in r.data)r.data.hasOwnProperty(key)&&(se[key]=r.data[key]);se.belt_loop_options=[{id:1,label:"Centered"},{id:2,label:"Split"},{id:3,label:"X-Pattern"}],se.payment_statuses=[{id:1,label:"Awaiting Payment"},{id:2,label:"Paid"},{id:3,label:"Comped"}],se.pocket_options=[{id:1,label:"Normal"},{id:2,label:"Watch Pocket"},{id:3,label:"Fake Pocket"}],se.lookup=function(e,r,t,n){var a=this[e];if(a){n=n||!1;for(var s=0;s<a.length;s++)if(a[s][r]==t)return n?a[s][n]:a[s]}},se.loaded=!0,e&&e(se)})};return{getData:function(){return se},getAppData:ie,call:f,login:h,register:m,getResetToken:T,resetPassword:P,uploadJeanThumb:S,getJean:O,createThumb:b,getDataCode:getDataCode,getCurrentUser:w,createMyJeans:v,getMyOrders:y,getMyJeans:C,updateMe:k,postMyAddress:_,deleteMyJean:G,deleteMyAddress:E,placeMyOrder:$,updateMyOrder:I,getMyCreditCards:M,createMyCreditCard:D,createMyFitMatch:j,postOrderItem:A,usersList:L,userGet:J,usersCreateCreditCard:x,usersGetUserCreditCards:X,usersDelete:q,usersCreateJean:R,usersCreateAddress:z,usersCreateOrder:U,usersPost:F,ordersPost:W,ordersList:H,orderGet:B,ordersDelete:N,ordersCharge:Z,postAddress:K,commentsCreate:Q,swipeCallback:V,fitmatchList:Y,fitmatchGet:ee,fitmatchDelete:re,fitmatchPost:te,fitmatchCharge:ne,sendInvoice:ae}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
!function(){function e(){return{restrict:"EA",template:'<div class="clearfix">\n   <div class="sq-input-container cardNumber" ng-class="{active:f.cardNumber}"><div id="sq-card-number"></div><label>Card Number</label>\n   <small style="display:block; margin-bottom:10px;" ng-show="errors.cardNumber" class="text-danger">{{errors.cardNumber}}</small>\n   </div><div class="sq-input-container cvv" ng-class="{active:f.cvv}"><div id="sq-cvv"></div><label>CVV</label>\n   <small style="display:block; margin-bottom:10px;" ng-show="errors.cvv" class="text-danger">{{errors.cvv}}</small>\n   </div><div class="sq-input-container expirationDate" ng-class="{active:f.expirationDate}"><div id="sq-expiration-date"></div><label>Expiration Date</label>   <small style="display:block; margin-bottom:10px;" ng-show="errors.expirationDate" class="text-danger">{{errors.expirationDate}}</small>\n   </div><div class="sq-input-container postalCode" ng-class="{active:f.postalCode}"><div id="sq-postal-code"></div><label>Postal Code</label>\n   <small style="display:block; margin-bottom:10px;" ng-show="errors.postalCode" class="text-danger">{{errors.postalCode}}</small>\n   </div><small style="display:block; margin-bottom:10px;" ng-show="errors.request" class="text-danger">{{errors.request}}</small>\n      <button ng-if="!externalControl" class="btn btn-flat btn-primary pull-right"        type="button" ng-click="requestCardNonce()">Submit</button>\n    </div>',replace:!0,scope:{nonceReceivedCallback:"=",externalControl:"=?",inputStyles:"=?",inputConfigOverrides:"=?"},link:function(e){e.f={};var a="sandbox-sq0idp-Ix0BKq70y9xTbYuMuBPZkQ",t="sq0idp-Ix0BKq70y9xTbYuMuBPZkQ";t=a;var n="CBASEN9Li-GLHOlc4cpGQaL58MogAQ",r="9PZNFDJTA6SQ4";r=n,e.requestCardNonce=function(){e.errors={},e.paymentForm.requestCardNonce()},e.externalControl&&(e.externalControl=e.requestCardNonce),e.methodsSupported=function(e){if(e.applePay===!0){var a=document.getElementById("sq-apple-pay");a.style.display="inline-block"}},e.createPaymentRequest=function(){return{requestShippingAddress:!0,currencyCode:"USD",countryCode:"US",total:{label:"{{ MERCHANT NAME }}",amount:"{{TOTAL AMOUNT}}",pending:!1},lineItems:[{label:"Subtotal",amount:"{{SUBTOTAL AMOUNT}}",pending:!1},{label:"Shipping",amount:"{{SHIPPING AMOUNT}}",pending:!0},{label:"Tax",amount:"{{TAX AMOUNT}}",pending:!1}]}},e.cardNonceResponseReceived=function(a,t,n){return a?(a.forEach(function(a){e.errors[a.field]=a.message}),void e.$apply()):void e.nonceReceivedCallback(t,function(a){e.errors.request=a.message})},e.unsupportedBrowserDetected=function(){console.log("unsupported browser")},e.inputEventReceived=function(a){switch(a.eventType){case"focusClassAdded":break;case"focusClassRemoved":e.f[a.field]=!0,e.$apply();break;case"errorClassAdded":break;case"errorClassRemoved":break;case"cardBrandChanged":break;case"postalCodeChanged":}},e.paymentFormLoaded=function(){},e.inputStyles||(e.inputStyles=[{backgroundColor:"#FFFFFF",padding:"6px 12px",fontSize:"14px",lineHeight:"18px"}]);var o={cardNumber:{elementId:"sq-card-number",placeholder:"•••• •••• •••• ••••"},cvv:{elementId:"sq-cvv",placeholder:"CVV"},expirationDate:{elementId:"sq-expiration-date",placeholder:"MM/YY"},postalCode:{elementId:"sq-postal-code"},applePay:{elementId:"sq-apple-pay"}};if(e.inputConfigOverrides)for(var s in e.inputConfigOverrides)if(e.inputConfigOverrides.hasOwnProperty(s)){var l=s,i=e.inputConfigOverrides[s];for(ov in i)i.hasOwnProperty(ov)&&(o[l][ov]=i[ov])}e.paymentForm=new SqPaymentForm({applicationId:t,locationId:r,inputClass:"sq-input",inputStyles:e.inputStyles,cardNumber:o.cardNumber,cvv:o.cvv,expirationDate:o.expirationDate,postalCode:o.postalCode,applePay:o.applePay,callbacks:{methodsSupported:e.methodsSupported,cardNonceResponseReceived:e.cardNonceResponseReceived,unsupportedBrowserDetected:e.unsupportedBrowserDetected,inputEventReceived:e.inputEventReceived,paymentFormLoaded:e.paymentFormLoaded,createPaymentRequest:e.createPaymentRequest}}),e.$evalAsync(function(){e.paymentForm.build()})}}}angular.module("sqPaymentForm",[]).directive("sqPaymentForm",e),e.$inject=[]}();
!function(){function e(e,o,t){function n(e,t){console.log("Auth callback"),console.log(e),console.log("setting token to "+c),o.localStorage.setItem(c,e.access_token),d(function(e){o.localStorage.setItem(r,e.role_id),o.localStorage.setItem(s,e.id),t&&t(e)})}var l="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],r=l?"bdUserRole":"bdDashUserRole";"localhost"==e.$$host&&(r+="_dev");var c=l?"bdAccessToken":"bdDashAccessToken";"localhost"==e.$$host&&(c+="_dev");var s=l?"bdUserId":"bdDashUserId";"localhost"==e.$$host&&(s+="_dev");var a={},i=function(){return parseInt(o.localStorage.getItem(r))>1},u=function(){return!!o.localStorage.getItem(c)},g=function(){return o.localStorage.getItem(c)},f=function(e,o){if(null==e)return!1;if("object"==typeof e){var t=e;for(obKey in t)t.hasOwnProperty(obKey)&&(a[obKey]=e[obKey])}else a[e]=o;return a},d=function(e){t.call("getCurrentUser",{},function(t){console.log("get current user"),console.log(t),console.log("setting "+r),o.localStorage.setItem(r,t.role_id),f(t),e&&e(t)})},m=function(e,o,l,r){var c={username:e,password:o};t.call("login",c,function(e){n(e,l)},function(e){r&&r(e)})},h=function(e,o,l,r,c,s){var a={email:e,password:o,first_name:l,last_name:r};t.call("register",a,function(e){n(e,c)},function(e){s&&s(e)})},$=function(e,o,n){t.call("getResetToken",e,function(e){o(e)},function(e){n&&n(e)})},v=function(e,o,n){t.call("resetPassword",e,function(e){o(e)},function(e){n&&n(e)})},I=function(t,n){o.localStorage.removeItem(c),o.localStorage.removeItem(r),o.localStorage.removeItem(s),a={},t&&t(),n!==!1&&e.path("/login")},b=function(e,o,n){t.call("updateMe",e,o,n)};return{get:function(){return a},isLoggedIn:u,isAdmin:i,set:f,login:m,register:h,update:b,logout:I,setup:d,getToken:g,getResetToken:$,resetPassword:v}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
