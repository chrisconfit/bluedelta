...
!function(){function e(e,r,t,n,s){function a(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}};"localhost"==e.$$host&&(c.url="http://bluedelta.local");var d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port,f=p?"bdAccessToken":"bdDashAccessToken",l=function(e,r,t,a){if(accessToken=s.localStorage.getItem(f),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](r).success(function(e){t&&t(e),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),a&&a(e)})},g=function(e,t,n){var a=c.headers,o=s.localStorage.getItem(f);o&&(a.Authorization="Bearer "+o);var i={method:e,url:c.url+t,headers:a};if(n){var u="POST"==e?"data":"params";i[u]=n}return r(i)},h=function(e){return g("POST","/api/login",e)},T=function(e){return g("POST","/api/register",e)},m=function(e){return g("POST","/api/passwordtoken",{email:e})},O=function(e){return g("POST","/api/passwordreset",e)},_=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],s=a(t);s&&(r+="-"+s+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var w=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),s=[],a=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<a.length;i++)s.push(o(a[i],n));return t.all(s).then(function(e){u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},P=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),g("POST",r,e)},b=function(e){return g("DELETE","/api/users/current/addresses/"+e)},v=function(e){return g("POST","/api/users/current/jeans",e)},E=function(){return g("GET","/api/users/current")},S=function(){return g("GET","/api/users/current/jeans")},C=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),g("GET",r)},y=function(e){return g("POST","/api/users/current",e)},S=function(){return g("GET","/api/users/current/jeans")},$=function(e){return g("DELETE","/api/users/current/jeans/"+e)},k=function(e){return g("POST","/api/users/current/orders",e)},G=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),g("POST",r,e)},I=function(e){return g("GET","/api/users",e)},j=function(e){return g("GET","/api/users/"+e)},D=function(e){return g("DELETE","/api/users/"+e)},M=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},A=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},J=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},L=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},z=function(e){return g("GET","/api/users/"+e+"/cc")},x=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),g("POST",r,e)},R=function(e){return g("GET","/api/orders",e)},U=function(e){return g("GET","/api/orders/"+e)},q=function(e){return g("DELETE","/api/orders/"+e)},H=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),g("POST",r,e)},X=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},B=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),g("POST",r,e.address)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},F=function(e){return g("POST","/api/swipe",e)},K=function(){r.get("https://api.bluedeltajeans.com/api/data").then(function(e){for(key in e.data)e.data.hasOwnProperty(key)&&(N[key]=e.data[key])})},N={};return N.lookup=function(e,r,t,n){var s=this[e];if(s){n=n||!1;for(var a=0;a<s.length;a++)if(s[a][r]==t)return n?s[a][n]:s[a]}},{getData:function(){return N},getAppData:K,call:l,login:h,register:T,getResetToken:m,resetPassword:O,getJean:_,createThumb:w,getDataCode:getDataCode,getCurrentUser:E,createMyJeans:v,getMyOrders:C,getMyJeans:S,updateMe:y,postMyAddress:P,getMyJeans:S,getMyOrders:C,deleteMyJean:$,deleteMyAddress:b,placeMyOrder:k,postOrderItem:G,usersList:I,userGet:j,usersCreateCreditCard:L,usersGetUserCreditCards:z,usersDelete:D,usersCreateJean:A,usersCreateAddress:M,usersCreateOrder:J,usersPost:x,ordersPost:H,ordersList:R,orderGet:U,ordersDelete:q,ordersCharge:X,postAddress:B,commentsCreate:Z,swipeCallback:F}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
