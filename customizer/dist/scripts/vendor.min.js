...
!function(){function e(e,r,t,n,s){function a(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com",headers:{"Content-Type":"application/json"}},d=["login","register","getResetToken","resetPassword","forgotPassword","getJean"],p="localhost"==e.$$host&&4e3==e.$$port,f=p?"bdAccessToken":"bdDashAccessToken",g=function(e,r,t,a){if(accessToken=s.localStorage.getItem(f),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](r).success(function(e){t&&t(e),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),a&&a(e)})},l=function(e,t,n){var a=c.headers,o=s.localStorage.getItem(f);o&&(a.Authorization="Bearer "+o);var i={method:e,url:c.url+t,headers:a};if(n){var u="POST"==e?"data":"params";i[u]=n}return r(i)},m=function(e){return l("POST","/api/login",e)},h=function(e){return l("POST","/api/register",e)},T=function(e){return l("POST","/api/passwordtoken",{email:e})},_=function(e){return l("POST","/api/passwordreset",e)},w=function(e){return l("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],s=a(t);s&&(r+="-"+s+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var O=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),s=[],a=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<a.length;i++)s.push(o(a[i],n));return t.all(s).then(function(e){u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},P=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),l("POST",r,e)},E=function(e){return l("DELETE","/api/users/current/addresses/"+e)},v=function(e){return l("POST","/api/users/current/jeans",e)},b=function(){return l("GET","/api/users/current")},S=function(){return l("GET","/api/users/current/jeans")},y=function(e){return l("GET","/api/users/current/orders")},$=function(e){return l("POST","/api/users/current",e)},S=function(){return l("GET","/api/users/current/jeans")},y=function(){return l("GET","/api/users/current/orders")},k=function(e){return l("DELETE","/api/users/current/jeans/"+e)},D=function(e){return l("POST","/api/users/current/orders",e)},G=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),l("POST",r,e)},M=function(e){return l("GET","/api/users",e)},C=function(e){return l("GET","/api/users/"+e)},I=function(e){return l("DELETE","/api/users/"+e)},j=function(e){return l("POST","/api/users/"+e.userId+"/address",e.address)},z=function(e){return l("POST","/api/users/"+e.userId+"/jeans",e.jean)},A=function(e){return l("POST","/api/users/"+e.userId+"/orders",e.order)},J=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),l("POST",r,e)},L=function(e){return l("GET","/api/orders",e)},x=function(e){return l("GET","/api/orders/"+e)},R=function(e){return l("DELETE","/api/orders/"+e)},U=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),l("POST",r,e)},q=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),l("POST",r,e.address)},H=function(e){return l("POST","/api/orders/"+e.orderId+"/comments",e.comment)},X=function(){r.get("http://ec2-54-200-231-145.us-west-2.compute.amazonaws.com/api/data").then(function(e){for(key in e.data)e.data.hasOwnProperty(key)&&(B[key]=e.data[key])})},B={};return B.lookup=function(e,r,t,n){var s=this[e];if(s){n=n||!1;for(var a=0;a<s.length;a++)if(s[a][r]==t)return n?s[a][n]:s[a]}},{getData:function(){return B},getAppData:X,call:g,login:m,register:h,getResetToken:T,resetPassword:_,getJean:w,createThumb:O,getDataCode:getDataCode,getCurrentUser:b,createMyJeans:v,getMyOrders:y,getMyJeans:S,updateMe:$,postMyAddress:P,getMyJeans:S,getMyOrders:y,deleteMyJean:k,deleteMyAddress:E,placeMyOrder:D,postOrderItem:G,usersList:M,userGet:C,usersDelete:I,usersCreateJean:z,usersCreateAddress:j,usersCreateOrder:A,usersPost:J,ordersPost:U,ordersList:L,orderGet:x,ordersDelete:R,postAddress:q,commentsCreate:H}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
