...
!function(){function e(e,r,t,n,a){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}},d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","uploadJeanThumb","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],f=p?"bdAccessToken":"bdDashAccessToken";"localhost"===e.$$host&&(f+="_dev");var l=function(e,r,t,s){if(accessToken=a.localStorage.getItem(f),d.indexOf(e)<0&&!accessToken){var i="Request being made with no access token.",o=new Error(i);throw o}this[e](r).success(function(e){t&&t(e),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),s&&s(e)})},h=function(e,t,n){var s=c.headers,i=a.localStorage.getItem(f);i&&(s.Authorization="Bearer "+i);var o={method:e,url:c.url+t,headers:s};if(n){var u="POST"==e?"data":"params";o[u]=n}return r(o)},g=function(e){return h("POST","/api/login",e)},m=function(e){return h("POST","/api/register",e)},T=function(e){return h("POST","/api/passwordtoken",{email:e})},P=function(e){return h("POST","/api/passwordreset",e)},O=function(e){return h("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],a=s(t);a&&(r+="-"+a+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var b=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),a=[],s=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<s.length;i++)a.push(o(s[i],n));return t.all(a).then(function(e){console.log("IMAGES RESULTS!!!"),console.log(e),u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},S=function(e){return h("POST","/api/thumbnail",e)},_=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),h("POST",r,e)},E=function(e){return h("DELETE","/api/users/current/addresses/"+e)},v=function(e){var r="/api/users/current/jeans";return e.id&&(r+="/"+e.id),h("POST",r,e)},w=function(){return h("GET","/api/users/current")},C=function(){return h("GET","/api/users/current/jeans")},y=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),h("GET",r)},G=function(e){return h("POST","/api/users/current",e)},C=function(){return h("GET","/api/users/current/jeans")},k=function(e){return h("DELETE","/api/users/current/jeans/"+e)},$=function(e){return h("POST","/api/users/current/orders",e)},I=function(e){return!!e.id&&h("POST","/api/users/current/orders/"+e.id,e)},M=function(){return h("GET","/api/users/current/cc")},D=function(e){return h("POST","/api/users/current/cc",e)},j=function(e){return h("POST","/api/users/current/fitmatch",e)},A=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),h("POST",r,e)},L=function(e){return h("GET","/api/users",e)},J=function(e){return h("GET","/api/users/"+e)},q=function(e){return h("DELETE","/api/users/"+e)},z=function(e){return h("POST","/api/users/"+e.userId+"/address",e.address)},R=function(e){return h("POST","/api/users/"+e.userId+"/jeans",e.jean)},U=function(e){return h("POST","/api/users/"+e.userId+"/orders",e.order)},x=function(e){return h("POST","/api/users/"+e.userId+"/cc",e)},X=function(e){return h("GET","/api/users/"+e+"/cc")},F=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),h("POST",r,e)},H=function(e){return h("GET","/api/orders",e)},B=function(e){return h("GET","/api/orders/"+e)},N=function(e){return h("DELETE","/api/orders/"+e)},W=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),h("POST",r,e)},Z=function(e){return h("POST","/api/orders/"+e.orderId+"/charge",e)},K=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),h("POST",r,e.address)},Q=function(e){return h("POST","/api/orders/"+e.orderId+"/comments",e.comment)},V=function(e){return h("POST","/api/swipe",e)},Y=function(e){return h("GET","/api/fitmatchrequests",e)},ee=function(e){return h("GET","/api/fitmatchrequests/"+e)},re=function(e){return h("DELETE","/api/fitmatchrequests/"+e)},te=function(e){var r="/api/fitmatchrequests";return e.id&&(r+="/"+e.id),h("POST",r,e)},ne=function(e){return h("POST","/api/fitmatchrequests/"+e.fitmatchId+"/charge",e)},ae=function(e){return h("POST","/api/orders/"+e+"/invoice")},se={};se.loaded=!1;var ie=function(e){h("GET","/api/data").then(function(r){for(key in r.data)r.data.hasOwnProperty(key)&&(se[key]=r.data[key]);se.belt_loop_options=[{id:1,label:"Centered"},{id:2,label:"Split"},{id:3,label:"X-Pattern"}],se.payment_statuses=[{id:1,label:"Awaiting Payment"},{id:2,label:"Paid"},{id:3,label:"Comped"}],se.pocket_options=[{id:1,label:"Normal"},{id:2,label:"Watch Pocket"},{id:3,label:"Fake Pocket"}],se.lookup=function(e,r,t,n){var a=this[e];if(a){n=n||!1;for(var s=0;s<a.length;s++)if(a[s][r]==t)return n?a[s][n]:a[s]}},se.loaded=!0,e&&e(se)})};return{getData:function(){return se},getAppData:ie,call:l,login:g,register:m,getResetToken:T,resetPassword:P,uploadJeanThumb:S,getJean:O,createThumb:b,getDataCode:getDataCode,getCurrentUser:w,createMyJeans:v,getMyOrders:y,getMyJeans:C,updateMe:G,postMyAddress:_,deleteMyJean:k,deleteMyAddress:E,placeMyOrder:$,updateMyOrder:I,getMyCreditCards:M,createMyCreditCard:D,createMyFitMatch:j,postOrderItem:A,usersList:L,userGet:J,usersCreateCreditCard:x,usersGetUserCreditCards:X,usersDelete:q,usersCreateJean:R,usersCreateAddress:z,usersCreateOrder:U,usersPost:F,ordersPost:W,ordersList:H,orderGet:B,ordersDelete:N,ordersCharge:Z,postAddress:K,commentsCreate:Q,swipeCallback:V,fitmatchList:Y,fitmatchGet:ee,fitmatchDelete:re,fitmatchPost:te,fitmatchCharge:ne,sendInvoice:ae}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
