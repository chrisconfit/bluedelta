...
!function(){function e(e,o,t){function n(e,t){console.log("Auth callback"),console.log(e),o.localStorage.setItem(c,e.access_token),d(function(e){o.localStorage.setItem(l,e.role_id),o.localStorage.setItem(a,e.id),t&&t(e)})}var r="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],l=r?"bdUserRole":"bdDashUserRole",c=r?"bdAccessToken":"bdDashAccessToken",a=r?"bdUserId":"bdDashUserId",s={},i=function(){return parseInt(o.localStorage.getItem(l))>1},u=function(){return!!o.localStorage.getItem(c)},g=function(){return o.localStorage.getItem(c)},f=function(e,o){if(null==e)return!1;if("object"==typeof e){var t=e;for(obKey in t)t.hasOwnProperty(obKey)&&(s[obKey]=e[obKey])}else s[e]=o;return s},d=function(e){t.call("getCurrentUser",{},function(t){console.log("get current user"),console.log(t),o.localStorage.setItem(l,t.role_id),f(t),e&&e(t)})},m=function(e,o,r,l){var c={username:e,password:o};t.call("login",c,function(e){n(e,r)},function(e){l&&l(e)})},I=function(e,o,r,l,c,a){var s={email:e,password:o,first_name:r,last_name:l};t.call("register",s,function(e){n(e,c)},function(e){a&&a(e)})},b=function(e,o,n){t.call("getResetToken",e,function(e){o(e)},function(e){n&&n(e)})},p=function(e,o,n){t.call("resetPassword",e,function(e){o(e)},function(e){n&&n(e)})},S=function(t,n){o.localStorage.removeItem(c),o.localStorage.removeItem(l),o.localStorage.removeItem(a),s={},t&&t(),n!==!1&&e.path("/login")},h=function(e,o,n){t.call("updateMe",e,o,n)};return{get:function(){return s},isLoggedIn:u,isAdmin:i,set:f,login:m,register:I,update:h,logout:S,setup:d,getToken:g,getResetToken:b,resetPassword:p}}angular.module("user",["api"]).service("user",e),e.$inject=["$location","$window","api"]}();
