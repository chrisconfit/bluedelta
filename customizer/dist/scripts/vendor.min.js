...
!function(){function e(e,r,t,n,a){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return t(function(r,t){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){r(n)},n.onerror=function(e){t(e)}})}function u(e,r,t){for(i=0;i<t.length;i++){var n=t[i];n.src.indexOf("/"+e+"/")>-1&&r.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}},d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","swipeCallback"],p="localhost"==e.$$host&&4e3==e.$$port,f=p?"bdAccessToken":"bdDashAccessToken",l=function(e,r,t,s){if(accessToken=a.localStorage.getItem(f),console.log("calling "+e+" with..."),console.log(r),d.indexOf(e)<0&&!accessToken){var i="Request being made with no access token.",o=new Error(i);throw o}this[e](r).success(function(r){console.log(e+" was a success:"),console.log(r),t&&t(r),n.$$phase||n.$apply()}).error(function(e,r,t){console.log(e),s&&s(e)})},g=function(e,t,n){var s=c.headers,i=a.localStorage.getItem(f);i&&(s.Authorization="Bearer "+i);var o={method:e,url:c.url+t,headers:s};if(n){var u="POST"==e?"data":"params";o[u]=n}return r(o)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},P=function(e){return g("POST","/api/passwordreset",e)},O=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var r="";for(var t in e)if(e.hasOwnProperty(t)){var n=e[t],a=s(t);a&&(r+="-"+a+":"+n)}return r=r.replace(/(^[_\s]+)|([_\s]+$)/g,""),r.replace("-","")};var b=function(e){var r=document.createElement("canvas");r.width=600,r.height=600;for(var n=r.getContext("2d"),a=[],s=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<s.length;i++)a.push(o(s[i],n));return t.all(a).then(function(e){u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var t=r.toDataURL("image/jpeg");return t},function(e){console.log(e)})},_=function(e){var r="/api/users/current/addresses";return e.id&&(r+="/"+e.id),g("POST",r,e)},E=function(e){return g("DELETE","/api/users/current/addresses/"+e)},w=function(e){return g("POST","/api/users/current/jeans",e)},S=function(){return g("GET","/api/users/current")},C=function(){return g("GET","/api/users/current/jeans")},v=function(e){var r="/api/users/current/orders";return e&&(r+="/"+e),g("GET",r)},y=function(e){return g("POST","/api/users/current",e)},C=function(){return g("GET","/api/users/current/jeans")},k=function(e){return g("DELETE","/api/users/current/jeans/"+e)},G=function(e){return g("POST","/api/users/current/orders",e)},D=function(){return g("GET","/api/users/current/cc")},I=function(e){return g("POST","/api/users/current/cc",e)},M=function(e){return g("POST","/api/users/current/fitmatch",e)},$=function(e){var r="/api/orderItem";return e.id&&(r+="/"+e.id),g("POST",r,e)},j=function(e){return g("GET","/api/users",e)},A=function(e){return g("GET","/api/users/"+e)},L=function(e){return g("DELETE","/api/users/"+e)},q=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},z=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},J=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},x=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},R=function(e){return g("GET","/api/users/"+e+"/cc")},U=function(e){var r="/api/users";return e.id&&(r+="/"+e.id),g("POST",r,e)},X=function(e){return g("GET","/api/orders",e)},F=function(e){return g("GET","/api/orders/"+e)},H=function(e){return g("DELETE","/api/orders/"+e)},B=function(e){var r="/api/orders";return e.id&&(r+="/"+e.id),g("POST",r,e)},N=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},W=function(e){var r="/api/users/"+e.userId+"/addresses";return e.address.id&&(r+="/"+e.address.id),g("POST",r,e.address)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},K=function(e){return g("POST","/api/swipe",e)},Q=function(e){return g("GET","/api/fitmatchrequests",e)},V=function(e){return g("GET","/api/fitmatchrequests/"+e)},Y=function(e){return g("DELETE","/api/fitmatchrequests/"+e)},ee=function(e){var r="/api/fitmatchrequests";return e.id&&(r+="/"+e.id),g("POST",r,e)},re=function(e){return g("POST","/api/fitmatchrequests/"+e.fitmatchId+"/charge",e)},te=function(){g("GET","/api/data").then(function(e){for(key in e.data)e.data.hasOwnProperty(key)&&(ne[key]=e.data[key]);ne.belt_loop_options=[{id:1,label:"Centered"},{id:2,label:"Split"},{id:3,label:"X-Pattern"}],ne.payment_statuses=[{id:1,label:"Awaiting Payment"},{id:2,label:"Paid"},{id:3,label:"Comped"}],ne.pocket_options=[{id:1,label:"Normal"},{id:2,label:"Watch Pocket"},{id:3,label:"Fake Pocket"}]})},ne={};return ne.lookup=function(e,r,t,n){var a=this[e];if(a){n=n||!1;for(var s=0;s<a.length;s++)if(a[s][r]==t)return n?a[s][n]:a[s]}},{getData:function(){return ne},getAppData:te,call:l,login:h,register:m,getResetToken:T,resetPassword:P,getJean:O,createThumb:b,getDataCode:getDataCode,getCurrentUser:S,createMyJeans:w,getMyOrders:v,getMyJeans:C,updateMe:y,postMyAddress:_,deleteMyJean:k,deleteMyAddress:E,placeMyOrder:G,getMyCreditCards:D,createMyCreditCard:I,createMyFitMatch:M,postOrderItem:$,usersList:j,userGet:A,usersCreateCreditCard:x,usersGetUserCreditCards:R,usersDelete:L,usersCreateJean:z,usersCreateAddress:q,usersCreateOrder:J,usersPost:U,ordersPost:B,ordersList:X,orderGet:F,ordersDelete:H,ordersCharge:N,postAddress:W,commentsCreate:Z,swipeCallback:K,fitmatchList:Q,fitmatchGet:V,fitmatchDelete:Y,fitmatchPost:ee,fitmatchCharge:re}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
