...
!function(){function e(e,t,r,n,a){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function o(e){return r(function(t,r){var n=new Image;n.crossOrigin="",n.src=e,n.onload=function(){t(n)},n.onerror=function(e){r(e)}})}function u(e,t,r){for(i=0;i<r.length;i++){var n=r[i];n.src.indexOf("/"+e+"/")>-1&&t.drawImage(n,0,0,600,696)}}var c={client_id:2,client_secret:"8xHu3MLzZXr3pcUneGCM08XOzMc5rH5AOtJSCdIP",url:"https://api.bluedeltajeans.com",headers:{"Content-Type":"application/json"}};"localhost"==e.$$host&&(c.url="http://bluedelta.local");var d=["login","register","getResetToken","resetPassword","forgotPassword","getJean","swipeCallback"],l="localhost"==e.$$host&&4e3==e.$$port||"build"==e.$$host.split(".")[0],p=l?"bdAccessToken":"bdDashAccessToken";"localhost"===e.$$host&&(p+="_dev");var f=function(e,t,r,s){if(console.log("Token prop"+p),accessToken=a.localStorage.getItem(p),console.log(accessToken),console.log("calling "+e+" with..."),console.log(t),d.indexOf(e)<0&&!accessToken){var o="Request being made with no access token.",i=new Error(o);throw i}this[e](t).success(function(t){console.log(e+" was a success:"),console.log(t),r&&r(t),n.$$phase||n.$apply()}).error(function(e,t,r){console.log(e),s&&s(e)})},g=function(e,r,n){var s=c.headers,o=a.localStorage.getItem(p);o&&(s.Authorization="Bearer "+o);var i={method:e,url:c.url+r,headers:s};if(n){var u="POST"==e?"data":"params";i[u]=n}return t(i)},h=function(e){return g("POST","/api/login",e)},m=function(e){return g("POST","/api/register",e)},T=function(e){return g("POST","/api/passwordtoken",{email:e})},P=function(e){return g("POST","/api/passwordreset",e)},b=function(e){return g("GET","/api/jean/"+e)};getDataCode=function(e){var t="";for(var r in e)if(e.hasOwnProperty(r)){var n=e[r],a=s(r);a&&(t+="-"+a+":"+n)}return t=t.replace(/(^[_\s]+)|([_\s]+$)/g,""),t.replace("-","")};var O=function(e){console.log("CREATING THUMB!!!");var t=document.createElement("canvas");t.width=600,t.height=600;for(var n=t.getContext("2d"),a=[],s=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<s.length;i++)a.push(o(s[i],n));return r.all(a).then(function(e){console.log("ALL PROMISES"),u("fabrics",n,e),u("tb",n,e),u("tt",n,e),u("ta",n,e);var r=t.toDataURL("image/jpeg");return r},function(e){console.log(e)})},_=function(e){var t="/api/users/current/addresses";return e.id&&(t+="/"+e.id),g("POST",t,e)},E=function(e){return g("DELETE","/api/users/current/addresses/"+e)},S=function(e){return g("POST","/api/users/current/jeans",e)},w=function(){return g("GET","/api/users/current")},v=function(){return g("GET","/api/users/current/jeans")},C=function(e){var t="/api/users/current/orders";return e&&(t+="/"+e),g("GET",t)},k=function(e){return g("POST","/api/users/current",e)},v=function(){return g("GET","/api/users/current/jeans")},y=function(e){return g("DELETE","/api/users/current/jeans/"+e)},G=function(e){return g("POST","/api/users/current/orders",e)},$=function(){return g("GET","/api/users/current/cc")},I=function(e){return g("POST","/api/users/current/cc",e)},M=function(e){return g("POST","/api/users/current/fitmatch",e)},D=function(e){var t="/api/orderItem";return e.id&&(t+="/"+e.id),g("POST",t,e)},j=function(e){return g("GET","/api/users",e)},A=function(e){return g("GET","/api/users/"+e)},L=function(e){return g("DELETE","/api/users/"+e)},q=function(e){return g("POST","/api/users/"+e.userId+"/address",e.address)},z=function(e){return g("POST","/api/users/"+e.userId+"/jeans",e.jean)},J=function(e){return g("POST","/api/users/"+e.userId+"/orders",e.order)},R=function(e){return g("POST","/api/users/"+e.userId+"/cc",e)},U=function(e){return g("GET","/api/users/"+e+"/cc")},x=function(e){var t="/api/users";return e.id&&(t+="/"+e.id),g("POST",t,e)},H=function(e){return g("GET","/api/orders",e)},X=function(e){return g("GET","/api/orders/"+e)},B=function(e){return g("DELETE","/api/orders/"+e)},F=function(e){var t="/api/orders";return e.id&&(t+="/"+e.id),g("POST",t,e)},N=function(e){return g("POST","/api/orders/"+e.orderId+"/charge",e)},W=function(e){var t="/api/users/"+e.userId+"/addresses";return e.address.id&&(t+="/"+e.address.id),g("POST",t,e.address)},Z=function(e){return g("POST","/api/orders/"+e.orderId+"/comments",e.comment)},K=function(e){return g("POST","/api/swipe",e)},Q=function(e){return g("GET","/api/fitmatchrequests",e)},V=function(e){return g("GET","/api/fitmatchrequests/"+e)},Y=function(e){return g("DELETE","/api/fitmatchrequests/"+e)},ee=function(e){var t="/api/fitmatchrequests";return e.id&&(t+="/"+e.id),g("POST",t,e)},te=function(e){return g("POST","/api/fitmatchrequests/"+e.fitmatchId+"/charge",e)},re={};re.loaded=!1;var ne=function(e){g("GET","/api/data").then(function(t){for(key in t.data)t.data.hasOwnProperty(key)&&(re[key]=t.data[key]);re.belt_loop_options=[{id:1,label:"Centered"},{id:2,label:"Split"},{id:3,label:"X-Pattern"}],re.payment_statuses=[{id:1,label:"Awaiting Payment"},{id:2,label:"Paid"},{id:3,label:"Comped"}],re.pocket_options=[{id:1,label:"Normal"},{id:2,label:"Watch Pocket"},{id:3,label:"Fake Pocket"}],re.lookup=function(e,t,r,n){var a=this[e];if(a){n=n||!1;for(var s=0;s<a.length;s++)if(a[s][t]==r)return n?a[s][n]:a[s]}},re.loaded=!0,e&&e(re)})};return{getData:function(){return re},getAppData:ne,call:f,login:h,register:m,getResetToken:T,resetPassword:P,getJean:b,createThumb:O,getDataCode:getDataCode,getCurrentUser:w,createMyJeans:S,getMyOrders:C,getMyJeans:v,updateMe:k,postMyAddress:_,deleteMyJean:y,deleteMyAddress:E,placeMyOrder:G,getMyCreditCards:$,createMyCreditCard:I,createMyFitMatch:M,postOrderItem:D,usersList:j,userGet:A,usersCreateCreditCard:R,usersGetUserCreditCards:U,usersDelete:L,usersCreateJean:z,usersCreateAddress:q,usersCreateOrder:J,usersPost:x,ordersPost:F,ordersList:H,orderGet:X,ordersDelete:B,ordersCharge:N,postAddress:W,commentsCreate:Z,swipeCallback:K,fitmatchList:Q,fitmatchGet:V,fitmatchDelete:Y,fitmatchPost:ee,fitmatchCharge:te}}angular.module("api",[]).service("api",e),e.$inject=["$location","$http","$q","$rootScope","$window"]}();
