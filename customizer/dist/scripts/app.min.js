...
!function(){function e(e,s,r,a,n,t,o,i,u,l){function d(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function c(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function m(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function p(e){for(var s=0;s<f.user.jeans.length;s++)if(f.user.jeans[s].jeanId===e)return{index:s,data:f.user.jeans[s]}}var f=this;a.closeAll(),f.popups=a.get(),f.messages=i.get(),f.jean=r,f.data={},f.jeans=f.data.jeansList,f.onload=function(){o.vm=f},f.userForm={},f.userForm.editing={},f.userForm.saving={},f.userForm.feedback={type:"",message:""},f.userForm.cancel=function(e){f.userForm.editing[e]=!1,f.user[e]=f.userForm.data[e]},f.userForm.validate=function(e,s){return"email"==e?!!d(s)||(i.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!c(s)||(i.set("Please enter a valid phone number","error"),!1))},f.userForm.save=function(e){""==f.user[e]&&(f.user[e]=null),f.userForm.validate(e,f.user[e])&&(f.userForm.saving[e]=!0,t.call("usersUpdate",[f.user.identityId,f.user],function(s){f.userForm.saving[e]=!1,f.userForm.editing[e]=!1,f.userForm.data[e]=f.user[e],o.$apply()}))},f.orders=[],f.user=l.get(),f.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){f.passForm.editing=!1,f.passForm.currentPass="",f.passForm.newPass="",f.passForm.newPassConfirm="",i.reset()}},f.validatePasswordForm=function(){return m(f.passForm.newPass)||i.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),f.passForm.newPass===f.passForm.newPassConfirm||(i.set("New Password and Confirmation do not match","error"),!1)},f.changePassword=function(){i.reset(),f.validatePasswordForm()&&n.changePassword(f.user.email,f.passForm.currentPass,f.passForm.newPass).then(function(e){f.passForm.clear(),i.set("Password successfully changed.","success")},function(e){i.set(e.message,"error")})},f.copyJean=function(){f.jean=r.createNew(f.displayJean),e.path("/customizer")},f.displayJean={},f.selectJean=function(e){f.popups.jeanProfile=!0,f.displayJean=e},f.selectOrder=function(e){f.popups.orderProfile=!0,f.displayOrder=e,f.displayJean=e.orderItems[0].jean},f.deleteJean=function(e){r.deleter(f.user.identityId,e,function(s){var r=p(e).index;f.user.jeans.splice(r,1),o.$apply()})},f.orderJean=function(s){r.setup(s),e.path("/order/"+s.jeanId+"/"+f.user.identityId)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","$window","jean","popups","aws","bdAPI","$scope","messages","loader","user"]}();
...
!function(){function e(e,o){var n=this;n.user=o.get(),console.log(e.localStorage.getItem("bdAccessToken"))}angular.module("bdApp").controller("homeCtrl",e),e.$inject=["$window","user"]}();
