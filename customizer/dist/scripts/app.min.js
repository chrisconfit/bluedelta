...
!function(){function e(e,t,o,n){function r(e){switch(e){case"g":return"gender_option_id";case"s":return"style_option_id";case"f":return"fabric_id";case"tt":return"top_thread_id";case"tb":return"bottom_thread_id";case"ta":return"accent_thread_id";default:return!1}}var a={};set=function(e,t){a[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?a={gender_option_id:e.gender_option_id,style_option_id:e.style_option_id,fabric_id:e.fabric_id,accent_thread_id:e.accent_thread_id,top_thread_id:e.top_thread_id,bottom_thread_id:e.bottom_thread_id}:(a={gender_option_id:1,style_option_id:1,fabric_id:1704,accent_thread_id:1,top_thread_id:1,bottom_thread_id:1},a.saved=!1)},reset=function(){createNew()},buildJeanData=function(e,t){console.log(t),1==t&&(console.log("SETTING UP COPY"),delete e.user_id,delete e.id,e.name&&(e.name="Copy of "+e.name));for(prop in e)e.hasOwnProperty(prop)&&set(prop,e[prop])};var i=function(e,i){console.log("running setup");var d=o.defer(),c="localhost"===t.location.hostname?"bdUserId_dev":"bdUserId",l=parseInt(t.localStorage.getItem(c)),s=!l;if(s="copy"==i||s,null!==e&&"object"==typeof e)console.log("working from object data!"),e.user_id&&e.user_id!==l&&delete e.id,buildJeanData(e,s),d.resolve(a);else if(null!==e&&void 0!==e&&isNaN(e)){console.log("THIS IS A DATACODE"),console.log(e);var u={};dataArr=e.split("-");for(var _=0;_<dataArr.length;_++){var g=dataArr[_].split(":"),p=r(g[0]);u[p]=g[1]}console.log("jeanObj"),console.log(u),buildJeanData(u,!0),d.resolve(a)}else null!==e&&void 0!==e?(console.log("ID!!!"),console.log(e),n.call("getJean",e,function(e){console.log("GOT JEAN"),console.log(e),console.log(e.user_id),console.log(l),e.user_id!==l&&(s=!0),buildJeanData(e,s),d.resolve(a)},function(e){d.reject(e)})):Object.keys(a).length>0?d.resolve(a):(createNew(),d.resolve(a));return d.promise},d=function(){return a},c=function(e,t){n.call("deleteMyJean",e,function(e){t&&t(e)})},l=function(){var e=o.defer(),t=this,r=t.get(),a=n.getDataCode(r);return a+=".jpg",r.image={filename:a},n.createThumb(r).then(function(t){r.image.data=t,n.call("createMyJeans",r,function(t){e.resolve(t)},function(t){e.reject(t)})},function(t){e.reject(t)}),e.promise};return{deleter:c,save:l,get:d,set:set,setup:i,reset:reset,set:set,createNew:createNew,getDataCode:getDataCode}}angular.module("bdApp").service("jean",["$routeParams","$window","$q","api",e])}();
...
!function(){function e(e,a,r,s,t){var i=this;i.messages=t.get(),i.credentials={first_name:"",last_name:"",email:"",password:""},i.validateRegistrationForm=function(){function e(e){var a=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return a.test(e)}function a(e){var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.test(e)}return i.credentials.email&&i.credentials.first_name&&i.credentials.last_name&&i.credentials.password&&i.credentials.passwordConfirm?e(i.credentials.password)?i.credentials.password!==i.credentials.passwordConfirm?(t.set("Password and Confirmation do not match","error"),!1):!!a(i.credentials.email)||(t.set("Please Enter a valid E-mail address","error"),!1):(t.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),!1):(t.set("All fields are required","error"),!1)},i.registerUser=function(){t.reset();var s=i.validateRegistrationForm();return console.log(s),!!s&&void r.register(i.credentials.email,i.credentials.password,i.credentials.first_name,i.credentials.last_name,function(){e.callback&&e.callback(i.credentials),e.redirect&&a.path(e.redirect),e.callback||e.redirect||a.path("/closet")},function(e){(e.message="Duplicate email address")&&(e.message="This user is already registered."),t.set(e.message,"error")})}}angular.module("bdApp").controller("registerFormCtrl",e),e.$inject=["$scope","$location","user","$sce","messages"]}();
...
!function(){function e(e,r,a,s,n,o,t,i,u,d,l,c){function m(e){var r=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return r.test(e)}function p(e){var r=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(r)}function f(e){var r=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return r.test(e)}function F(e){for(var r=0;r<g.jeans.length;r++)if(g.jeans[r].id===e)return r}var g=this;n.closeAll(),g.popups=n.get(),g.messages=t.get(),g.data=c,console.log("LLLL"),console.log(g.data.lookup("order_statuses","id",5,"name")),g.jeans,d.call("getMyJeans",null,function(e){g.jeans=e}),g.orders=[],d.call("getMyOrders",null,function(e){g.orders=e}),g.onload=function(){o.vm=g},g.userForm={},g.userForm.editing={},g.userForm.saving={},g.userForm.data={},g.userForm.feedback={type:"",message:""},g.changeOrderItemName=function(){var e=g.displayOrder.order_items[0].id,r=g.displayJean.jean_name;d.call("postOrderItem",{id:e,jean_name:r})},g.userForm.cancel=function(e){g.userForm.editing[e]=!1,g.user[e]=g.userForm.data[e]},g.userForm.editField=function(e){g.userForm.data[e]=angular.copy(g.user[e]),g.userForm.editing[e]=!0},g.formatDate=function(r,a){var a=a||"MM/dd/yyyy",r=new Date(r);return e("date")(r,a)},g.userForm.validate=function(e,r){return"email"==e?!!m(r)||(t.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!p(r)||(t.set("Please enter a valid phone number","error"),!1))},g.userForm.save=function(e){g.userForm.validate(e,g.user[e])&&u.update(g.user,function(r){g.userForm.saving[e]=!1,g.userForm.editing[e]=!1})},g.user=u.get(),g.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){g.passForm.editing=!1,g.passForm.currentPass="",g.passForm.newPass="",g.passForm.newPassConfirm="",t.reset()}},g.validatePasswordForm=function(){return f(g.passForm.newPass)||t.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),g.passForm.newPass===g.passForm.newPassConfirm||(t.set("New Password and Confirmation do not match","error"),!1)},g.changePassword=function(){if(t.reset(),g.validatePasswordForm()){var e={id:g.user.id,password:g.passForm.newPass,old_password:g.passForm.currentPass};u.update(e,function(e){g.passForm.clear(),t.set("Password successfully changed.","success")},function(e){t.set(e.message,"error")})}},g.reOrder=function(e){r.path("/order/"+e+"/re-order")},g.copyJean=function(e){dataCode=d.getDataCode(e),s.setup(dataCode,!0),r.path("/customizer")},g.displayJean={},g.selectJean=function(e){g.popups.jeanProfile=!0,g.displayJean=e},g.selectOrder=function(e){g.popups.orderProfile=!0,g.displayOrder=e,g.displayJean=e.order_items[0]},g.deleteJean=function(e){d.call("deleteMyJean",e,function(r){var a=F(e);g.jeans.splice(a,1)})},g.orderJean=function(e){r.path("/order/"+e)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$filter","$location","$window","jean","popups","$scope","messages","loader","user","api","$routeParams","apiData"]}();
...
!function(){function e(e,r,d,o,a,n,s){var t=this;t.messages=e.get(),t.userLoggedIn=o.isLoggedIn(),t.user={loaded:!1},t.user=o.get(),t.user.loaded=!t.userLoggedIn,t.checkoutForm={},t.data=n,t.add={},t.formStep=1,t.fitMatch=d.orderDetails.split("-"),t.cards=null,t.cardForm={addingCard:!1,loadingCards:!0},t.authCallback=function(){t.user=o.get(),t.userLoggedIn=o.isLoggedIn()},t.logout=function(){o.logout(function(){t.user={},t.user.loaded=!0,t.userLoggedIn=o.isLoggedIn()},!1)},t.fire=function(){},r.$watch(function(){return t.user},function(e,r){if(console.log("USER CHANGED!!!"),console.log(e),console.log(!t.user.id),!t.user.id)return!1;if(console.log("still running..."),console.log("first run"),t.user.loaded=!0,t.user.addresses.length)for(i=0;i<t.user.addresses.length;i++)if(t.user.addresses[i].primary){t.add=t.user.addresses[i];break}e.square_id?(console.log("USER has sqid"),t.cardForm.loadingCards=!0,a.call("getMyCreditCards",null,function(e){e.length<1?t.cardForm.addingCard=!0:t.cards=e,t.cardForm.loadingCards=!1})):e.id&&!e.square_id?(console.log("USER doesn't sqid"),t.cardForm.addingCard=!0,t.cardForm.loadingCards=!1):(console.log("no user"),t.cardForm.loadingCards=!1)},!0),t.inputConfigOverrides={cardNumber:{placeholder:""},cvv:{placeholder:""},expirationDate:{placeholder:""}},t.inputStyles=[{backgroundColor:"#e8edef",padding:"10px",fontSize:"20px",lineHeight:"20px"}],t.nonceReceived=function(e,r){a.call("createMyCreditCard",{nonce:e},function(e){t.orderFitMatch(e.card_id)})},t.orderFitMatch=function(e){var r={credit_card_id:e,shipping_address_id:t.add.id,requested_fabric_ids:JSON.stringify(t.fitMatch)};a.call("createMyFitMatch",r,function(){s.path("/thank-you/fitmatch")})}}angular.module("bdApp").controller("fmCtrl",e),e.$inject=["messages","$scope","$routeParams","user","api","apiData","$location"]}();
