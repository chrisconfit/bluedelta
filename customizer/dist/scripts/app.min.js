...
!function(){function e(e,t,o,r,l,n){function a(e,t,o){e=e[0],t=t-e.offsetWidth/2+40;var r=e.scrollWidth-e.offsetWidth;t>=r&&(t=r-1),t==r&&(t=r-1);var l=Math.ceil(o/15),n=t-e.scrollLeft,a=n/l,c=e.scrollLeft<t?function(e,t){return e<=t-1}:function(e,t){return e>=t+1},s=setInterval(function(){if(c(e.scrollLeft,t)){var o=e.scrollLeft+a;o>=r&&(o=r-1),e.scrollLeft=o}else clearInterval(s)},15)}var c=this;c.popups=n.get(),c.jeanData=l.get(),c.breakPoint=800,c.touched=!1,c.selectorCoords={top:0,left:0},e.$watch("active",function(l,n){1==l&&o(function(){var o=c.jeanData[e.step.jeanKey],l=e.step.jeanKey+"_"+o;l=l.replace("_option_id","");var n=angular.element(document.querySelector("#"+l));c.selectorCoords.top=n.prop("offsetTop"),c.selectorCoords.left=n.prop("offsetLeft");var a=angular.element(document.querySelector("#"+e.step.jeanKey+"-selector"));if(a.css({top:c.selectorCoords.top+"px",left:c.selectorCoords.left+"px",width:n.prop("width")+"px",height:n.prop("height")+"px"}),r.innerWidth<c.breakPoint){var s=angular.element(t[0].querySelector(".chooser-grid")),p=s[0]?c.selectorCoords.left-s[0].offsetWidth/2+40:0;s.prop("scrollLeft",p)}else if(c.touched){var s=angular.element(t[0]);s.prop("scrollTop",c.selectorCoords.top-15)}},200)}),c.selectAttr=function(e,t,n,s){attrId=n.replace("_option_id",""),0==c.touched&&(c.touched=!0);var p=angular.element(document.querySelector("#"+attrId+"-chooser")),s=angular.element(document.querySelector("#"+attrId+"-selector")),i=angular.element(e.target).prop("offsetTop"),u=angular.element(e.target).prop("offsetLeft"),f=angular.element(document.querySelectorAll("#item-title")),d=angular.element(e.target)[0].clientWidth,h=angular.element(e.target)[0].clientHeight;f.css({right:"-400px",opacity:0}),s.css({top:i+"px",left:u+"px",width:d+"px",height:h+"px"}),c.selectorCoords={top:i,left:u},r.innerWidth<c.breakPoint&&a(p,u,200),o(function(){f.css({right:"15px",opacity:1}),l.set(n,t)},200)},c.jeanSet=function(e,t){c.jeanData[e]=t}}angular.module("bdApp").controller("chooserCtrl",e),e.$inject=["$scope","$element","$timeout","$window","jean","popups"]}();
...
!function(){function e(e,t,n,r){function o(e,t){var n=i[e](t);return n!==!1?"email"==e?window.open(n,"_self"):window.open(n,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600"):console.log("Error builiding social URL"),!1}var a=this;a.jean=e.jean,a.shareImageUploaded=e.shareImageUploaded,a.jeanToUrl=function(){var t="http://share.bluedeltajeans.com/";return t+=n.getDataCode(e.jean)};var i={},l="Custom Jeans by Blue Delta",s="Check out the jeans I made at the Blue Delta Jean Builder";i.facebook=function(e){if(!e)return!1;var t="https://www.facebook.com/sharer/sharer.php?u="+e;return t},i.twitter=function(e){return!!e&&"https://twitter.com/intent/tweet?text="+l+"&source=webclient&url="+e},i.email=function(e){return"mailto:?&subject="+l+"&body="+s+" - "+e},i.pinterest=function(e){return!!e&&"https://www.pinterest.com/pin/find/?description=sharing&url="+e+"&description="+l+"%0A"+s},a.share=function(e){var t=a.jeanToUrl();o(e,t)}}angular.module("bdApp").controller("socialCtrl",e),e.$inject=["$scope","popups","api","jean"]}();
...
!function(){function e(e,a,n,t,o,i,l,r,s,d,p,c){function u(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var g=this;g.loader=d.get(),s.reset(),g.messages=s.get(),r.closeAll(),g.popups=r.get();var h;o.jeanId&&(h=o.jeanId);var v=!1;o.action&&(v=o.action),i.setup(h,v).then(function(e){g.jeanData=i.get(),l.$watch(function(){return g.jeanData},function(e,a){g.shareImageUploaded=!1,g.displaySocial=!1,g.displaySocialHelper=!1,g.updateActiveItem()},!0),l.$watch(function(){return g.data},function(e,a){g.updateActiveItem()},!0)},function(e){(e.message="Invalid Jean ID")&&r.set("noJean",!0)}),g.landscape=u();var f="onorientationchange"in window,m=f?"orientationchange":"resize";window.addEventListener(m,function(){g.landscape=u(),l.$apply()},!1),g.data=p,g.activeItem={},g.updateActiveItem=function(){if(!g.jeanData)return!1;var e=g.data[g.panel[g.panelStep].dataKey],a=g.jeanData[g.panel[g.panelStep].jeanKey],t=n("filter")(e,{id:a});t&&(t=t[0]),g.activeItem=t||null},g.panel=[],g.panel.push({panelTemplate:"gender-chooser",dataKey:"gender_options",title:"Gender",jeanKey:"gender_option_id"}),g.panel.push({panelTemplate:"style-chooser",dataKey:"style_options",title:"Style",jeanKey:"style_option_id"}),g.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric_id"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread_id"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread_id"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread_id"}),g.panel.push({panelTemplate:"list",title:"Overview"}),g.panelDir="next",g.panelStep=0,g.changeStep=function(e){return!(e>=g.panel.length)&&(!(e<0)&&(void 0!==e&&(g.panelStep=e,void(e+1!=g.panel.length&&g.updateActiveItem()))))},h&&h.indexOf(":")>-1&&c.innerWidth<800&&(g.panelStep=2),g.savingBar=!1,g.newJeanName="My New Jeans",g.authCallback,g.saveCallback;var w=function(){r.set("saveOpts",!0)},y=function(e){t.path("/order/"+e.id)};g.saveAndOrder=function(){g.saveCallback=y,g.runSave()},g.saveAndShowOpts=function(){g.saveCallback=w,g.runSave()},g.keepEditing=function(){console.log("KEEP ED.."),console.log(g.jeanData.id),console.log(parseInt(o.jeanId)),parseInt(o.jeanId)!==g.jeanData.id?t.path("/customizer/"+g.jeanData.id):r.closeAll()},g.goToCloset=function(){t.path("/closet")},g.startOver=function(){i.reset(),g.jeanData=i.get(),r.closeAll()},g.runSave=function(){r.closeAll(),g.jeanData.name?(g.savingBar=!0,i.save().then(function(e){g.jeanData=e,g.savingBar=!1,g.saveCallback&&g.saveCallback(e)})):r.set("namer",!0)},g.placeOrder=function(){return a.isLoggedIn()?void g.saveAndOrder():(g.authCallback=g.saveAndOrder,r.set("loginOrRegister",!0),!1)},g.socialAuthCheck=function(e){return a.isLoggedIn()?void e():(g.authCallback=e,r.set("loginOrRegister",!0),!1)},g.saveJean=function(){return a.isLoggedIn()?void g.saveAndShowOpts():(g.authCallback=g.saveAndShowOpts,r.set("loginOrRegister",!0),!1)},g.registerCallback=function(e){},g.shareImageUploaded=!1,g.displaySocial=!1,g.displaySocialHelper=!1,g.share=function(a){if(console.log("here it is"),console.log(a),1==g[a])g[dispaly]=!1;else{g[a]=!0;var n=e.getDataCode(g.jeanData),t=angular.copy(g.jeanData);delete t.image,delete t.image_url,i.testJeanForExistingImage(t,n,function(a){a.image_url?g.shareImageUploaded=!0:e.call("uploadJeanThumb",a.image,function(e){console.log("Image has been uploaded: "+e.url),g.shareImageUploaded=!0})})}}}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["api","user","$filter","$location","$routeParams","jean","$scope","popups","messages","loader","apiData","$window"]}();
!function(){function e(e,r,d,a,n,i,t){var o=this;o.messages=e.get(),o.userLoggedIn=a.isLoggedIn(),o.user={loaded:!1},o.user=a.get(),o.user.loaded=!o.userLoggedIn,o.checkoutForm={},o.data=i,o.add={},o.formStep=1,o.fitMatch=d.orderDetails.split("-"),o.cards=null,o.cardForm={addingCard:!1,loadingCards:!0},o.authCallback=function(){o.user=a.get(),o.userLoggedIn=a.isLoggedIn()},o.logout=function(){a.logout(function(){o.user={},o.user.loaded=!0,o.userLoggedIn=a.isLoggedIn(),o.add={}},!1)},o.fire=function(){},r.$watch(function(){return o.user},function(e,r){if(!o.user.id)return!1;if(o.user.loaded=!0,o.user.addresses.length)for(var d=0;d<o.user.addresses.length;d++)if(o.user.addresses[d].primary){o.add=o.user.addresses[d];break}o.user.phone&&(o.shipping_phone=o.user.phone),e.square_id?(o.cardForm.loadingCards=!0,n.call("getMyCreditCards",null,function(e){e.length<1?o.cardForm.addingCard=!0:o.cards=e,o.cardForm.loadingCards=!1})):e.id&&!e.square_id?(console.log("USER doesn't sqid"),o.cardForm.addingCard=!0,o.cardForm.loadingCards=!1):(console.log("no user"),o.cardForm.loadingCards=!1)},!0),o.inputConfigOverrides={cardNumber:{placeholder:""},cvv:{placeholder:""},expirationDate:{placeholder:""}},o.inputStyles=[{backgroundColor:"#e8edef",padding:"10px",fontSize:"20px",lineHeight:"20px"}],o.nonceReceived=function(e,r){n.call("createMyCreditCard",{nonce:e},function(e){o.orderFitMatch(e.card_id)})},o.ordering=!1,o.orderFitMatch=function(e){if(o.ordering)return!1;if(o.ordering=!0,!o.validateFitMatch())return!1;var r={credit_card_id:e,shipping_address_id:o.add.id,shipping_phone:o.shipping_phone,requested_fabric_ids:JSON.stringify(o.fitMatch)};n.call("createMyFitMatch",r,function(){t.path("/thank-you/fitmatch")})},o.truncateBrand=function(e){return"AMERICAN_EXPRESS"==e?truncated="AMEX":"DISCOVER"==e?truncated="DISC":"MASTERCARD"==e?truncated="MSTR":truncated=e,truncated},o.fit_match_error=!1,o.validateFitMatch=function(){return o.fit_match_error=!1,o.add.id?!!o.shipping_phone||(o.fit_match_error="Please provide a phone number",!1):(o.fit_match_error="Please provide a shipping address",!1)},o.addCard=function(){o.validateFitMatch()&&o.fire()}}angular.module("bdApp").controller("fmCtrl",e),e.$inject=["messages","$scope","$routeParams","user","api","apiData","$location"]}();
