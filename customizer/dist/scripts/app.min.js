...
!function(){function e(e,i,n,r,o){function t(a){a=a||!0,e.editAdd={},e.model={},a&&(e.active=!1)}function s(a){e.user.addresses.splice(a,1)}e.editing=!1,e.active=!1,e.addForm={},e.model={};e.choosePrimary=function(i){for(a=0;a<e.user.addresses.length;a++)e.user.addresses[a].primary=a==i?1:0},e.startEditing=function(){e.user.addresses=i("orderBy")(e.user.addresses,"-primary"),e.editing=!0},e.stopEditing=function(){e.editing=!1},e.editAdd={},e.open=function(a){e.active=!0,e.user.addresses||(e.user.addresses=[]),"undefined"==typeof a?(e.model={},e.editAdd.index=e.user.addresses.push(e.model)-1,e.editAdd.data=null):(e.model=e.user.addresses[a],e.editAdd.index=a,e.editAdd.data=angular.copy(e.model))},e.clear=function(){var a=e.editAdd.data;null==a?s(e.editAdd.index):e.user.addresses[e.editAdd.index]=e.editAdd.data,t()},e.remove=function(a){if(e.user.addresses.length<2)return r.set("You can't remove your last address","error"),!1;var i=e.user.addresses[a].primary;s(a),i&&e.choosePrimary(0)},e.save=function(){var a=e.user.addresses.filter(function(a){return 1==a.primary});a.length||(e.user.addresses[0].primary=!0),o.call("postAddress",e.model,function(a){e.newAdd=null,e.active=!1,e.model={}})},e.states=[{name:"Alabama",abbreviation:"AL"},{name:"Alaska",abbreviation:"AK"},{name:"Arizona",abbreviation:"AZ"},{name:"Arkansas",abbreviation:"AR"},{name:"California",abbreviation:"CA"},{name:"Colorado",abbreviation:"CO"},{name:"Connecticut",abbreviation:"CT"},{name:"Delaware",abbreviation:"DE"},{name:"District Of Columbia",abbreviation:"DC"},{name:"Florida",abbreviation:"FL"},{name:"Georgia",abbreviation:"GA"},{name:"Hawaii",abbreviation:"HI"},{name:"Idaho",abbreviation:"ID"},{name:"Illinois",abbreviation:"IL"},{name:"Indiana",abbreviation:"IN"},{name:"Iowa",abbreviation:"IA"},{name:"Kansas",abbreviation:"KS"},{name:"Kentucky",abbreviation:"KY"},{name:"Louisiana",abbreviation:"LA"},{name:"Maine",abbreviation:"ME"},{name:"Maryland",abbreviation:"MD"},{name:"Massachusetts",abbreviation:"MA"},{name:"Michigan",abbreviation:"MI"},{name:"Minnesota",abbreviation:"MN"},{name:"Mississippi",abbreviation:"MS"},{name:"Missouri",abbreviation:"MO"},{name:"Montana",abbreviation:"MT"},{name:"Nebraska",abbreviation:"NE"},{name:"Nevada",abbreviation:"NV"},{name:"New Hampshire",abbreviation:"NH"},{name:"New Jersey",abbreviation:"NJ"},{name:"New Mexico",abbreviation:"NM"},{name:"New York",abbreviation:"NY"},{name:"North Carolina",abbreviation:"NC"},{name:"North Dakota",abbreviation:"ND"},{name:"Ohio",abbreviation:"OH"},{name:"Oklahoma",abbreviation:"OK"},{name:"Oregon",abbreviation:"OR"},{name:"Pennsylvania",abbreviation:"PA"},{name:"Rhode Island",abbreviation:"RI"},{name:"South Carolina",abbreviation:"SC"},{name:"South Dakota",abbreviation:"SD"},{name:"Tennessee",abbreviation:"TN"},{name:"Texas",abbreviation:"TX"},{name:"Utah",abbreviation:"UT"},{name:"Vermont",abbreviation:"VT"},{name:"Virginia",abbreviation:"VA"},{name:"Washington",abbreviation:"WA"},{name:"West Virginia",abbreviation:"WV"},{name:"Wisconsin",abbreviation:"WI"},{name:"Wyoming",abbreviation:"WY"}]}angular.module("bdApp").controller("addressChoiceCtrl",e),e.$inject=["$scope","$filter","bdAPI","messages","api"]}();
...
!function(){function e(e,s,r,a,n,o,t,i,u,l,d){function c(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function p(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function m(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function f(e){for(var s=0;s<F.user.jeans.length;s++)if(F.user.jeans[s].jeanId===e)return{index:s,data:F.user.jeans[s]}}var F=this;a.closeAll(),F.popups=a.get(),F.messages=i.get(),F.jean=r,F.data={},F.onload=function(){t.vm=F},F.userForm={},F.userForm.editing={},F.userForm.saving={},F.userForm.data={},F.userForm.feedback={type:"",message:""},F.userForm.cancel=function(e){F.userForm.editing[e]=!1,F.user[e]=F.userForm.data[e]},F.userForm.editField=function(e){F.userForm.data[e]=angular.copy(F.user[e]),F.userForm.editing[e]=!0},F.userForm.validate=function(e,s){return"email"==e?!!c(s)||(i.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!p(s)||(i.set("Please enter a valid phone number","error"),!1))},F.userForm.save=function(e){F.userForm.validate(e,F.user[e])&&(console.log(F.user),l.update(F.user,function(s){F.userForm.saving[e]=!1,F.userForm.editing[e]=!1}))},F.orders=[],d.call("getMyOrders",{},function(e){console.log(e),F.orders=e}),F.jeans=[],d.call("getMyJeans",{},function(e){console.log(e),F.jeans=e}),F.user=l.get(),F.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){F.passForm.editing=!1,F.passForm.currentPass="",F.passForm.newPass="",F.passForm.newPassConfirm="",i.reset()}},F.validatePasswordForm=function(){return m(F.passForm.newPass)||i.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),F.passForm.newPass===F.passForm.newPassConfirm||(i.set("New Password and Confirmation do not match","error"),!1)},F.changePassword=function(){if(i.reset(),F.validatePasswordForm()){var e={id:F.user.id,password:F.passForm.newPass,old_password:F.passForm.currentPass};l.update(e,function(e){F.passForm.clear(),i.set("Password successfully changed.","success")},function(e){i.set(e.message,"error")})}},F.copyJean=function(){F.jean=r.createNew(F.displayJean),e.path("/customizer")},F.displayJean={},F.selectJean=function(e){F.popups.jeanProfile=!0,F.displayJean=e},F.selectOrder=function(e){F.popups.orderProfile=!0,F.displayOrder=e,F.displayJean=e.orderItems[0].jean},F.deleteJean=function(e){r.deleter(F.user.identityId,e,function(s){var r=f(e).index;F.user.jeans.splice(r,1),t.$apply()})},F.orderJean=function(s){r.setup(s),e.path("/order/"+s.jeanId+"/"+F.user.identityId)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","$window","jean","popups","aws","bdAPI","$scope","messages","loader","user","api"]}();
...
!function(){function o(o,e,l,t){var n=this;for(i=0;i<l.tailors.length;i++){var r=l.tailors[i];console.log(r)}n.user=e.get(),console.log(o.localStorage.getItem("bdAccessToken"))}angular.module("bdApp").controller("homeCtrl",o),o.$inject=["$window","user","jsonData","api"]}();
