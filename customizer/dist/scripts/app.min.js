...
!function(){function e(e,t,r,a,o,n,d){function c(e){switch(e){case"g":return"gender_option_id";case"s":return"style_option_id";case"f":return"fabric_id";case"tt":return"top_thread_id";case"tb":return"bottom_thread_id";case"ta":return"accent_thread_id";default:return!1}}var s=function(e,t){var r=n[e];if(!r)return!1;for(i=0;i<r.length;i++)if(r[i][e+"Id"]==t)return r[i]},l={};set=function(e,t){l[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?l={gender_option_id:e.gender_option_id,style_option_id:e.style_option_id,fabric_id:e.fabric_id,accent_thread_id:e.accent_thread_id,top_thread_id:e.top_thread_id,bottom_thread_id:e.bottom_thread_id}:(l={gender_option_id:1,style_option_id:1,fabric_id:1004,accent_thread_id:1,top_thread_id:1,bottom_thread_id:1},l.saved=!1)},reset=function(){createNew()},buildJeanData=function(e,t){1==t&&(delete e.user_id,delete e.id,e.name&&(e.name="Copy of "+e.name));for(prop in e)e.hasOwnProperty(prop)&&set(prop,e[prop])};var u=function(e,r){var o=a.defer(),n=parseInt(t.localStorage.getItem("bdUserId")),i=!n;if(i="copy"==r||i,null!==e&&"object"==typeof e)console.log("working from object data!"),e.user_id&&e.user_id!==n&&delete e.id,buildJeanData(e,i),o.resolve(l);else if(null!==e&&void 0!==e&&e.split("-").length){var s={};dataArr=e.split("-");for(var u=0;u<dataArr.length;u++){var _=dataArr[u].split(":"),f=c(_[0]);s[f]=_[1]}console.log(s),buildJeanData(s,i),o.resolve(l)}else null!==e&&void 0!==e?(console.log(e,n,r,i),console.log("working from ID!"),d.call("getJean",e,function(e){e.user_id!==n&&(i=!0),buildJeanData(e,i),console.log(l),o.resolve(l)},function(e){o.reject(e)})):Object.keys(l).length>0?(console.log("jean data already exists!"),o.resolve(l)):(console.log("creating new jean!"),createNew(),o.resolve(l));return o.promise},_=function(){return l},f=function(e,t){d.call("deleteMyJean",e,function(e){t&&t(e)})},p=function(){console.log("saving jean...");var e=a.defer(),t=this,r=t.get(),o=d.getDataCode();return o+=".jpg",r.image={filename:o},d.createThumb(r).then(function(t){r.image.data=t,d.call("createMyJeans",r,function(t){e.resolve(t)},function(t){e.reject(t)})},function(t){e.reject(t)}),e.promise};return{dataLookup:s,deleter:f,save:p,get:_,set:set,setup:u,reset:reset,set:set,createNew:createNew,getDataCode:getDataCode}}angular.module("bdApp").service("jean",["$routeParams","$window","bdAPI","$q","aws","apiData","api",e])}();
...
!function(){function e(e,t,o,r,l,n){function a(e,t,o){e=e[0],t=t-e.offsetWidth/2+40;var r=e.scrollWidth-e.offsetWidth;t>=r&&(t=r-1),t==r&&(t=r-1);var l=Math.ceil(o/15),n=t-e.scrollLeft,a=n/l,c=e.scrollLeft<t?function(e,t){return e<=t-1}:function(e,t){return e>=t+1},s=setInterval(function(){if(c(e.scrollLeft,t)){var o=e.scrollLeft+a;o>=r&&(o=r-1),e.scrollLeft=o}else clearInterval(s)},15)}var c=this;c.popups=n.get(),c.jeanData=l.get(),c.breakPoint=800,c.selectorCoords={top:0,left:0},e.$watch("active",function(l,n){1==l&&o(function(){var o=c.jeanData[e.step.jeanKey];"object"==typeof o&&(o=o[e.step.dataKey4]);var l=e.step.jeanKey+"_"+o,n=angular.element(document.querySelector("#"+l));c.selectorCoords.top=n.prop("offsetTop"),c.selectorCoords.left=n.prop("offsetLeft");var a=angular.element(document.querySelector("#"+e.step.jeanKey+"-selector"));if(a.css({top:c.selectorCoords.top+"px",left:c.selectorCoords.left+"px"}),r.innerWidth<c.breakPoint){var s=angular.element(t[0].querySelector(".chooser-grid")),p=s[0]?c.selectorCoords.left-s[0].offsetWidth/2+40:0;s.prop("scrollLeft",p)}else{var s=angular.element(t[0]);s.prop("scrollTop",c.selectorCoords.top-15)}},200)}),c.selectAttr=function(e,t,n,s){var p=n.replace("_id",""),p=p.replace("_option",""),f=angular.element(document.querySelector("#"+p+"-chooser")),s=angular.element(document.querySelector("#"+n+"-selector")),i=angular.element(e.target).prop("offsetTop"),u=angular.element(e.target).prop("offsetLeft"),d=angular.element(document.querySelectorAll("#item-title"));d.css({right:"-400px",opacity:0}),s.css({top:i+"px",left:u+"px"}),c.selectorCoords={top:i,left:u},r.innerWidth<c.breakPoint&&a(f,u,200),o(function(){d.css({right:"15px",opacity:1}),l.set(n,t)},200)},c.jeanSet=function(e,t){c.jeanData[e]=t}}angular.module("bdApp").controller("chooserCtrl",e),e.$inject=["$scope","$element","$timeout","$window","jean","popups"]}();
...
!function(){function e(e,o){var t=this;t.jean=e.jean,console.log("jean!"),console.log(t.jean),t.jeanToUrl=function(){var e=document.location.origin+"/customizer/";return console.log("jeantoURL"),console.log(t.jean),t.jean.id?e+=t.jean.id:(e+="tt:"+t.jean.top_thread_id,e+="-tb:"+t.jean.bottom_thread_id,e+="-ta:"+t.jean.accent_thread_id,e+="-f:"+t.jean.fabric_id,e+="-s:"+t.jean.style_option_id,e+="-g:"+t.jean.gender_option_id,console.log("url!!"),console.log(e)),e+="/copy"};var n={},i="Check out my custom jeans built with Blue Delta!",a="Cras justo odio, dapibus ac facilisis in, egestas eget quam.";n.facebook=function(e,o){if(!e)return!1;var t="https://www.facebook.com/sharer/sharer.php?u="+e+"&description="+a+"&title="+i;return o&&(t+="&images="+urlencode(o)),t},n.twitter=function(e){return!!e&&"http://twitter.com/home?status="+i+"-"+e},n.email=function(e){return"mailto:?&subject="+i+"&body="+a+" - "+e},n.pinterest=function(e,o){return!e&&!o&&"https://pinterest.com/pin/create/button/?url="+e+"&media="+o+"&description="+i+"%0A"+a},console.log(e),t.share=function(e){var o=n[e](t.jeanToUrl());return o!==!1?"email"==e?window.open(o,"_self"):window.open(o,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600"):console.log("Error builiding social URL"),!1}}angular.module("bdApp").controller("socialCtrl",e),e.$inject=["$scope","popups"]}();
...
!function(){function e(e,s,r,a,n,o,t,i,l,u,c){function d(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function m(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function p(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function f(e){for(var s=0;s<g.jeans.length;s++)if(g.jeans[s].id===e)return s}var g=this;a.closeAll(),g.popups=a.get(),g.messages=o.get(),g.data=u,g.jeans,l.call("getMyJeans",null,function(e){g.jeans=e}),g.orders=[],l.call("getMyOrders",{},function(e){g.orders=e}),g.data=u,g.onload=function(){n.vm=g},g.userForm={},g.userForm.editing={},g.userForm.saving={},g.userForm.data={},g.userForm.feedback={type:"",message:""},g.userForm.cancel=function(e){g.userForm.editing[e]=!1,g.user[e]=g.userForm.data[e]},g.userForm.editField=function(e){g.userForm.data[e]=angular.copy(g.user[e]),g.userForm.editing[e]=!0},g.userForm.validate=function(e,s){return"email"==e?!!d(s)||(o.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!m(s)||(o.set("Please enter a valid phone number","error"),!1))},g.userForm.save=function(e){g.userForm.validate(e,g.user[e])&&(console.log(g.user),i.update(g.user,function(s){g.userForm.saving[e]=!1,g.userForm.editing[e]=!1}))},g.user=i.get(),g.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){g.passForm.editing=!1,g.passForm.currentPass="",g.passForm.newPass="",g.passForm.newPassConfirm="",o.reset()}},g.validatePasswordForm=function(){return p(g.passForm.newPass)||o.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),g.passForm.newPass===g.passForm.newPassConfirm||(o.set("New Password and Confirmation do not match","error"),!1)},g.changePassword=function(){if(o.reset(),g.validatePasswordForm()){var e={id:g.user.id,password:g.passForm.newPass,old_password:g.passForm.currentPass};i.update(e,function(e){g.passForm.clear(),o.set("Password successfully changed.","success")},function(e){o.set(e.message,"error")})}},g.copyJean=function(s){g.jean=r.createNew(g.displayJean),e.path("/customizer/")},g.displayJean={},g.selectJean=function(e){g.popups.jeanProfile=!0,g.displayJean=e},g.selectOrder=function(e){console.log("selecting Order"),console.log(e),g.popups.orderProfile=!0,g.displayOrder=e,g.displayJean=e.order_items[0],console.log(g.displayOrder)},g.deleteJean=function(e){l.call("deleteMyJean",e,function(s){console.log(s);var r=f(e);g.jeans.splice(r,1)})},g.orderJean=function(s){console.log("going to order"),e.path("/order/"+s)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","$window","jean","popups","$scope","messages","loader","user","api","apiData","$routeParams"]}();
!function(){function e(e,a,n,t,o,i,r,l,s,c,d,p,u,h,g,v){function f(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var w=this;w.loader=g.get(),h.reset(),w.messages=h.get(),p.closeAll(),w.popups=p.get();var m;l.jeanId&&(m=l.jeanId);var y=!1;l.action&&(y=l.action),console.log("JEAN SETUP"),console.log(m,y),c.setup(m,y).then(function(e){w.jeanData=c.get(),d.$watch(function(){return w.jeanData},function(e,a){w.updateActiveItem()},!0),d.$watch(function(){return w.data},function(e,a){w.updateActiveItem()},!0)},function(e){(e.message="Invalid Jean ID")&&p.set("noJean",!0)}),w.landscape=f();var j="onorientationchange"in window,A=j?"orientationchange":"resize";window.addEventListener(A,function(){w.landscape=f(),d.$apply()},!1),w.data=v,w.activeItem={},w.updateActiveItem=function(){if(!w.jeanData)return!1;var e=w.data[w.panel[w.panelStep].dataKey],a=w.jeanData[w.panel[w.panelStep].jeanKey],n=t("filter")(e,{id:a});n&&(n=n[0]),w.activeItem=n||null},w.panel=[],w.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender_option_id"}),w.panel.push({panelTemplate:"style-chooser",dataKey:"style_options",title:"Style",jeanKey:"style_option_id"}),w.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric_id"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread_id"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread_id"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread_id"}),w.panel.push({panelTemplate:"list",title:"Overview"}),w.panelDir="next",w.panelStep=0,w.changeStep=function(e){return!(e>=w.panel.length)&&(!(e<0)&&(void 0!==e&&(w.panelStep=e,void(e+1!=w.panel.length&&w.updateActiveItem()))))},w.savingBar=!1,w.newJeanName="My New Jeans",w.authCallback,w.saveCallback;var b=function(){console.log("running openSaveOpts..."),p.set("saveOpts",!0)},C=function(e){i.path("/order/"+e.id)};w.saveAndOrder=function(){w.saveCallback=C,w.runSave()},w.saveAndShowOpts=function(){console.log("running!!!"),w.saveCallback=b,w.runSave()},w.keepEditing=function(){i.path("/customizer/"+w.jeanData.id)},w.goToCloset=function(){i.path("/closet")},w.startOver=function(){c.reset(),w.jeanData=c.get(),console.log(c.get()),p.closeAll()},w.runSave=function(){p.closeAll(),w.jeanData.name?(w.savingBar=!0,c.save().then(function(e){w.jeanData=e,w.savingBar=!1,w.saveCallback&&w.saveCallback(e)})):p.set("namer",!0)},w.placeOrder=function(){return a.isLoggedIn()?void w.saveAndOrder():(w.authCallback=w.saveAndOrder,p.set("loginOrRegister",!0),!1)},w.socialAuthCheck=function(e){return a.isLoggedIn()?void e():(w.authCallback=e,p.set("loginOrRegister",!0),!1)},w.saveJean=function(){return a.isLoggedIn()?void w.saveAndShowOpts():(w.authCallback=w.saveAndShowOpts,p.set("loginOrRegister",!0),!1)},w.registerCallback=function(e){u.authenticateCognitoUser(e.email,e.password).then(function(e){w.authCallback()})}}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["api","user","$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","messages","loader","apiData"]}();
