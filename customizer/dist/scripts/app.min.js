...
!function(){function e(e,t,o,n,a,r,d){var c=function(e,t){var o=r[e];if(!o)return!1;for(i=0;i<o.length;i++)if(o[i][e+"Id"]==t)return o[i]},l={};set=function(e,t){l[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?l={gender_option_id:e.gender_option_id,style_option_id:e.style_option_id,fabric_id:e.fabric_id,accent_thread_id:e.accent_thread_id,top_thread_id:e.top_thread_id,bottom_thread_id:e.bottom_thread_id}:(l={gender_option_id:1,style_option_id:1,fabric_id:1004,accent_thread_id:1,top_thread_id:1,bottom_thread_id:1},l.saved=!1)},reset=function(){createNew()},buildJeanData=function(e,t){1==t&&(delete e.user_id,delete e.id,e.name="Copy of "+e.name);for(prop in e)e.hasOwnProperty(prop)&&set(prop,e[prop])};var s=function(e,o){var a=n.defer(),r=parseInt(t.localStorage.getItem("bdUserId")),i=!r;return i="copy"==o||i,null!==e&&"object"==typeof e?(console.log("working from object data!"),e.user_id&&e.user_id!==r&&delete e.id,buildJeanData(e,i),a.resolve(l)):null!==e&&void 0!==e?(console.log(e,r,o,i),console.log("working from ID!"),d.call("getJean",e,function(e){e.user_id!==r&&(i=!0),buildJeanData(e,i),console.log(l),a.resolve(l)},function(e){a.reject(e)})):Object.keys(l).length>0?(console.log("jean data already exists!"),a.resolve(l)):(console.log("creating new jean!"),createNew(),a.resolve(l)),a.promise},u=function(){return l},_=function(e,t){d.call("deleteMyJean",e,function(e){t&&t(e)})},f=function(){console.log("saving jean...");var e=n.defer(),t=this,o=t.get(),a=d.getDataCode();return a+=".jpg",o.image={filename:a},d.createThumb(o).then(function(t){o.image.data=t,d.call("createMyJeans",o,function(t){e.resolve(t)},function(t){e.reject(t)})},function(t){e.reject(t)}),e.promise};return{dataLookup:c,deleter:_,save:f,get:u,set:set,setup:s,reset:reset,set:set,createNew:createNew,getDataCode:getDataCode}}angular.module("bdApp").service("jean",["$routeParams","$window","bdAPI","$q","aws","apiData","api",e])}();
...
!function(){function e(e){var t=this;t.jean=e.jean,t.jeanToUrl=function(){if(!e.jean.id)return!1;var t=document.location.origin+"/customizer/"+e.jean.id;return t+="/copy"};var n={},o="Check out my custom jeans built with Blue Delta!",r="Cras justo odio, dapibus ac facilisis in, egestas eget quam.";n.facebook=function(e,t){if(!e)return!1;var n="https://www.facebook.com/sharer/sharer.php?u="+e+"&description="+r+"&title="+o;return t&&(n+="&images="+urlencode(t)),n},n.twitter=function(e){return!!e&&"http://twitter.com/home?status="+o+"-"+e},n.email=function(e){return"mailto:?&subject="+o+"&body="+r+" - "+e},n.pinterest=function(e,t){return!e&&!t&&"https://pinterest.com/pin/create/button/?url="+e+"&media="+t+"&description="+o+"%0A"+r},t.share=e.onsave(function(e){var o=n[e](t.jeanToUrl());return o!==!1?"email"==e?window.open(o,"_self"):window.open(o,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600"):console.log("Error builiding social URL"),!1})}angular.module("bdApp").controller("socialCtrl",e),e.$inject=["$scope"]}();
!function(){angular.module("bdApp").directive("socialActions",[function(){return{restrict:"EA",replace:!0,templateUrl:"/directives/social-actions/social-actions.template.html",scope:{jean:"=",display:"=",onsave:"="},controller:"socialCtrl as sovm"}}])}();
...
!function(){function e(e,s,r,a,n,o,t,i,l,u,c){function d(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function p(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function m(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function f(e){for(var s=0;s<g.jeans.length;s++)if(g.jeans[s].id===e)return s}var g=this;a.closeAll(),g.popups=a.get(),g.messages=o.get(),g.data=u,g.jeans,l.call("getMyJeans",null,function(e){g.jeans=e}),g.orders=[],l.call("getMyOrders",{},function(e){g.orders=e}),g.data=u,g.onload=function(){n.vm=g},g.userForm={},g.userForm.editing={},g.userForm.saving={},g.userForm.data={},g.userForm.feedback={type:"",message:""},g.userForm.cancel=function(e){g.userForm.editing[e]=!1,g.user[e]=g.userForm.data[e]},g.userForm.editField=function(e){g.userForm.data[e]=angular.copy(g.user[e]),g.userForm.editing[e]=!0},g.userForm.validate=function(e,s){return"email"==e?!!d(s)||(o.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!p(s)||(o.set("Please enter a valid phone number","error"),!1))},g.userForm.save=function(e){g.userForm.validate(e,g.user[e])&&(console.log(g.user),i.update(g.user,function(s){g.userForm.saving[e]=!1,g.userForm.editing[e]=!1}))},g.user=i.get(),g.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){g.passForm.editing=!1,g.passForm.currentPass="",g.passForm.newPass="",g.passForm.newPassConfirm="",o.reset()}},g.validatePasswordForm=function(){return m(g.passForm.newPass)||o.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),g.passForm.newPass===g.passForm.newPassConfirm||(o.set("New Password and Confirmation do not match","error"),!1)},g.changePassword=function(){if(o.reset(),g.validatePasswordForm()){var e={id:g.user.id,password:g.passForm.newPass,old_password:g.passForm.currentPass};i.update(e,function(e){g.passForm.clear(),o.set("Password successfully changed.","success")},function(e){o.set(e.message,"error")})}},g.copyJean=function(s){g.jean=r.createNew(g.displayJean),e.path("/customizer/"+s+"/copy")},g.displayJean={},g.selectJean=function(e){g.popups.jeanProfile=!0,g.displayJean=e},g.selectOrder=function(e){console.log("selecting Order"),console.log(e),g.popups.orderProfile=!0,g.displayOrder=e,g.displayJean=e.order_items[0],console.log(g.displayOrder)},g.deleteJean=function(e){l.call("deleteMyJean",e,function(s){console.log(s);var r=f(e);g.jeans.splice(r,1)})},g.orderJean=function(s){console.log("going to order"),e.path("/order/"+s)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","$window","jean","popups","$scope","messages","loader","user","api","apiData","$routeParams"]}();
