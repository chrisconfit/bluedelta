...
!function(){function o(o,e,l,r){var a=this;for(i=0;i<l.fabric.length;i++){var c=l.fabric[i];c.id=c.fabricId,delete c.fabricId,r.call("createFabric",c,function(o){console.log("Created!"),console.log(o)})}for(i=0;i<l.tailors.length;i++){var c=l.tailors[i];console.log(c)}a.user=e.get(),console.log(o.localStorage.getItem("bdAccessToken"))}angular.module("bdApp").controller("homeCtrl",o),o.$inject=["$window","user","jsonData","api"]}();
