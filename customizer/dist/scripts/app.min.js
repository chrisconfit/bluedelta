...
!function(){function o(o,n,e){var c=function(n){return console.log(n[0],n[1]),o.get("/")},t=function(o,n,c,t){console.log(o),console.log(this),this[o](n).success(function(o){e.$$phase||e.$apply(),c&&c(o.data)}).error(function(o){console.log(o.message),t&&t(o)})};return{call:t,login:c}}angular.module("bdApp").service("api",o),o.$inject=["$http","$q","$rootScope"]}();
...
!function(){function e(e,t,r,a,n,o){function s(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function c(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function d(e){return a(function(t,r){var a=new Image;a.crossOrigin="",a.src=e,a.onload=function(){t(a)},a.onerror=function(e){r(e)}})}function u(e,t,r){for(i=0;i<r.length;i++){var a=r[i];a.src.indexOf("/"+e+"/")>-1&&t.drawImage(a,0,0,600,696)}}var f=function(e,t){var r=o[e];if(!r)return!1;for(i=0;i<r.length;i++)if(r[i][e+"Id"]==t)return r[i]},g={};set=function(e,t){g[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?g={gender:e.gender,style:e.style,fabric:e.fabric.fabricId,accent_thread:e.accent_thread.threadId,top_thread:e.top_thread.threadId,bottom_thread:e.bottom_thread.threadId}:(g={gender:1,style:1,fabric:f("fabric",1004),accent_thread:f("thread",1),top_thread:f("thread",1),bottom_thread:f("thread",1)},g.saved=!1)},reset=function(){createNew()};var l=function(t){var o=a.defer();if(t){for(prop in t)t.hasOwnProperty(prop)&&set(prop,t[prop]);o.resolve(g)}else if(e.jeanId&&!e.userId){if(createNew(),e.jeanId.indexOf(":")>0){g=e.jeanId.split(":");for(var c=0;c<g.length;c++){var d=g[c].match(/([A-Za-z]+)([0-9]+)/);if(d){var i=s(d[1]);i&&(g[i]=parseInt(d[2]))}}}o.resolve(g)}else e.jeanId&&e.userId?(console.log(e.userId,e.jeanId),r.jeansGet(e.userId,e.jeanId).then(function(t){var a=t.data,s=n.getCurrentUserFromLocalStorage();if(s){var c=r.setupHeaders(s);if(c==e.userId)for(prop in a)a.hasOwnProperty(prop)&&set(prop,a[prop]);else createNew(a)}else createNew(a);o.resolve(g)},function(e){console.log(e),createNew(),o.resolve(g)})):Object.keys(g).length>0?o.resolve(g):0===Object.keys(g).length&&g.constructor===Object&&(createNew(),o.resolve(g));return o.promise},h=function(){return g},p=function(e){var t=document.createElement("canvas");t.width=600,t.height=600;for(var r=t.getContext("2d"),n=[],o=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabric/g"+e.gender+"/s2/f"+e.fabric.fabricId+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/thread/g"+e.gender+"/s2/tb/"+e.bottom_thread.threadId+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/thread/g"+e.gender+"/s2/tt/"+e.top_thread.threadId+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/thread/g"+e.gender+"/s2/ta/"+e.accent_thread.threadId+".png"],s=0;s<o.length;s++)n.push(d(o[s],r));return a.all(n).then(function(e){console.log("all images loaded"),u("fabric",r,e),u("tb",r,e),u("tt",r,e),u("ta",r,e);var a=t.toDataURL("image/jpeg");return a},function(e){console.log(e)})};getDataCode=function(){var e="";for(var t in g)if(g.hasOwnProperty(t)){var r=g[t];if("object"==typeof r){var a=t+"Id";a.indexOf("thread")>-1&&(a="threadId"),r=r[a]}var n=c(t);n&&(e+="_"+n+r)}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var m=function(e,t,a){var o=n.getCurrentUserFromLocalStorage();r.defaultHeaders_.Authorization=o.idToken.getJwtToken(),r.jeansDelete(e,t).then(function(e){a&&a(e)},function(e){console.log(e)})},b=function(){var e=a.defer(),t=this,o=t.get(),s=t.getDataCode();return s+=".jpg",this.createThumb(o).then(function(a){var c=n.getCurrentUserFromLocalStorage();c?n.saveImageTos3(a,c,s).then(function(a){t.set("imageURL",a);var s=n.getCurrentIdentityId(),c=o.jeanId?[s,o.jeanId,o]:[s,o],d=o.jeanId?"jeansUpdate":"jeansCreate";r.call(d,c,function(r){var a=r.data.jeans[r.data.jeans.length-1];o.jeanId||t.set("jeanId",a.jeanId),e.resolve(r)},function(t){e.reject(t)})},function(t){console.log(t),e.reject(t.message)}):e.reject("You are not logged in...")}),e.promise};return{dataLookup:f,deleter:m,save:b,get:h,setup:l,reset:reset,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:p}}angular.module("bdApp").service("jean",["$routeParams","$window","bdAPI","$q","aws","jsonData",e])}();
...
!function(){function n(n){var e={isLoggedIn:!1},i=function(n,i){return e[n]=i,e},u=function(e,u){n.call("login",[e,u],function(n){i("username","cplefevre"),i("isLoggedIn",!0)})};return{get:function(){return e},set:i,login:u}}angular.module("bdApp").service("user",n),n.$inject=["api"]}();
...
!function(){function o(o,e,n,r,t,a){var i=this;i.loader=a.get("loader"),i.saver=a.get("saver"),i.drops={},i.drops.acct=!1,i.mobileMenu=!1,i.isLoggedIn=r.isLoggedIn(),i.logout=function(){r.signCurrentUserOut(),"/"==o.path()&&e.reload()}}angular.module("bdApp").controller("navigationCtrl",o),o.$inject=["$location","$route","popups","aws","$window","loader"]}();
...
!function(){function e(e,s,r,a,n,t,o,i,u){function l(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function d(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function c(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function m(e){for(var s=0;s<p.user.jeans.length;s++)if(p.user.jeans[s].jeanId===e)return{index:s,data:p.user.jeans[s]}}u.show("Getting your profile information...");var p=this;a.closeAll(),p.popups=a.get(),p.messages=i.get(),p.jean=r,p.data={},p.jeans=p.data.jeansList,p.onload=function(){o.vm=p},p.userForm={},p.userForm.editing={},p.userForm.saving={},p.userForm.feedback={type:"",message:""},p.userForm.cancel=function(e){p.userForm.editing[e]=!1,p.user[e]=p.userForm.data[e]},p.userForm.validate=function(e,s){return"email"==e?!!l(s)||(i.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!d(s)||(i.set("Please enter a valid phone number","error"),!1))},p.userForm.save=function(e){""==p.user[e]&&(p.user[e]=null),p.userForm.validate(e,p.user[e])&&(p.userForm.saving[e]=!0,t.call("usersUpdate",[p.user.identityId,p.user],function(s){p.userForm.saving[e]=!1,p.userForm.editing[e]=!1,p.userForm.data[e]=p.user[e],o.$apply()}))},p.orders=[];var f=n.getCurrentIdentityId();f?(t.call("ordersList",100,function(e){p.orders=e.data.items}),t.call("usersGet",f,function(e){u.hide(),p.user=e.data,p.userForm.data=angular.copy(e.data)})):e.path("/"),p.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){p.passForm.editing=!1,p.passForm.currentPass="",p.passForm.newPass="",p.passForm.newPassConfirm="",i.reset()}},p.validatePasswordForm=function(){return c(p.passForm.newPass)||i.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),p.passForm.newPass===p.passForm.newPassConfirm||(i.set("New Password and Confirmation do not match","error"),!1)},p.changePassword=function(){i.reset(),p.validatePasswordForm()&&n.changePassword(p.user.email,p.passForm.currentPass,p.passForm.newPass).then(function(e){p.passForm.clear(),i.set("Password successfully changed.","success")},function(e){i.set(e.message,"error")})},p.copyJean=function(){p.jean=r.createNew(p.displayJean),e.path("/customizer")},p.displayJean={},p.selectJean=function(e){p.popups.jeanProfile=!0,p.displayJean=e},p.selectOrder=function(e){p.popups.orderProfile=!0,p.displayOrder=e,p.displayJean=e.orderItems[0].jean},p.deleteJean=function(e){r.deleter(p.user.identityId,e,function(s){var r=m(e).index;p.user.jeans.splice(r,1),o.$apply()})},p.orderJean=function(s){r.setup(s),e.path("/order/"+s.jeanId+"/"+p.user.identityId)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","$window","jean","popups","aws","bdAPI","$scope","messages","loader"]}();
...
!function(){function o(o){var e=this;e.user=o.get(),o.login("cplefevre@gmail.com","i@mF@tty23",function(o){console.log("second user"),console.log(e.user)}),console.log("first user"),console.log(e.user)}angular.module("bdApp").controller("homeCtrl",o),o.$inject=["user"]}();
