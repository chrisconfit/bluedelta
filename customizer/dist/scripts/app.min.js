...
!function(){function e(e,t,o,a,n,r,d){function s(e){switch(e){case"gender_option_id":return"g";case"style_option_id":return"s";case"fabric_id":return"f";case"top_thread_id":return"tt";case"bottom_thread_id":return"tb";case"accent_thread_id":return"ta";default:return!1}}function c(e){return a(function(t,o){var a=new Image;a.crossOrigin="",a.src=e,a.onload=function(){t(a)},a.onerror=function(e){o(e)}})}function l(e,t,o){for(i=0;i<o.length;i++){var a=o[i];a.src.indexOf("/"+e+"/")>-1&&t.drawImage(a,0,0,600,696)}}var u=function(e,t){var o=r[e];if(!o)return!1;for(i=0;i<o.length;i++)if(o[i][e+"Id"]==t)return o[i]},_={};set=function(e,t){_[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?_={gender_option_id:e.gender_option_id,style_option_id:e.style_option_id,fabric_id:e.fabric_id,accent_thread_id:e.accent_thread_id,top_thread_id:e.top_thread_id,bottom_thread_id:e.bottom_thread_id}:(_={gender_option_id:1,style_option_id:1,fabric_id:1004,accent_thread_id:1,top_thread_id:1,bottom_thread_id:1},_.saved=!1)},reset=function(){createNew()},buildJeanData=function(e,t){1==t&&(delete e.user_id,delete e.id,e.name="Copy of "+e.name);for(prop in e)e.hasOwnProperty(prop)&&set(prop,e[prop])};var g=function(e,o){var n=a.defer(),r=parseInt(t.localStorage.getItem("bdUserId")),i=!r;return i="copy"==o||i,null!==e&&"object"==typeof e?(console.log("working from object data!"),e.user_id&&e.user_id!==r&&delete e.id,buildJeanData(e,i),n.resolve(_)):null!==e&&void 0!==e?(console.log(e,r,o,i),console.log("working from ID!"),d.call("getJean",e,function(e){e.user_id!==r&&(i=!0),buildJeanData(e,i),console.log(_),n.resolve(_)},function(e){n.reject(e)})):Object.keys(_).length>0?(console.log("jean data already exists!"),n.resolve(_)):(console.log("creating new jean!"),createNew(),n.resolve(_)),n.promise},p=function(){return _},f=function(e){var t=document.createElement("canvas");t.width=600,t.height=600;for(var o=t.getContext("2d"),n=[],r=["http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/fabrics/g"+e.gender_option_id+"/s2/f"+e.fabric_id+".jpg","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tb/"+e.bottom_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/tt/"+e.top_thread_id+".png","http://bluedelta-data.s3-website-us-east-1.amazonaws.com/images/components/threads/g"+e.gender_option_id+"/s2/ta/"+e.accent_thread_id+".png"],i=0;i<r.length;i++)n.push(c(r[i],o));return a.all(n).then(function(e){l("fabrics",o,e),l("tb",o,e),l("tt",o,e),l("ta",o,e);var a=t.toDataURL("image/jpeg");return a},function(e){console.log(e)})};getDataCode=function(){var e="";console.log("get data code!!!"),console.log(_);for(var t in _)if(_.hasOwnProperty(t)){var o=_[t],a=s(t);console.log(t,a,o),a&&(e+="_"+a+o)}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,""),console.log(e),e};var h=function(e,t){d.call("deleteMyJean",e,function(e){t&&t(e)})},m=function(){console.log("saving jean...");var e=a.defer(),t=this,o=t.get(),n=t.getDataCode();return n+=".jpg",o.image={filename:n},this.createThumb(o).then(function(t){o.image.data=t,d.call("createMyJeans",o,function(t){console.log("We have created the jean"),console.log(t),e.resolve(t)},function(t){e.reject(t)})},function(t){e.reject(t)}),e.promise};return{dataLookup:u,deleter:h,save:m,get:p,set:set,setup:g,reset:reset,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:f}}angular.module("bdApp").service("jean",["$routeParams","$window","bdAPI","$q","aws","apiData","api",e])}();
...
!function(){function e(e,i,n,r,o){function t(a){a=a||!0,e.editAdd={},e.model={},a&&(e.active=!1)}function b(a){e.vm.user.address.splice(a,1)}e.editing=!1,e.active=!1,e.addForm={},e.model={};e.choosePrimary=function(i){for(console.log("choosing primary!!"),console.log(i),a=0;a<e.vm.user.address.length;a++){var n=e.vm.user.address[a];n.primary=n.id==i.id}o.call("postAddress",i,function(a){console.log("saved")})},e.startEditing=function(){e.vm.user.address=i("orderBy")(e.vm.user.address,"-primary"),e.editing=!0},e.stopEditing=function(){e.editing=!1},e.editAdd={},e.open=function(a){e.active=!0,e.vm.user.address||(e.vm.user.address=[]),"undefined"==typeof a?(e.model={},e.editAdd.index=e.vm.user.address.push(e.model)-1,e.editAdd.data=null):(e.model=e.vm.user.address[a],e.editAdd.index=a,e.editAdd.data=angular.copy(e.model))},e.clear=function(){var a=e.editAdd.data;null==a?b(e.editAdd.index):e.vm.user.address[e.editAdd.index]=e.editAdd.data,t()},e.remove=function(a){if(e.vm.user.address.length<2)return r.set("You can't remove your last address","error"),!1;var i=e.vm.user.address[a].primary;b(a),i&&e.choosePrimary(0),n.saveUser(e.vm.user)},e.save=function(){var a=e.vm.user.address.filter(function(a){return 1==a.primary});a.length||(e.vm.user.address[0].primary=!0),n.saveUser(e.vm.user).then(function(a){e.newAdd=null,e.active=!1,e.model={},e.$apply()})},e.states=[{name:"Alabama",abbreviation:"AL"},{name:"Alaska",abbreviation:"AK"},{name:"Arizona",abbreviation:"AZ"},{name:"Arkansas",abbreviation:"AR"},{name:"California",abbreviation:"CA"},{name:"Colorado",abbreviation:"CO"},{name:"Connecticut",abbreviation:"CT"},{name:"Delaware",abbreviation:"DE"},{name:"District Of Columbia",abbreviation:"DC"},{name:"Florida",abbreviation:"FL"},{name:"Georgia",abbreviation:"GA"},{name:"Hawaii",abbreviation:"HI"},{name:"Idaho",abbreviation:"ID"},{name:"Illinois",abbreviation:"IL"},{name:"Indiana",abbreviation:"IN"},{name:"Iowa",abbreviation:"IA"},{name:"Kansas",abbreviation:"KS"},{name:"Kentucky",abbreviation:"KY"},{name:"Louisiana",abbreviation:"LA"},{name:"Maine",abbreviation:"ME"},{name:"Maryland",abbreviation:"MD"},{name:"Massachusetts",abbreviation:"MA"},{name:"Michigan",abbreviation:"MI"},{name:"Minnesota",abbreviation:"MN"},{name:"Mississippi",abbreviation:"MS"},{name:"Missouri",abbreviation:"MO"},{name:"Montana",abbreviation:"MT"},{name:"Nebraska",abbreviation:"NE"},{name:"Nevada",abbreviation:"NV"},{name:"New Hampshire",abbreviation:"NH"},{name:"New Jersey",abbreviation:"NJ"},{name:"New Mexico",abbreviation:"NM"},{name:"New York",abbreviation:"NY"},{name:"North Carolina",abbreviation:"NC"},{name:"North Dakota",abbreviation:"ND"},{name:"Ohio",abbreviation:"OH"},{name:"Oklahoma",abbreviation:"OK"},{name:"Oregon",abbreviation:"OR"},{name:"Pennsylvania",abbreviation:"PA"},{name:"Rhode Island",abbreviation:"RI"},{name:"South Carolina",abbreviation:"SC"},{name:"South Dakota",abbreviation:"SD"},{name:"Tennessee",abbreviation:"TN"},{name:"Texas",abbreviation:"TX"},{name:"Utah",abbreviation:"UT"},{name:"Vermont",abbreviation:"VT"},{name:"Virginia",abbreviation:"VA"},{name:"Washington",abbreviation:"WA"},{name:"West Virginia",abbreviation:"WV"},{name:"Wisconsin",abbreviation:"WI"},{name:"Wyoming",abbreviation:"WY"}]}angular.module("bdApp").controller("addFormCtrl",e),e.$inject=["$scope","$filter","bdAPI","messages","api"]}();
!function(){function e(e,s,r,a,n,o,t,i,u,l,c){function d(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function m(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function p(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function f(e){for(var s=0;s<F.jeans.length;s++)if(F.jeans[s].id===e)return s}var F=this;a.closeAll(),F.popups=a.get(),F.messages=o.get(),F.data=l,F.jeans,u.call("getMyJeans",null,function(e){F.jeans=e}),F.orders=[],u.call("getMyOrders",{},function(e){F.orders=e}),F.data=l,F.onload=function(){n.vm=F},F.userForm={},F.userForm.editing={},F.userForm.saving={},F.userForm.data={},F.userForm.feedback={type:"",message:""},F.userForm.cancel=function(e){F.userForm.editing[e]=!1,F.user[e]=F.userForm.data[e]},F.userForm.editField=function(e){F.userForm.data[e]=angular.copy(F.user[e]),F.userForm.editing[e]=!0},F.userForm.validate=function(e,s){return"email"==e?!!d(s)||(o.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!m(s)||(o.set("Please enter a valid phone number","error"),!1))},F.userForm.save=function(e){F.userForm.validate(e,F.user[e])&&(console.log(F.user),i.update(F.user,function(s){F.userForm.saving[e]=!1,F.userForm.editing[e]=!1}))},F.user=i.get(),F.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){F.passForm.editing=!1,F.passForm.currentPass="",F.passForm.newPass="",F.passForm.newPassConfirm="",o.reset()}},F.validatePasswordForm=function(){return p(F.passForm.newPass)||o.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),F.passForm.newPass===F.passForm.newPassConfirm||(o.set("New Password and Confirmation do not match","error"),!1)},F.changePassword=function(){if(o.reset(),F.validatePasswordForm()){var e={id:F.user.id,password:F.passForm.newPass,old_password:F.passForm.currentPass};i.update(e,function(e){F.passForm.clear(),o.set("Password successfully changed.","success")},function(e){o.set(e.message,"error")})}},F.copyJean=function(s){F.jean=r.createNew(F.displayJean),e.path("/customizer/"+s+"/copy")},F.displayJean={},F.selectJean=function(e){F.popups.jeanProfile=!0,F.displayJean=e},F.selectOrder=function(e){F.popups.orderProfile=!0,F.displayOrder=e,F.displayJean=e.orderItems[0].jean},F.deleteJean=function(e){u.call("deleteMyJean",e,function(s){console.log(s);var r=f(e);F.jeans.splice(r,1)})},F.orderJean=function(s){console.log("going to order"),e.path("/order/"+s)}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","$window","jean","popups","$scope","messages","loader","user","api","apiData","$routeParams"]}();
!function(){function e(e,a,n,t,i,o,r,l,s,d,p,c,u,h,v,g){function f(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var w=this;w.loader=v.get(),h.reset(),w.messages=h.get(),c.closeAll(),w.popups=c.get();var m;l.jeanId&&(m=l.jeanId);var y=!1;l.action&&(y=l.action),d.setup(m,y).then(function(e){w.jeanData=d.get(),p.$watch(function(){return w.jeanData},function(e,a){w.updateActiveItem()},!0),p.$watch(function(){return w.data},function(e,a){w.updateActiveItem()},!0)},function(e){(e.message="Invalid Jean ID")&&c.set("noJean",!0)}),w.landscape=f();var j="onorientationchange"in window,b=j?"orientationchange":"resize";window.addEventListener(b,function(){w.landscape=f(),p.$apply()},!1),w.data=g,w.activeItem={},w.updateActiveItem=function(){if(!w.jeanData)return!1;var e=w.data[w.panel[w.panelStep].dataKey],a=w.jeanData[w.panel[w.panelStep].jeanKey],n=t("filter")(e,{id:a});n&&(n=n[0]),w.activeItem=n||null},w.panel=[],w.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender_option_id"}),w.panel.push({panelTemplate:"style-chooser",dataKey:"style_options",title:"Style",jeanKey:"style_option_id"}),w.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric_id"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread_id"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread_id"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread_id"}),w.panel.push({panelTemplate:"list",title:"Overview"}),w.panelDir="next",w.panelStep=0,w.changeStep=function(e){return!(e>=w.panel.length)&&(!(e<0)&&(void 0!==e&&(w.panelStep=e,void(e+1!=w.panel.length&&w.updateActiveItem()))))},w.savingBar=!1,w.newJeanName="My New Jeans",w.authCallback,w.saveCallback;var A=function(){console.log("running openSaveOpts..."),c.set("saveOpts",!0)},C=function(e){o.path("/order/"+e.id)};w.saveAndOrder=function(){w.saveCallback=C,w.runSave()},w.saveAndShowOpts=function(){console.log("running!!!"),w.saveCallback=A,w.runSave()},w.keepEditing=function(){o.path("/customizer/"+w.jeanData.id)},w.goToCloset=function(){o.path("/closet")},w.startOver=function(){d.reset(),w.jeanData=d.get(),console.log(d.get()),c.closeAll()},w.runSave=function(){c.closeAll(),w.jeanData.name?(w.savingBar=!0,d.save().then(function(e){w.jeanData=e,w.savingBar=!1,w.saveCallback&&w.saveCallback(e)})):c.set("namer",!0)},w.placeOrder=function(){return a.isLoggedIn()?void w.saveAndOrder():(w.authCallback=w.saveAndOrder,c.set("loginOrRegister",!0),!1)},w.saveJean=function(){return a.isLoggedIn()?void w.saveAndShowOpts():(w.authCallback=w.saveAndShowOpts,c.set("loginOrRegister",!0),!1)},w.registerCallback=function(e){u.authenticateCognitoUser(e.email,e.password).then(function(e){w.authCallback()})}}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["api","user","$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","messages","loader","apiData"]}();
