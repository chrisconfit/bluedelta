...
!function(){function e(e,t,o,n){function r(){var e={UserPoolId:n.USER_POOL_ID,ClientId:n.CLIENT_ID},t=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return t}function s(e,t){var o={Username:e,Password:t},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(o);return n}function a(e,t){var o={Username:e,Pool:t},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(o);return n}function u(e,t){var o={Name:e,Value:t},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(o);return n}function c(e,t){var o,n=[];for(var r in t)o=e(r,t[r]),n.push(o);return n}function l(e){logins={};var t="cognito-idp."+n.REGION+".amazonaws.com/"+n.USER_POOL_ID;return logins[t]=e,AWS.config.update({region:n.REGION}),AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID,Logins:logins}),AWS.config.credentials.getPromise()}return getUserFromLocalStorage=function(e){var t=a(e,r());null!=t&&t.getSession(function(e,t){return e?void alert(e):void console.log("session validity: "+t.isValid())})},deleteCognitoUser=function(){var e=r().getCurrentUser();e.deleteUser(function(e,t){return e?void alert(e):void console.log("call result: "+t)})},authenticateViaFB=function(){var e=o.defer();return FB.login(function(t){t.authResponse?(AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID,Logins:{"graph.facebook.com":t.authResponse.accessToken}}),e.resolve()):e.reject("There was a problem logging in with Facebook.")}),e.promise},authenticateCognitoUser=function(e,n){var i=s(e,n),u=a(e,r()),c=o.defer();return u.authenticateUser(i,{onSuccess:function(e){c.resolve(e),t.localStorage.isLoggedIn=!0},onFailure:function(e){c.reject(e)},newPasswordRequired:function(e,t){console.log(e,t)}}),c.promise},signupForApplication=function(e,t,n){var i=o.defer(),s=c(u,{email:e,name:t});console.log(s);return r().signUp(e,n,s,null,function(e,t){e?i.reject(e):i.resolve(t)}),i.promise},updateAttributesOnUser=function(e,t){var o=c(u,t),n=a(e,r());n.updateAttributes(o,function(e,t){return e?void alert(e):void console.log("call result: "+t)})},deleteUserAttributes=function(e,t){e.deleteAttributes(t,function(e,t){return e?void alert(e):void console.log("call result: "+t)})},verifyUserAttribute=function(e,t){e.getAttributeVerificationCode(t,{onSuccess:function(e){console.log("call result: "+e)},onFailure:function(e){alert(e)},inputVerificationCode:function(){var o=prompt("Please input verification code: ","");e.verifyAttribute(t,o,this)}})},retrieveUserAttributes=function(e){e.getUserAttributes(function(e,t){if(e)return void alert(e);for(i=0;i<t.length;i++)console.log("attribute "+t[i].getName()+" has value "+t[i].getValue())})},resendConfirmationCode=function(e){e.resendConfirmationCode||(e=a(e,r())),e.resendConfirmationCode(function(e,t){return!e||void console.log(e)})},confirmRegistration=function(e,t){e.confirmRegistration(t,!0,function(e,t){return e?void alert(e):void alert(t)})},changePassword=function(e,t,n){var i=o.defer(),s=a(e,r());return null!=s?s.getSession(function(e,o){e?i.reject(e):s.changePassword(t,n,function(e,t){e?i.reject(e):i.resolve(t)})}):i.reject("You are not logged in."),i.promise},forgotPassword=function(e){var t=o.defer(),n=a(e,r());return n.forgotPassword({onSuccess:function(e){console.log("forgotPassword success... for some reason the email didn't send..."),console.log(e),t.reject(e)},onFailure:function(e){console.log(e),t.reject(e)},inputVerificationCode:function(e){console.log("Code sent to:"),console.log(e),t.resolve("email sent")}}),t.promise},setNewPassword=function(e,t,n){var i=a(e,r()),s=o.defer();return i.confirmPassword(t,n,{onSuccess:function(e){s.resolve()},onFailure:function(e){console.log(e),s.reject(e)}}),s.promise},deleteUser=function(e){e.deleteUser(function(e,t){return e?void alert(e):void console.log("call result: "+t)})},signUserOut=function(e){null!=e&&e.signOut()},signCurrentUserOut=function(){var e=r().getCurrentUser();null!=e&&(e.signOut(),t.localStorage.isLoggedIn=!1)},signUserOutGlobally=function(e){t.localStorage.isLoggedIn=!1,e.globalSignOut()},getCurrentUserFromLocalStorage=function(e){var t=r().getCurrentUser();return null!=t?t.getSession(function(t,o){return t?(console.log(t),!1):(e&&e(o),o)}):(console.log("You are not logged in"),!1)},isLoggedIn=function(){var e=r().getCurrentUser();return!!e},confirmRegisteredUnauthenticatedUser=function(e,t){var n=a(e,r()),i=o.defer();return n.confirmRegistration(t,!0,function(e,t){e?i.reject(e):i.resolve(t)}),i.promise},saveImageTos3=function(e,t,r){function i(e){for(var t=atob(e.split(",")[1]),o=[],n=0;n<t.length;n++)o.push(t.charCodeAt(n));return new Blob([new Uint8Array(o)],{type:"image/jpeg"})}var s=o.defer();return l(t.idToken.jwtToken).then(function(){var t=i(e),o="blue-delta-api-development-stack-userdatabucket-12z57hiicf3xy",a=new AWS.S3({region:n.REGION,params:{Bucket:o}}),u={Key:AWS.config.credentials.identityId+"/"+r,Body:t};a.upload(u,function(e,t){e?s.reject(e):s.resolve(t.Location)})},function(e){s.reject(e)}),s.promise},{authenticateViaFB:authenticateViaFB,getUserFromLocalStorage:getUserFromLocalStorage,deleteCognitoUser:deleteCognitoUser,authenticateCognitoUser:authenticateCognitoUser,signupForApplication:signupForApplication,updateAttributesOnUser:updateAttributesOnUser,deleteUserAttributes:deleteUserAttributes,verifyUserAttribute:verifyUserAttribute,retrieveUserAttributes:retrieveUserAttributes,resendConfirmationCode:resendConfirmationCode,confirmRegistration:confirmRegistration,changePassword:changePassword,forgotPassword:forgotPassword,setNewPassword:setNewPassword,deleteUser:deleteUser,signUserOut:signUserOut,signUserOutGlobally:signUserOutGlobally,getCurrentUserFromLocalStorage:getCurrentUserFromLocalStorage,confirmRegisteredUnauthenticatedUser:confirmRegisteredUnauthenticatedUser,signCurrentUserOut:signCurrentUserOut,saveImageTos3:saveImageTos3,isLoggedIn:isLoggedIn}}angular.module("bdApp").service("aws",e),e.$inject=["$http","$window","$q","AWSConfig"]}();
!function(){function t(t,e,n,a,r,o){t._thirdParty=t._thirdParty||{},t._thirdParty.BlueDeltaApi=new API.Client.DefaultApi(angular.injector(["ng"]).get("$http"),angular.injector(["ng"]).get("$httpParamSerializer"),angular.injector(["ng"]));var i=t._thirdParty.BlueDeltaApi;for(i.jsonData={},setupJsonData=function(t){e.get("http://bluedelta-data.s3-website-us-east-1.amazonaws.com/data/"+t+".json").then(function(e){i.jsonData[t]=e.data})},jsonDataKeys=["style","thread","button","fabric","gender","tailors"],d=0;d<jsonDataKeys.length;d++)setupJsonData(jsonDataKeys[d]);i.getJsonData=function(){return this.jsonData};i.jeanKeyToDataKey=function(t){var e=!1;switch(!0){case t.indexOf("thread")>-1:e="threads";break;case"gender"==t||"style"==t||"fabric"==t:e=t+"s"}return e},i.dataLookup=function(t,e,n){if(n=n||null,"undefined"==typeof t||"undefined"==typeof e)return!1;var r=i.jsonData[t];return dataById=a("filter")(r,{id:e}),"undefined"!=typeof dataById&&(selected=dataById[0],n?selected[n]:selected)};var s=function(t){var e=JSON.stringify(t);return e=e.replace(/\"\"/g,null),t=JSON.parse(e)};return i.setupHeaders=function(){var t=o.getCurrentUserFromLocalStorage();this.defaultHeaders_.Authorization=t.idToken.getJwtToken();var e=t.idToken.jwtToken.split(".")[1],n=JSON.parse(atob(e)).sub;return n},i.call=function(t,e,n,a){console.log("running "+t);var r=this;o.getCurrentUserFromLocalStorage(function(o){r.defaultHeaders_.Authorization=o.idToken.getJwtToken(),Array.isArray(e)||(e=[e]),r[t].apply(r,e).then(function(t){n(t)},function(t){console.log(t),a&&a(t)})})},i.saveUser=function(t){var e=r.defer();return t=s(t),t.identityId?i.usersUpdate(t.identityId,t).then(function(t){console.log("got it"),e.resolve(t)},function(t){console.log("Error saving user:"),console.log(t),e.reject(t)}):e.reject("No identity Id"),e.promise},i}angular.module("bdApp").service("bdAPI",t),t.$inject=["$window","$http","$httpParamSerializer","$filter","$q","aws"]}();
...
!function(){function e(e,t,r,a,n,o){function c(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function s(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function d(e,t){return a(function(r,a){var n=new Image;n.src=e,n.onload=function(){t.drawImage(n,0,0,600,696),r(n)},n.onerror=function(e){a(e)}})}var u=function(e,t){var r=o[e];if(!r)return!1;for(i=0;i<r.length;i++)if(r[i][e+"Id"]==t)return r[i]},f={};set=function(e,t){f[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?f={gender:e.gender,style:e.style,fabric:e.fabric.fabricId,accent_thread:e.accent_thread.threadId,top_thread:e.top_thread.threadId,bottom_thread:e.bottom_thread.threadId}:(f={gender:1,style:1,fabric:u("fabric",1004),accent_thread:u("thread",1),top_thread:u("thread",1),bottom_thread:u("thread",1)},f.saved=!1)};var h=function(t){var o=a.defer();if(t){for(prop in t)t.hasOwnProperty(prop)&&set(prop,t[prop]);o.resolve(f)}else if(e.jeanId&&!e.userId){if(createNew(),e.jeanId.indexOf(":")>0){f=e.jeanId.split(":");for(var s=0;s<f.length;s++){var d=f[s].match(/([A-Za-z]+)([0-9]+)/);if(d){var i=c(d[1]);i&&(f[i]=parseInt(d[2]))}}}o.resolve(f)}else e.jeanId&&e.userId?r.jeansGet(e.userId,e.jeanId).then(function(t){var a=t.data,c=n.getCurrentUserFromLocalStorage();if(c){var s=r.setupHeaders(c);if(s==e.userId)for(prop in a)a.hasOwnProperty(prop)&&set(prop,a[prop]);else createNew(a)}else createNew(a);o.resolve(f)},function(e){console.log(e),createNew(),o.resolve(f)}):Object.keys(f).length>0?o.resolve(f):0===Object.keys(f).length&&f.constructor===Object&&(createNew(),o.resolve(f));return o.promise},g=function(){return f};createThumb=function(e){var t=document.createElement("canvas");t.width=600,t.height=600;for(var r=t.getContext("2d"),n=[],o=["/images/components/fabric/g"+e.gender+"/s2/f"+e.fabric.fabricId+".jpg","/images/components/thread/g"+e.gender+"/s2/tb/"+e.bottom_thread.threadId+".png","/images/components/thread/g"+e.gender+"/s2/tt/"+e.top_thread.threadId+".png","/images/components/thread/g"+e.gender+"/s2/ta/"+e.accent_thread.threadId+".png"],c=0;c<o.length;c++)n.push(d(o[c],r));return a.all(n).then(function(e){var r=t.toDataURL("image/jpeg");return r},function(e){console.log(e)})},getDataCode=function(){var e="";for(var t in f)if(f.hasOwnProperty(t)){var r=f[t];if("object"==typeof r){var a=t+"Id";a.indexOf("Thread")>-1&&(a="threadId"),r=r[a]}var n=s(t);n&&(e+="_"+n+r)}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var l=function(e,t,a){var o=n.getCurrentUserFromLocalStorage();r.defaultHeaders_.Authorization=o.idToken.getJwtToken(),r.jeansDelete(e,t).then(function(e){a&&a(e)},function(e){console.log(e)})},p=function(){var e=a.defer(),t=this,o=t.get(),c=t.getDataCode();return c+=".jpg",this.createThumb(o).then(function(a){var s=n.getCurrentUserFromLocalStorage();r.defaultHeaders_.Authorization=s.idToken.getJwtToken();var d=s.idToken.jwtToken.split(".")[1],i=JSON.parse(atob(d)).sub;s?n.saveImageTos3(a,s,c).then(function(a){t.set("imageURL",a),o.jeanId?r.jeansUpdate(i,o.jeanId,o).then(function(t){e.resolve(t)},function(t){console.log(t),e.reject(t)}):r.jeansCreate(i,o).then(function(r){t.set("jeanId",r.data.jeanId),e.resolve(r)},function(t){e.reject(t)})},function(t){console.log(t),e.reject(t.message)}):e.reject("You are not logged in...")}),e.promise};return{dataLookup:u,deleter:l,save:p,get:g,setup:h,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:createThumb}}angular.module("bdApp").service("jean",["$routeParams","$http","bdAPI","$q","aws","jsonData",e])}();
...
!function(){function e(e,a,t,n,o,i,r,l,p,c,d,s,u,h){function f(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var v=this;v.loader=u.get(),s.reset(),v.messages=s.get(),c.closeAll(),v.popups=c.get(),l.setup().then(function(e){v.jeanData=l.get(),p.$watch(function(){return v.jeanData},function(e,a){v.updateActiveItem()},!0),p.$watch(function(){return v.data},function(e,a){v.updateActiveItem()},!0)}),v.landscape=f();var g="onorientationchange"in window,w=g?"orientationchange":"resize";window.addEventListener(w,function(){v.landscape=f(),p.$apply()},!1),v.data=h,v.activeItem={},v.updateActiveItem=function(){if(!v.jeanData)return!1;var e=v.data[v.panel[v.panelStep].dataKey],t=v.jeanData[v.panel[v.panelStep].jeanKey];if("object"==typeof t)v.activeItem=t;else{var n=a("filter")(e,{id:t});n&&(n=n[0]),v.activeItem=n||null}},v.panel=[],v.panel.push({panelTemplate:"gender-chooser",dataKey:"gender",title:"Gender",jeanKey:"gender"}),v.panel.push({panelTemplate:"style-chooser",dataKey:"style",title:"Style",jeanKey:"style"}),v.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabric",title:"Fabric",jeanKey:"fabric"}),v.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Top Thread",jeanKey:"top_thread"}),v.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Bottom Thread",jeanKey:"bottom_thread"}),v.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Accent Thread",jeanKey:"accent_thread"}),v.panel.push({panelTemplate:"list",title:"Overview"}),v.panelDir="next",v.panelStep=0,v.changeStep=function(e){return!(e>=v.panel.length)&&(!(e<0)&&(void 0!==e&&(v.panelStep=e,void(e+1!=v.panel.length&&v.updateActiveItem()))))},v.orderCallback=function(){v.saveCallback(function(){n.path("/order")})},v.placeOrder=function(){return d.isLoggedIn()?void v.saveCallback(function(){n.path("/order")}):(v.authCallback=v.orderCallback,c.set("loginOrRegister",!0),!1)},v.savingBar=!1,v.saveCallback=function(e){c.closeAll(),v.savingBar=!0,l.save().then(function(a){v.savingBar=!1;var t=d.getCurrentUserFromLocalStorage(),o=r.setupHeaders(t);n.path("/customizer/"+v.jeanData.jeanId+"/"+o),e&&e(a)})},v.saveJean=function(){return d.isLoggedIn()?void v.saveCallback():(v.authCallback=v.saveCallback,c.set("loginOrRegister",!0),!1)},v.authCallback=v.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","messages","loader","jsonData"]}();
!function(){function n(n,a,e){n.jean=a.data}angular.module("bdApp").controller("homeCtrl",n),n.$inject=["$scope","jean","$animate"]}();
!function(){function r(r,e,o,n,t,a,l,d,s){function p(r){for(var e=0;e<r.length;e++)if(1==r[e].primary)return r[e];return console.log("no address marked as primary... returning first result"),r[0]}var i=this;i.popups=n.get(),o.setup(),i.jean=o.get();var u=a.getCurrentUserFromLocalStorage(),c=l.setupHeaders(u);i.jean.jeanId&&c&&e.path("/order/"+i.jean.jeanId+"/"+c),i.orderForm={},i.orderForm.step=1,i.order={userId:c,price:null,shippingAddress:null,vendor:null,rep:null,status:"New",orderItems:[{jean:i.jean,tracking:null,notes:null}],timeline:null,tailor:null},i.placeOrder=function(){console.log("placing order..."),console.log("order object V"),console.log(i.order),l.call("orderCreate",i.order,function(r){console.log("order created: "+r.data.orderId),l.call("commentsCreate",[r.data.orderId,{message:"Order Placed"}],function(r){console.log("comment created"),console.log(r)})})},i.chooseFitType=function(r){i.order.orderType=r,2!=r||i.order.tailor||(i.popups.tailors=!0)},i.data=s,i.orderForm.nextStep=function(){if(1==i.orderForm.step)return!!i.order.orderType&&(2!=i.order.orderType||i.order.tailor?void(i.orderForm.step=2):(i.popups.tailors=!0,!1))};var g=a.getCurrentUserFromLocalStorage();if(g){var m=l.setupHeaders(g);l.usersGet(m).then(function(r){i.user=r.data,i.order.shippingAddress=p(i.user.address),d.$apply()},function(r){console.log(r)})}else e.path("/login")}angular.module("bdApp").controller("orderCtrl",r),r.$inject=["$window","$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
