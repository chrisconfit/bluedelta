...
!function(){function e(e,n,o){var t=this;t.jean=o,t.zoom=!1,t.pan="50%,50%",t.breakPoint=800,t.returnPan=function(){t.pan="0% 30% 0",console.log(t.pan),images=angular.element(document.querySelectorAll("#zoom-frame img")),console.log(images),images.css({"transform-origin":t.pan})},t.scanImage=function(n,o){frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(n-offsetL)/fWidth*100,yPosition=(o-offsetT)/fHeight*100,e.innerWidth<t.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",t.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},t.trackMouse=function(n){return!(e.innerWidth<t.breakPoint)&&void t.scanImage(n.pageX,n.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","$swipe","jean"]}();
