...
!function(){function e(e,o){return getUserPool=function(){var e={UserPoolId:"us-east-1_q2Y6U8uuY",ClientId:"224kjog47ojnt9ov773erj7qn9"},o=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return o},getAuthenticationDetails=function(e,o){var t={Username:e,Password:o},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(t);return n},fetchCognitoUser=function(e){var o={UserPoolId:"us-east-1_q2Y6U8uuY",ClientId:"224kjog47ojnt9ov773erj7qn9"},t=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(o),n={Username:e,Pool:t},i=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(n);return i},getUserFromLocalStorage=function(){var e={UserPoolId:"us-east-1_Iqc12345",ClientId:"12345du353sm7khjj1q"},o=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e),t=o.getCurrentUser();null!=t&&t.getSession(function(e,o){return e?void alert(e):void console.log("session validity: "+o.isValid())})},deleteCognitoUser=function(){var e={UserPoolId:"us-east-1_Iqc12345",ClientId:"12345du353sm7khjj1q"},o=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e),t=o.getCurrentUser();t.deleteUser(function(e,o){return e?void alert(e):void console.log("call result: "+o)})},authenticateCognitoUser=function(e,o){function t(e,o){var t={Username:e,Password:o},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(t);return n}function n(){var e={UserPoolId:"us-east-1_TcoKGbf7n",ClientId:"4pe2usejqcdmhi0a25jp4b5sh3"},o=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return o}function i(e,o){var t={Username:e,Pool:o},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(t);return n}var r=t(e,o),s=n(),u=i(e,s);u.authenticateUser(r,{onSuccess:function(e){console.log("access token + "+e.getAccessToken().getJwtToken()),console.log("idToken + "+e.idToken.jwtToken)},onFailure:function(e){alert(e)}})},signupForApplication=function(e,o){var t={Name:"email",Value:e},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(t),i=[];i.push(n);var r;userPool.signUp(e,o,i,null,function(e,o){return e?void alert(e):(r=o.user,void console.log("CognitoUser => ",r))})},updateAttributesOnUser=function(e,o){function t(){var e={UserPoolId:"us-east-1_TcoKGbf7n",ClientId:"4pe2usejqcdmhi0a25jp4b5sh3"},o=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return o}function n(e,o){var t={Username:e,Pool:o},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(t);return n}function i(e,o){var t={Name:e,Value:o},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(t);return n}function r(e,o){var t,n=[];for(var i in o)t=e(i,o[i]),n.push(t);return n}var s=r(i,o),u=n(e,t());u.updateAttributes(s,function(e,o){return e?void alert(e):void console.log("call result: "+o)})},deleteUserAttributes=function(e,o){e.deleteAttributes(o,function(e,o){return e?void alert(e):void console.log("call result: "+o)})},verifyUserAttribute=function(e,o){e.getAttributeVerificationCode(o,{onSuccess:function(e){console.log("call result: "+e)},onFailure:function(e){alert(e)},inputVerificationCode:function(){var t=prompt("Please input verification code: ","");e.verifyAttribute(o,t,this)}})},retrieveUserAttributes=function(e){e.getUserAttributes(function(e,o){if(e)return void alert(e);for(i=0;i<o.length;i++)console.log("attribute "+o[i].getName()+" has value "+o[i].getValue())})},{}}angular.module("bdApp").service("aws",e),e.$inject=["$http","$window"]}();
...
!function(){function e(e,t,i){var o=this;o.credentials={name:"",email:"",password:""},o.errors={message:""},o.onSubmit=function(){var e;e=t.createUserAttributeList(o.credentials,awsConfig.acceptedCognitoFields),console.log(e),console.log("Submitting registration"),t.register(t.userPool,o.credentials.email,o.credentials.password,e)}}angular.module("bdApp").controller("registerCtrl",e),e.$inject=["$location","authentication","aws"]}();
