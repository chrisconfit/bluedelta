...
!function(){function e(e,t){var o=this;o.jean=t,o.centerPan=!1,o.zoom=!1,o.pan="0% 30% 0",o.breakPoint=800,o.toggleZoom=function(){left=o.zoom?"50%":"0",o.zoom=!o.zoom;var e=angular.element(document.querySelectorAll("#zoom-frame img"));e.css("left",left),e.css("bottom","-175px")},o.returnPan=function(){o.pan="50% 30% 0",o.centerPan=!0,images=angular.element(document.querySelectorAll("#zoom-frame img")),setTimeout(function(){images.css({"transform-origin":o.pan})},200)},o.drag=function(e){console.log("dragger"),console.log(e)},o.scale=1,o.xImage=0,o.yImage=0,o.zoomDrag={x:0,y:0},o.dragTracker={x:0,y:0},o.yLast=0,o.myDrag=function(e,t){var n=angular.element(document.querySelectorAll("#zoom-frame img")),a={width:t.target.clientWidth,height:t.target.clientHeight},r=(window.innerHeight,n[0].height),i=1.7*r,c={y:{},x:{}};if(console.log(i),c.y.bottom=-(.225*i),c.y.top=i/2+175,c.x.left=-(t.target.clientWidth-.05*t.target.clientWidth),c.x.right=t.target.clientWidth-.05*t.target.clientWidth,console.log(c.y),!o.zoom)return!1;var g={x:t.deltaX,y:t.deltaY},l=g.x-o.dragTracker.x,m=g.y-o.dragTracker.y,l=Math.abs(l)/a.width*100;l=g.x<0?-l:l;var m=Math.abs(m)/a.height*100;m=g.y<0?-m:m,l+=o.zoomDrag.x,m+=o.zoomDrag.y,m>60&&(m=60),m<-90&&(m=-90),l<-150&&(l=-150),l>60&&(l=60),console.log(l,m);var s={x:l,y:m};o.zoomDrag=s,console.log("move:");var f=-l+"% "+-m+"% 0";n.css({"transform-origin":f}),o.dragTracker=t.isFinal?{x:0,y:0}:g},o.scanImage=function(t,n){setTimeout(function(){o.centerPan=!1},200),frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(t-offsetL)/fWidth*100,yPosition=(n-offsetT)/fHeight*100,e.innerWidth<o.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",o.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},o.trackMouse=function(t){return!(e.innerWidth<o.breakPoint)&&void o.scanImage(t.pageX,t.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","jean"]}();
!function(){function e(){return{restrict:"AE",templateUrl:"/common/directives/image-stack/image-stack.template.html",controller:"istackCtrl as isvm",link:function(e,t,i,a){console.log("here we go")}}}angular.module("meanApp").directive("imageStack",e)}();
