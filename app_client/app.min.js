...
!function(){function o(o,e){return getUserPool=function(){var o={UserPoolId:"us-east-1_q2Y6U8uuY",ClientId:"224kjog47ojnt9ov773erj7qn9"},e=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(o);return e},getAuthenticationDetails=function(o,e){var t={Username:o,Password:e},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(t);return n},fetchCognitoUser=function(o){var e={UserPoolId:"us-east-1_q2Y6U8uuY",ClientId:"224kjog47ojnt9ov773erj7qn9"},t=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e),n={Username:o,Pool:t},i=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(n);return i},getUserFromLocalStorage=function(){var o={UserPoolId:"us-east-1_Iqc12345",ClientId:"12345du353sm7khjj1q"},e=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(o),t=e.getCurrentUser();null!=t&&t.getSession(function(o,e){return o?void alert(o):void console.log("session validity: "+e.isValid())})},deleteCognitoUser=function(){var o={UserPoolId:"us-east-1_Iqc12345",ClientId:"12345du353sm7khjj1q"},e=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(o),t=e.getCurrentUser();t.deleteUser(function(o,e){return o?void alert(o):void console.log("call result: "+e)})},authenticateCognitoUser=function(o,e){var t={Username:o,Password:e},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(t),i={UserPoolId:"us-east-1_TcoKGbf7n",ClientId:"4pe2usejqcdmhi0a25jp4b5sh3"},r=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(i),s={Username:o,Pool:r},u=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(s);u.authenticateUser(n,{onSuccess:function(o){console.log("access token + "+o.getAccessToken().getJwtToken()),console.log("idToken + "+o.idToken.jwtToken)},onFailure:function(o){alert(o)}})},signupForApplication=function(o,e){var t={Name:"email",Value:o},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(t),i=[];i.push(n);var r;userPool.signUp(o,e,i,null,function(o,e){return o?void alert(o):(r=e.user,void console.log("CognitoUser => ",r))})},updateAttributesOnUser=function(o,e){},{}}angular.module("bdApp").service("aws",o),o.$inject=["$http","$window"]}();
