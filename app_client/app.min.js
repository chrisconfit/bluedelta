...
!function(){function e(e,r){return createUserAttribute=AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute,createUserAttributeList=function(e,r){var t=[];for(var i in e)"password"!==i&&t.push(new r({Name:i,Value:e[i]}));return t},createUserPool=function(e){var r=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return r},registerUser=function(e,r,t,i){console.log("insid");var o=null;e.signUp(r,t,i,o,function(e,r){if(e)return void alert(e);var t=r.user;console.log("user name is "+t.getUsername())})},{createUserAttribute:createUserAttribute,createUserAttributeList:createUserAttributeList,createUserPool:createUserPool,registerUser:registerUser}}angular.module("bdApp").service("aws",e),e.$inject=["$http","$window"]}();
...
!function(){function e(e,r,t,n){var o=this,s=t.createUserPool(n.poolInfo);o.credentials={name:"",email:"",password:""},o.errors={message:""},o.onSubmit=function(){var n,i,a;a=t.createUserAttributeList(o.credentials,t.createUserAttribute),n=o.credentials.name,i=o.credentials.password,t.registerUser(s,n.replace(" ","-"),i,a),console.log("Submitting registration"),r.register(o.credentials).error(function(e){console.log(e),o.errors.message=e.message}).then(function(){e.path("profile")})}}angular.module("bdApp").controller("registerCtrl",e),e.$inject=["$location","authentication","aws","awsConfig"]}();
