...
!function(){function e(e,t,a,r){function n(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function o(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function s(e,t){return a(function(a,r){var n=new Image;n.src=e,n.onload=function(){t.drawImage(n,0,0,600,696),a(n)},n.onerror=function(e){r(e)}})}data={},set=function(e,t){this.data[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?this.data={gender:e.gender,style:e.style,fabric:e.fabric,accent_thread:e.accent_thread,top_thread:e.top_thread,bottom_thread:e.bottom_thread}:(this.data={gender:1,style:1,fabric:"1004",accent_thread:"1",top_thread:"1",bottom_thread:"1"},this.saved=!1)};var c=function(o){var s=a.defer();if(console.log(e),o)this.data=o,s.resolve(this.data);else if(e.jeanId&&!e.userId){if(e.jeanId.indexOf(":")>0){this.createNew(),jeanData=e.jeanId.split(":");for(var c=0;c<jeanData.length;c++){var d=jeanData[c].match(/([A-Za-z]+)([0-9]+)/);if(d){var i=n(d[1]);i&&(this.data[i]=parseInt(d[2]))}}}s.resolve(this.data)}else if(e.jeanId&&e.userId){var u=this;t.jeansGet(e.userId,e.jeanId).then(function(a){var n=a.data,o=r.getCurrentUserFromLocalStorage();if(o){var c=t.setupHeaders(o);c==e.userId?u.data=n:u.createNew(n)}else u.createNew(n);console.log(u),s.resolve(u.data)},function(e){console.log(e),u.createNew(),s.resolve(u.data)})}else 0===Object.keys(this.data).length&&this.data.constructor===Object&&this.createNew(),s.resolve(this.data);return s.promise},d=function(){return this.data};createThumb=function(){var e=document.createElement("canvas");e.width=600,e.height=600;for(var t=e.getContext("2d"),r=[],n=["/images/components/fabrics/g"+this.data.gender+"/s2/f"+this.data.fabric+".jpg","/images/components/threads/g"+this.data.gender+"/s2/tb/"+this.data.bottom_thread+".png","/images/components/threads/g"+this.data.gender+"/s2/tt/"+this.data.top_thread+".png","/images/components/threads/g"+this.data.gender+"/s2/ta/"+this.data.accent_thread+".png"],o=0;o<n.length;o++)r.push(s(n[o],t));return a.all(r).then(function(t){var a=e.toDataURL("image/jpeg");return a})},getDataCode=function(){var e="";for(var t in this.data)if(this.data.hasOwnProperty(t)){var a=o(t);a&&(e+="_"+a+this.data[t])}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var i=function(e,a,n){console.log(e,a,n);var o=r.getCurrentUserFromLocalStorage();t.defaultHeaders_.Authorization=o.idToken.getJwtToken(),t.jeansDelete(e,a).then(function(e){n&&n(e)},function(e){console.log(e)})},u=function(){var e=a.defer(),n=this;console.log("jean"),console.log(n);var o=this.getDataCode();return o+=".jpg",this.createThumb().then(function(a){var s=r.getCurrentUserFromLocalStorage();t.defaultHeaders_.Authorization=s.idToken.getJwtToken();var c=s.idToken.jwtToken.split(".")[1],d=JSON.parse(atob(c)).sub;console.log(s),s?r.saveImageTos3(a,s,o).then(function(a){n.set("imageURL",a),n.data.jeanId?t.jeansUpdate(d,n.data.jeanId,n.data).then(function(t){e.resolve(t)},function(t){console.log(t),e.reject(t)}):t.jeansCreate(d,n.data).then(function(t){n.set("jeanId",t.data.jeanId),e.resolve(t)},function(t){e.reject(t)})},function(t){console.log(t),e.reject(t.message)}):e.reject("You are not logged in...")}),e.promise};return{deleter:i,save:u,get:d,setup:c,data:data,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:createThumb}}angular.module("bdApp").service("jean",["$routeParams","bdAPI","$q","aws",e])}();
...
!function(){angular.module("bdApp").directive("jeanList",["jean","jsonData",function(t,e){return{restrict:"EA",templateUrl:"/directives/jean-list/jean-list.template.html",scope:{fields:"=?"},link:function(a){a.data=e.getData(),a.dataLookup=e.dataLookup,t.setup().then(function(t){a.jean=t});var n=["fabric","accent_thread","top_thread","bottom_thread","gender","style"];a.fields=a.fields||n,a.filterFields=function(t){matches={};for(var e in t)t.hasOwnProperty(e)&&a.fields.indexOf(e)>=0&&(matches[e]=t[e]);return matches}}}}])}();
...
!function(){function e(e,a,t,n,o,r,i,l,p,s,c,d,u,h){function g(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var f=this;f.loader=h.get(),u.reset(),f.messages=u.get(),s.closeAll(),f.popups=s.get(),l.setup().then(function(e){f.jean=l.get(),p.$watch(function(){return f.jean.data},function(e,a){f.updateActiveItem()},!0),p.$watch(function(){return f.data},function(e,a){f.updateActiveItem()},!0)}),f.landscape=g();var v="onorientationchange"in window,w=v?"orientationchange":"resize";window.addEventListener(w,function(){f.landscape=g(),p.$apply()},!1),f.data=d.getData(),f.activeItem={},f.updateActiveItem=function(){if(!f.jean)return!1;var e=f.data[f.panel[f.panelStep].dataKey],t=f.jean[f.panel[f.panelStep].jeanKey],n=a("filter")(e,{id:t});n&&(n=n[0]),f.activeItem=n||null},f.panel=[],f.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),f.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),f.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),f.panel.push({panelTemplate:"list",title:"Overview"}),f.panelDir="next",f.panelStep=0,f.changeStep=function(e){return!(e>=f.panel.length)&&(!(e<0)&&(void 0!==e&&(f.panelStep=e,void(e+1!=f.panel.length&&f.updateActiveItem()))))},f.orderCallback=function(){f.saveCallback(function(){n.path("/order")})},f.placeOrder=function(){return c.isLoggedIn()?void f.saveCallback(function(){n.path("/order")}):(f.authCallback=f.orderCallback,s.set("loginOrRegister",!0),!1)},f.savingBar=!1,f.saveCallback=function(e){s.closeAll(),f.savingBar=!0,l.save().then(function(a){f.savingBar=!1;var t=c.getCurrentUserFromLocalStorage(),o=i.setupHeaders(t);n.path("/customizer/"+f.jean.jeanId+"/"+o),e&&e(a)})},f.saveJean=function(){return c.isLoggedIn()?void f.saveCallback():(f.authCallback=f.saveCallback,s.set("loginOrRegister",!0),!1)},f.authCallback=f.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","jsonData","messages","loader"]}();
...
!function(){function e(e,s,a,r,n,t,o,i,u){function l(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function c(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function d(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function m(e){for(var s=0;s<p.user.jeans.length;s++)if(p.user.jeans[s].jeanId===e)return{index:s,data:p.user.jeans[s]}}u.show("Getting your profile information...");var p=this;a.closeAll(),p.popups=a.get(),p.messages=i.get(),p.jean=s,p.data=o.getData(),p.jeans=p.data.jeansList,p.onload=function(){t.vm=p},p.userForm={},p.userForm.editing={},p.userForm.saving={},p.userForm.feedback={type:"",message:""},p.userForm.cancel=function(e){p.userForm.editing[e]=!1,p.user[e]=p.userForm.data[e]},p.userForm.validate=function(e,s){return"email"==e?!!l(s)||(i.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!c(s)||(i.set("Please enter a valid phone number","error"),!1))},p.userForm.save=function(e){""==p.user[e]&&(p.user[e]=null),p.userForm.validate(e,p.user[e])&&(p.userForm.saving[e]=!0,n.usersUpdate(p.user.identityId,p.user).then(function(s){p.userForm.saving[e]=!1,p.userForm.editing[e]=!1,p.userForm.data[e]=p.user[e],t.$apply()},function(e){console.log(e)}))};var f=r.getCurrentUserFromLocalStorage();if(f){n.defaultHeaders_.Authorization=f.idToken.getJwtToken();var g=f.idToken.jwtToken.split(".")[1],F=JSON.parse(atob(g)).sub;n.usersGet(F).then(function(e){u.hide(),p.user=e.data,p.userForm.data=angular.copy(e.data),t.$apply()},function(e){console.log(e)})}else e.path("/");p.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){p.passForm.editing=!1,p.passForm.currentPass="",p.passForm.newPass="",p.passForm.newPassConfirm="",i.reset()}},p.validatePasswordForm=function(){return d(p.passForm.newPass)||i.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),p.passForm.newPass===p.passForm.newPassConfirm||(i.set("New Password and Confirmation do not match","error"),!1)},p.changePassword=function(){i.reset(),p.validatePasswordForm()&&r.changePassword(p.user.email,p.passForm.currentPass,p.passForm.newPass).then(function(e){p.passForm.clear(),i.set("Password successfully changed.","success")},function(e){i.set(e.message,"error")})},p.copyJean=function(){p.jean=s.createNew(p.displayJean),e.path("/customizer")},p.displayJean={},p.selectJean=function(e){p.popups.jeanProfile=!0,p.displayJean.data=e},p.deleteJean=function(e){s.deleter(p.user.identityId,e,function(s){var a=m(e).index;p.user.jeans.splice(a,1),t.$apply()})},p.orderJean=function(a){console.log("ordering"),s.setup(a),e.path("/order")}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","aws","bdAPI","$scope","jsonData","messages","loader"]}();
