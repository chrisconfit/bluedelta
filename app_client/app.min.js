...
!function(){function e(e,t,r,a,n,o){function c(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function s(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function d(e,t){return a(function(r,a){var n=new Image;n.src=e,n.onload=function(){t.drawImage(n,0,0,600,696),r(n)},n.onerror=function(e){a(e)}})}var u=function(e,t){var r=o[e];if(!r)return!1;for(i=0;i<r.length;i++)if(r[i][e+"Id"]==t)return r[i]},l={};set=function(e,t){l[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?l={gender:e.gender,style:e.style,fabric:e.fabric.fabricId,accent_thread:e.accent_thread.threadId,top_thread:e.top_thread.threadId,bottom_thread:e.bottom_thread.threadId}:(l={gender:1,style:1,fabric:u("fabric",1004),accent_thread:u("thread",1),top_thread:u("thread",1),bottom_thread:u("thread",1)},l.saved=!1)};var g=function(t){var o=a.defer();if(t){for(prop in t)t.hasOwnProperty(prop)&&set(prop,t[prop]);o.resolve(l)}else if(e.jeanId&&!e.userId){if(createNew(),e.jeanId.indexOf(":")>0){l=e.jeanId.split(":");for(var s=0;s<l.length;s++){var d=l[s].match(/([A-Za-z]+)([0-9]+)/);if(d){var i=c(d[1]);i&&(l[i]=parseInt(d[2]))}}}o.resolve(l)}else e.jeanId&&e.userId?r.jeansGet(e.userId,e.jeanId).then(function(t){var a=t.data,c=n.getCurrentUserFromLocalStorage();if(c){var s=r.setupHeaders(c);if(s==e.userId){for(prop in a)a.hasOwnProperty(prop)&&set(prop,a[prop]);console.log(l)}else createNew(a)}else createNew(a);o.resolve(l)},function(e){console.log(e),createNew(),o.resolve(l)}):Object.keys(l).length>0?o.resolve(l):0===Object.keys(l).length&&l.constructor===Object&&(createNew(),o.resolve(l));return o.promise},f=function(){return l};createThumb=function(e){console.log(e);var t=document.createElement("canvas");t.width=600,t.height=600;var r=t.getContext("2d"),n=[],o=["/images/components/fabric/g"+e.gender+"/s2/f"+e.fabric.fabricId+".jpg","/images/components/thread/g"+e.gender+"/s2/tb/"+e.bottom_thread.threadId+".png","/images/components/thread/g"+e.gender+"/s2/tt/"+e.top_thread.threadId+".png","/images/components/thread/g"+e.gender+"/s2/ta/"+e.accent_thread.threadId+".png"];console.log(o);for(var c=0;c<o.length;c++)n.push(d(o[c],r));return a.all(n).then(function(e){var r=t.toDataURL("image/jpeg");return r},function(e){console.log(e)})},getDataCode=function(){var e="";for(var t in l)if(l.hasOwnProperty(t)){var r=l[t];if("object"==typeof r){var a=t+"Id";a.indexOf("Thread")>-1&&(a="threadId"),r=r[a]}var n=s(t);n&&(e+="_"+n+r)}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var h=function(e,t,a){console.log(e,t,a);var o=n.getCurrentUserFromLocalStorage();r.defaultHeaders_.Authorization=o.idToken.getJwtToken(),r.jeansDelete(e,t).then(function(e){a&&a(e)},function(e){console.log(e)})},p=function(){console.log("save");var e=a.defer(),t=this;console.log(this);var o=t.get();console.log(o);var c=t.getDataCode();return c+=".jpg",this.createThumb(o).then(function(a){var s=n.getCurrentUserFromLocalStorage();r.defaultHeaders_.Authorization=s.idToken.getJwtToken();var d=s.idToken.jwtToken.split(".")[1],i=JSON.parse(atob(d)).sub;s?n.saveImageTos3(a,s,c).then(function(a){t.set("imageURL",a),o.jeanId?(console.log("update"),r.jeansUpdate(i,o.jeanId,o).then(function(t){e.resolve(t)},function(t){console.log(t),e.reject(t)})):(console.log("create"),console.log(o),r.jeansCreate(i,o).then(function(r){console.log(r),t.set("jeanId",r.data.jeanId),e.resolve(r)},function(t){console.log(t),e.reject(t)}))},function(t){console.log(t),e.reject(t.message)}):e.reject("You are not logged in...")}),e.promise};return{dataLookup:u,deleter:h,save:p,get:f,setup:g,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:createThumb}}angular.module("bdApp").service("jean",["$routeParams","$http","bdAPI","$q","aws","jsonData",e])}();
...
!function(){function o(o,e,r,t,a,n,s,d,p){var l=this;l.popups=t.get(),r.setup(),l.jean=r.get(),console.log(l.jean);var i=n.getCurrentUserFromLocalStorage(),u=s.setupHeaders(i);console.log("jean is set up"),console.log(l.jean.jeanId),console.log(u),l.jean.jeanId&&u&&(console.log("hm.."),e.path("/order/"+l.jean.jeanId+"/"+u)),l.orderForm={},l.orderForm.step=1,l.orderForm.data={},l.chooseFitType=function(o){l.orderForm.data.fitType=o,2!=o||l.orderForm.data.tailor||(l.popups.tailors=!0)},l.data=p,l.orderForm.nextStep=function(){if(1==l.orderForm.step)return!!l.orderForm.data.fitType&&(2!=l.orderForm.data.fitType||l.orderForm.data.tailor?void(l.orderForm.step=2):(l.popups.tailors=!0,!1))};var c=n.getCurrentUserFromLocalStorage();if(c){var m=s.setupHeaders(c);s.usersGet(m).then(function(o){l.user=o.data,d.$apply()},function(o){console.log(o)})}else e.path("/login")}angular.module("bdApp").controller("orderCtrl",o),o.$inject=["$window","$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
