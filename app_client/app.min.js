...
!function(){function e(e,d,o){function s(d){d=d||!0,e.editAdd={},e.model={},d&&(e.active=!1)}function n(d){console.log(d),e.vm.user.address.splice(d,1),console.log(e.vm.user.address)}console.log(e),console.log(o),e.addForm={},e.model={};e.choosePrimary=function(d){for(a=0;a<e.vm.user.address.length;a++)e.vm.user.address[a].primary=a==d;o.saveUser(e.vm.user).then(function(e){console.log("saved")})},e.editing=!1,e.startEditing=function(){e.vm.user.address=d("orderBy")(e.vm.user.address,"-primary"),e.editing=!0},e.stopEditing=function(){e.editing=!1},e.editAdd={},e.open=function(d){e.active=!0,"undefined"==typeof d?(e.model={},e.editAdd.index=e.vm.user.address.push(e.model)-1,e.editAdd.data=null):(e.model=e.vm.user.address[d],e.editAdd.index=d,e.editAdd.data=angular.copy(e.model))},e.clear=function(){var d=e.editAdd.data;console.log(d),null==d?(console.log("removing"),n(e.editAdd.index)):e.vm.user.address[e.editAdd.index]=e.editAdd.data,s()},e.remove=function(d){var s=e.vm.user.address[d].primary;e.vm.user.address.splice(d,1),s&&e.choosePrimary(0),o.saveUser(e.vm.user)},e.save=function(){o.saveUser(e.vm.user).then(function(d){e.newAdd=null,e.active=!1,e.model={},e.$apply()})}}angular.module("bdApp").controller("addFormCtrl",e),e.$inject=["$scope","$filter","bdAPI"]}();
!function(){function e(e,a,r,o,n,s,t,u,i){function l(e){var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.test(e)}function c(e){var a=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(a)}i.show("Getting your profile information...");var d=this;r.closeAll(),d.popups=r.get(),d.messages=u.get(),d.jean=a,d.data=t.getData(),d.jeans=d.data.jeansList,d.onload=function(){s.vm=d},d.userForm={},d.userForm.editing={},d.userForm.saving={},d.userForm.feedback={type:"",message:""},d.userForm.cancel=function(e){console.log(e),d.userForm.editing[e]=!1,d.user[e]=d.userForm.data[e]},d.userForm.validate=function(e,a){return"email"==e?!!l(a)||(u.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!c(a)||(u.set("Please enter a valid phone number","error"),!1))},d.userForm.save=function(e){d.userForm.validate(e,d.user[e])&&(d.userForm.saving[e]=!0,n.usersUpdate(d.user.identityId,d.user).then(function(a){d.userForm.saving[e]=!1,d.userForm.editing[e]=!1,d.userForm.data[e]=d.user[e],s.$apply()},function(e){console.log(e)}))};var p=o.getCurrentUserFromLocalStorage();if(p){n.defaultHeaders_.Authorization=p.idToken.getJwtToken();var m=p.idToken.jwtToken.split(".")[1],g=JSON.parse(atob(m)).sub;n.usersGet(g).then(function(e){i.hide(),d.user=e.data,console.log(d.user),d.userForm.data=angular.copy(e.data),s.$apply()},function(e){console.log(e)})}else e.path("/");d.copyJean=function(){d.jean=a.createNew(d.displayJean),e.path("/customizer")},d.displayJean={},d.selectJean=function(e){d.popups.jeanProfile=!0,d.displayJean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","aws","bdAPI","$scope","jsonData","messages","loader"]}();
