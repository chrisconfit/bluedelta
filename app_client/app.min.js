!function(){function e(e,r){e.when("/",{templateUrl:"/pages/home/home.view.html",controller:"homeCtrl",controllerAs:"vm"}).when("/register",{templateUrl:"/pages/auth/register/register.view.html",controller:"registerCtrl",controllerAs:"vm"}).when("/login",{templateUrl:"/pages/auth/login/login.view.html",controller:"loginCtrl",controllerAs:"vm"}).when("/closet",{templateUrl:"/pages/closet/closet.view.html",controller:"closetCtrl",controllerAs:"vm",resolve:{jsonData:["jean",function(e){return e.setupJson()}]}}).when("/order/:jeanId?/:userId?",{templateUrl:"/pages/order/order.view.html",controller:"orderCtrl",controllerAs:"vm",resolve:{jsonData:["jean",function(e){return e.setupJson()}]}}).when("/customizer/:jeanId?/:userId?",{templateUrl:"/pages/customizer/customizer.view.html",controller:"customizerCtrl",controllerAs:"vm",resolve:{jsonData:["jean",function(e){return e.setupJson()}]}}).when("/admin",{templateUrl:"/pages/admin/admin.view.html",controller:"adminCtrl",controllerAs:"vm"}).otherwise({redirectTo:"/"}),r.html5Mode(!0)}function r(e,r,t,n,o){e.$on("$routeChangeStart",function(e,n,o){var l=["/closet","/order"];l.indexOf(r.path())>=0&&!t.isLoggedIn()&&r.path("/login")})}angular.module("bdApp",["ngRoute","ngAnimate","ngSanitize","ngCookies","angular-gestures"]);angular.module("bdApp").config(["$routeProvider","$locationProvider",e]).run(["$rootScope","$location","aws","jean","popups",r]).filter("spaceless",function(){return function(e){if(e)return e.replace(/\s+/g,"-")}}).filter("scoreToSpace",function(){return function(e){if(e)return e.replace(/_+/g," ")}}).filter("minMax",function(e,r,t){return function(n){return!(e&&n[t]<e)&&!(r&&n[t]>r)}}).filter("displayName",function(){return function(e){return!!e&&e.replace(/Raw Denim/g,"")}})}();
...
!function(){function e(a,t,n,o,s){function c(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function u(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function l(e,a){return o(function(t,n){var r=new Image;r.src=e,r.onload=function(){a.drawImage(r,0,0,600,696),t(r)},r.onerror=function(e){n(e)}})}var g=this;g.jsonData={},setupJsonData=function(e){g.promises.push(t.get("/data/"+e+".json"))},setupJson=function(){var e=o.defer();console.log(Object.keys(g.jsonData)),Object.keys(g.jsonData).length>0?e.resolve(g.jsonData):console.log("SETTINGUPPP"),g.promises=[];var a=["style","thread","button","fabric","gender"];for(d=0;d<a.length;d++)setupJsonData(a[d]);return o.all(g.promises).then(function(a){for(r=0;r<a.length;r++){var t=a[r].config.url.replace("/data/","").replace(".json","");g.jsonData[t]=a[r].data}e.resolve(g.jsonData)},function(a){e.reject(a)}),e.promise};var j=function(){return g.jsonData},f=function(e,a){console.log(e,a),console.log(e,a),console.log(e,a);var t=g.jsonData[e];if(!t)return!1;for(console.log("NEW"),i=0;i<t.length;i++)if(t[i][e+"Id"]==a)return t[i]};g.jeanData={},set=function(e,a){g.jeanData[e]=a,this.saved=!1},createNew=function(e){e&&e.constructor==Object?g.jeanData={gender:e.gender,style:e.style,fabric:e.fabric.fabricId,accentThread:e.accentThread.threadId,topThread:e.topThread.threadId,bottomThread:e.bottomThread.threadId}:(g.jeanData={gender:1,style:1,fabric:f("fabric",1004),accentThread:f("thread",1),topThread:f("thread",1),bottomThread:f("thread",1)},g.jeanData.saved=!1)};var h=function(t){var r=o.defer();return t?(g.jeanData=t,r.resolve(g.jeanData)):setupJson().then(function(){if(console.log("setup"),a.jeanId&&!a.userId){if(a.jeanId.indexOf(":")>0){createNew(),jeanData=a.jeanId.split(":");for(var t=0;t<jeanData.length;t++){var o=jeanData[t].match(/([A-Za-z]+)([0-9]+)/);if(o){var u=c(o[1]);u&&(g.jeanData[u]=parseInt(o[2]))}}}r.resolve(g.jeanData)}else a.jeanId&&a.userId?n.jeansGet(a.userId,a.jeanId).then(function(t){var o=t.jeanData,c=s.getCurrentUserFromLocalStorage();if(c){var u=n.setupHeaders(c);u==a.userId?g.jeanData=o:createNew(o)}else createNew(o);console.log(e),r.resolve(e.jeanData)},function(a){console.log(a),createNew(),r.resolve(e.jeanData)}):(0===Object.keys(g.jeanData).length&&g.jeanData.constructor===Object&&createNew(),console.log(g.jeanData),r.resolve(g.jeanData))}),r.promise},D=function(){return g.jeanData};createThumb=function(){var e=document.createElement("canvas");e.width=600,e.height=600;for(var a=e.getContext("2d"),t=[],n=["/images/components/fabrics/g"+g.jeanData.gender+"/s2/f"+g.jeanData.fabric+".jpg","/images/components/threads/g"+g.jeanData.gender+"/s2/tb/"+g.jeanData.bottom_thread+".png","/images/components/threads/g"+g.jeanData.gender+"/s2/tt/"+g.jeanData.top_thread+".png","/images/components/threads/g"+g.jeanData.gender+"/s2/ta/"+g.jeanData.accent_thread+".png"],r=0;r<n.length;r++)t.push(l(n[r],a));return o.all(t).then(function(a){var t=e.toDataURL("image/jpeg");return t})},getDataCode=function(){var e="";for(var a in g.jeanData)if(g.jeanData.hasOwnProperty(a)){var t=u(a);t&&(e+="_"+t+g.jeanData[a])}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var p=function(e,a,t){console.log(e,a,t);var r=s.getCurrentUserFromLocalStorage();n.defaultHeaders_.Authorization=r.idToken.getJwtToken(),n.jeansDelete(e,a).then(function(e){t&&t(e)},function(e){console.log(e)})},v=function(){var e=o.defer(),a=this;console.log("jean"),console.log(a);var t=this.getDataCode();return t+=".jpg",this.createThumb().then(function(r){var o=s.getCurrentUserFromLocalStorage();n.defaultHeaders_.Authorization=o.idToken.getJwtToken();var c=o.idToken.jwtToken.split(".")[1],u=JSON.parse(atob(c)).sub;console.log(o),o?s.saveImageTos3(r,o,t).then(function(t){a.set("imageURL",t),a.jeanData.jeanId?n.jeansUpdate(u,a.jeanData.jeanId,a.jeanData).then(function(a){e.resolve(a)},function(a){console.log(a),e.reject(a)}):n.jeansCreate(u,a.jeanData).then(function(t){a.set("jeanId",t.jeanData.jeanId),e.resolve(t)},function(a){e.reject(a)})},function(a){console.log(a),e.reject(a.message)}):e.reject("You are not logged in...")}),e.promise};return{setupJson:setupJson,getJsonData:j,dataLookup:f,deleter:p,save:v,get:D,setup:h,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:createThumb}}angular.module("bdApp").service("jean",["$routeParams","$http","bdAPI","$q","aws",e])}();
...
!function(){function o(o,r,e,t,n,a){var l=this;l.loader=a.get("loader"),l.saver=a.get("saver"),l.drops={},l.drops.acct=!1,l.mobileMenu=!1,l.isLoggedIn=!!t.getCurrentUserFromLocalStorage(),l.logout=function(){t.signCurrentUserOut(),"/"==o.path()&&r.reload()}}angular.module("bdApp").controller("navigationCtrl",o),o.$inject=["$location","$route","popups","aws","$window","loader"]}();
...
!function(){angular.module("bdApp").directive("jeanList",["jean",function(e){return{restrict:"EA",templateUrl:"/directives/jean-list/jean-list.template.html",scope:{fields:"=?"},link:function(t){t.data=e.getJsonData(),t.dataLookup=e.dataLookup,e.setup().then(function(e){t.jean=e});var a=["fabric","accentThread","topThread","bottomThread","gender","style"];t.fields=t.fields||a,t.filterFields=function(e){matches={};for(var a in e)e.hasOwnProperty(a)&&t.fields.indexOf(a)>=0&&(matches[a]=e[a]);return matches}}}}])}();
...
!function(){function e(e,s,a,r,n,t,o,i){function u(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}function l(e){var s=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(s)}function c(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function d(e){for(var s=0;s<m.user.jeans.length;s++)if(m.user.jeans[s].jeanId===e)return{index:s,data:m.user.jeans[s]}}i.show("Getting your profile information...");var m=this;a.closeAll(),m.popups=a.get(),m.messages=o.get(),m.jean=s,m.data={},m.jeans=m.data.jeansList,m.onload=function(){t.vm=m},m.userForm={},m.userForm.editing={},m.userForm.saving={},m.userForm.feedback={type:"",message:""},m.userForm.cancel=function(e){m.userForm.editing[e]=!1,m.user[e]=m.userForm.data[e]},m.userForm.validate=function(e,s){return"email"==e?!!u(s)||(o.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!l(s)||(o.set("Please enter a valid phone number","error"),!1))},m.userForm.save=function(e){""==m.user[e]&&(m.user[e]=null),m.userForm.validate(e,m.user[e])&&(m.userForm.saving[e]=!0,n.usersUpdate(m.user.identityId,m.user).then(function(s){m.userForm.saving[e]=!1,m.userForm.editing[e]=!1,m.userForm.data[e]=m.user[e],t.$apply()},function(e){console.log(e)}))};var p=r.getCurrentUserFromLocalStorage();if(p){n.defaultHeaders_.Authorization=p.idToken.getJwtToken();var f=p.idToken.jwtToken.split(".")[1],F=JSON.parse(atob(f)).sub;n.usersGet(F).then(function(e){i.hide(),m.user=e.data,m.userForm.data=angular.copy(e.data),t.$apply()},function(e){console.log(e)})}else e.path("/");m.passForm={editing:!1,currentPass:"",newPass:"",newPassConfirm:"",clear:function(){m.passForm.editing=!1,m.passForm.currentPass="",m.passForm.newPass="",m.passForm.newPassConfirm="",o.reset()}},m.validatePasswordForm=function(){return c(m.passForm.newPass)||o.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),m.passForm.newPass===m.passForm.newPassConfirm||(o.set("New Password and Confirmation do not match","error"),!1)},m.changePassword=function(){o.reset(),m.validatePasswordForm()&&r.changePassword(m.user.email,m.passForm.currentPass,m.passForm.newPass).then(function(e){m.passForm.clear(),o.set("Password successfully changed.","success")},function(e){o.set(e.message,"error")})},m.copyJean=function(){m.jean=s.createNew(m.displayJean),e.path("/customizer")},m.displayJean={},m.selectJean=function(e){m.popups.jeanProfile=!0,m.displayJean.data=e},m.deleteJean=function(e){s.deleter(m.user.identityId,e,function(s){var a=d(e).index;m.user.jeans.splice(a,1),t.$apply()})},m.orderJean=function(a){console.log("ordering"),s.setup(a),e.path("/order")}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","aws","bdAPI","$scope","messages","loader"]}();
!function(){function e(e,a,t,n,o,i,r,l,p,c,d,s,u,h){function f(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var g=this;g.loader=u.get(),s.reset(),g.messages=s.get(),c.closeAll(),g.popups=c.get(),l.setup().then(function(e){g.jeanData=l.get(),p.$watch(function(){return g.jeanData},function(e,a){g.updateActiveItem()},!0),p.$watch(function(){return g.data},function(e,a){g.updateActiveItem()},!0)}),g.landscape=f();var v="onorientationchange"in window,w=v?"orientationchange":"resize";window.addEventListener(w,function(){g.landscape=f(),p.$apply()},!1),g.data=l.getJsonData(),g.activeItem={},g.updateActiveItem=function(){if(!g.jeanData)return!1;var e=g.data[g.panel[g.panelStep].dataKey],t=g.jeanData[g.panel[g.panelStep].jeanKey];if("object"==typeof t)g.activeItem=t;else{var n=a("filter")(e,{id:t});n&&(n=n[0]),g.activeItem=n||null}},g.panel=[],g.panel.push({panelTemplate:"gender-chooser",dataKey:"gender",title:"Gender",jeanKey:"gender"}),g.panel.push({panelTemplate:"style-chooser",dataKey:"style",title:"Style",jeanKey:"style"}),g.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabric",title:"Fabric",jeanKey:"fabric"}),g.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Top Thread",jeanKey:"topThread"}),g.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Bottom Thread",jeanKey:"bottomThread"}),g.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Accent Thread",jeanKey:"accentThread"}),g.panel.push({panelTemplate:"list",title:"Overview"}),g.panelDir="next",g.panelStep=0,g.changeStep=function(e){return!(e>=g.panel.length)&&(!(e<0)&&(void 0!==e&&(g.panelStep=e,void(e+1!=g.panel.length&&g.updateActiveItem()))))},g.orderCallback=function(){g.saveCallback(function(){n.path("/order")})},g.placeOrder=function(){return d.isLoggedIn()?void g.saveCallback(function(){n.path("/order")}):(g.authCallback=g.orderCallback,c.set("loginOrRegister",!0),!1)},g.savingBar=!1,g.saveCallback=function(e){c.closeAll(),g.savingBar=!0,l.save().then(function(a){g.savingBar=!1;var t=d.getCurrentUserFromLocalStorage(),o=r.setupHeaders(t);n.path("/customizer/"+g.jeanData.jeanId+"/"+o),e&&e(a)})},g.saveJean=function(){return d.isLoggedIn()?void g.saveCallback():(g.authCallback=g.saveCallback,c.set("loginOrRegister",!0),!1)},g.authCallback=g.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","messages","loader","jsonData"]}();
!function(){function n(n,a,e){n.jean=a.data}angular.module("bdApp").controller("homeCtrl",n),n.$inject=["$scope","jean","$animate"]}();
!function(){function o(o,e,r,t,a,n,s,d,p){var l=this;l.popups=t.get(),r.setup().then(function(o){l.jean=o,console.log(l.jean);var r=n.getCurrentUserFromLocalStorage(),t=s.setupHeaders(r);console.log("jean is set up"),console.log(l.jean.jeanId),console.log(t),l.jean.jeanId&&t&&(console.log("hm.."),e.path("/order/"+l.jean.jeanId+"/"+t))}),l.orderForm={},l.orderForm.step=1,l.orderForm.data={},l.chooseFitType=function(o){l.orderForm.data.fitType=o,2!=o||l.orderForm.data.tailor||(l.popups.tailors=!0)},l.tailorLocations=[],l.data=p.getData(),l.orderForm.nextStep=function(){if(1==l.orderForm.step)return!!l.orderForm.data.fitType&&(2!=l.orderForm.data.fitType||l.orderForm.data.tailor?void(l.orderForm.step=2):(l.popups.tailors=!0,!1))};var i=n.getCurrentUserFromLocalStorage();if(i){var u=s.setupHeaders(i);s.usersGet(u).then(function(o){l.user=o.data,d.$apply()},function(o){console.log(o)})}else e.path("/login")}angular.module("bdApp").controller("orderCtrl",o),o.$inject=["$window","$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
...
!function(){function e(e,r,t,a){function o(e){var r=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return r.test(e)}function s(e){var r=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return r.test(e)}var n=this;console.log(a),n.messages=t.get(),n.credentials={loginEmail:"",loginPassword:""},n.login=function(o,s){t.reset(),n.validateLoginForm()&&(console.log("valid"),r.authenticateCognitoUser(o,s).then(function(r){a.callback&&a.callback(),a.redirect&&e.path(a.redirect),a.callback||a.redirect||e.path("/customizer")},function(e){"Incorrect username or password."==e.message&&(e.message="Incorrect Email address or password."),t.set(e.message,"error")}))},n.validateLoginForm=function(){return o(n.credentials.loginEmail)?!!n.credentials.loginPassword||(t.set("Please enter a password","error"),!1):(t.set("Please enter a valid Email address","error"),!1)},n.forgotPassword=!1,n.forgotPassword2=!1,n.forgot=function(){t.reset(),n.validateForgot()&&r.forgotPassword(n.credentials.loginEmail).then(function(e){n.forgotPassword2=!0},function(e){"Username/client id combination not found"==e.message&&(e.message="We don't have an account registered for that emial"),t.set(e.message,"error")})},n.validateForgot=function(){return!!o(n.credentials.loginEmail)||(t.set("Please enter a valid Email address","error"),!1)},n.forgot2=function(){t.reset(),n.validateForgot2()&&r.setNewPassword(n.credentials.loginEmail,n.credentials.loginVerifcation,n.credentials.newPassword).then(function(){t.set("Password reset successfully. Try logging in.","success"),n.forgotPassword=!1,n.forgotPassword2=!1},function(e){t.set(e.message,"error")})},n.validateForgot2=function(){return o(n.credentials.loginEmail)?n.credentials.loginVerifcation?(s(n.credentials.newPassword)||t.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),n.credentials.newPassword===n.credentials.newPasswordConfirm||(t.set("Password and Confirmation do not match","error"),!1)):(t.set("Please enter your verifcation code","error"),!1):(t.set("Please enter a valid Email address","error"),!1)},n.loginFB=function(){r.authenticateViaFB().then(function(r){e.path("/closet")},function(e){t.set(e.message,"error")})}}angular.module("bdApp").controller("loginFormCtrl",e),e.$inject=["$location","aws","messages","$scope"]}();
...
!function(){function e(e,a,r,t,s){var i=this;i.messages=s.get(),i.credentials={name:"",email:"",password:""},i.validateRegistrationForm=function(){function e(e){var a=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return a.test(e)}function a(e){var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.test(e)}return i.credentials.email&&i.credentials.name&&i.credentials.password&&i.credentials.passwordConfirm?(e(i.credentials.password)||s.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),i.credentials.password!==i.credentials.passwordConfirm?(s.set("Password and Confirmation do not match","error"),!1):!!a(i.credentials.email)||(s.set("Please Enter a valid E-mail address","error"),!1)):(s.set("All fields are required","error"),!1)},i.registerUser=function(){s.reset(),i.validateRegistrationForm()&&r.signupForApplication(i.credentials.email,i.credentials.name,i.credentials.password).then(function(r){e.callback&&e.callback(),e.redirect&&a.path(e.redirect),e.callback||e.redirect||a.path("/login")},function(e){s.set(e.message,"error")})}}angular.module("bdApp").controller("registerFormCtrl",e),e.$inject=["$scope","$location","aws","$sce","messages"]}();
