...
!function(){function e(e,n){var t=this;t.jean=n,t.centerPan=!1,t.zoom=!1,t.pan="0% 30% 0",t.breakPoint=800,t.returnPan=function(){t.pan="50% 30% 0",t.centerPan=!0,images=angular.element(document.querySelectorAll("#zoom-frame img")),setTimeout(function(){images.css({"transform-origin":t.pan})},200)},t.drag=function(e){console.log("dragger"),console.log(e)},t.scanImage=function(n,o){setTimeout(function(){t.centerPan=!1},200),frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(n-offsetL)/fWidth*100,yPosition=(o-offsetT)/fHeight*100,e.innerWidth<t.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",t.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},t.trackMouse=function(n){return!(e.innerWidth<t.breakPoint)&&void t.scanImage(n.pageX,n.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","jean"]}();
!function(){function t(){return{restrict:"AE",templateUrl:"/common/directives/image-stack/image-stack.template.html",controller:"istackCtrl as isvm",link:function(t,e,n,a){t.myDrag=function(e,n){t.isvm.scanImage(n.center.x,n.center.y)}}}}angular.module("meanApp").directive("imageStack",t)}();
