...
!function(){function o(o,n,e,t){var r=e.createUserPool(t.poolInfo);console.log(r);var i=function(o){n.localStorage["mean-token"]=o},a=function(){return n.localStorage["mean-token"]},s=function(){var o,e=a();return!!e&&(o=e.split(".")[1],o=n.atob(o),o=JSON.parse(o),o.exp>Date.now()/1e3)},l=function(){if(s()){var o=a();console.log(o);var e=o.split(".")[1];return e=n.atob(e),e=JSON.parse(e),{email:e.email,name:e.name}}},c=function(){if(s()){var o=a(),e=o.split(".")[1];e=n.atob(e),e=JSON.parse(e),console.log(e);var t=e.permissions;return t.indexOf("admin")!==-1}};return register=function(n){return console.log("USER! => ",n),o.post("/api/register",n).success(function(o){i(o.token)})},login=function(n){return o.post("/api/login",n).success(function(o){i(o.token)})},logout=function(){n.localStorage.removeItem("mean-token")},{isAdmin:c,currentUser:l,saveToken:i,getToken:a,isLoggedIn:s,register:register,login:login,logout:logout}}console.log(AWSCognito),angular.module("bdApp").service("authentication",o),o.$inject=["$http","$window","aws","awsConfig"]}();
!function(){function o(o,e){AWSCognito.config.region="us-east-1",createUserPool=function(o){var e=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(o);return e};var t={poolData:{UserPoolId:"us-east-1_LOGu3QxlG",ClientId:"722lmps6diglhvjek6gmrk4g69"}};return{createUserPool:createUserPool,configSettings:t}}angular.module("bdApp").service("aws",o),o.$inject=["$http","$window"]}();
!function(){function n(n,e){var o="us-east-1",i={UserPoolId:"us-east-1_LOGu3QxlG",ClientId:"722lmps6diglhvjek6gmrk4g69"};return{poolInfo:i,region:o}}angular.module("bdApp").service("awsConfig",n),n.$inject=["$http","$window"]}();
