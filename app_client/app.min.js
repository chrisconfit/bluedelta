...
!function(){function t(t,e){if(console.log(t),t.BlueDeltaApi){t._thirdParty=t._thirdParty||{},t._thirdParty.BlueDeltaApi=t.BlueDeltaApi;try{delete t.BlueDeltaApi}catch(a){t.BlueDeltaApi=void 0}}var n=t._thirdParty.BlueDeltaApi;return n.jsonData={},n.jsonData.getJeansByUser=function(t){return e.get("/data/chris-jeans.json")},n.jsonData.getProfile=function(){return e.get("/data/profile.json")},n.jsonData.getStyles=function(){return e.get("/data/styles.json")},n.jsonData.getThreads=function(){return e.get("/data/threads.json")},n.jsonData.getHardware=function(){return e.get("/data/buttons.json")},n.jsonData.getFabrics=function(){return e.get("/data/fabrics.json")},n.jsonData.getGenders=function(){return e.get("/data/genders.json")},n}angular.module("bdApp").service("bdAPI",t),t.$inject=["$window","$http"]}();
...
!function(){function e(e,t,n,a,o,s){var u=this,r=new s.DefaultApi;o.getCurrentUserFromLocalStorage().then(function(e){r.apiClient.defaultHeaders.Authorization=e,u.setUpClosetData()},function(e){console.log("you are not authenticated..."+e)}),u.popups=n,u.user={},u.jeans=[],u.jean={},u.data={},u.setupData=function(e,t){s.jsonData[e]().success(function(e){u.data[t]=e}).error(function(e){console.log(e)})},u.setUpClosetData=function(){console.log(r),console.log(r.usersList()),u.setupData("getGenders","genders"),u.setupData("getStyles","styles"),u.setupData("getFabrics","fabrics"),u.setupData("getThreads","threads"),s.jsonData.getJeansByUser(1).success(function(e){for(x=0;x<e.length;x++)u.jeans.push(e[x])}).error(function(e){console.log(e)})},u.jean=t,u.dataLookup=function(e,t,n){if("undefined"==typeof e||"undefined"==typeof t)return!1;n=n||null;var o=e.includes("thread")?"threads":e+"s",s=u.data[o];return selected=a("filter")(s,{id:t})[0],n?selected[n]:selected},u.copyJean=function(){u.jean=t.createNew(u.jean),e.path("/customizer")},u.selectJean=function(e){console.log(e),console.log(u.jean),u.popups.jeanProfile=!0,u.jean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","$filter","aws","bdAPI"]}();
