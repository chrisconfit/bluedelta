!function(){function e(e,t,r){e.when("/",{templateUrl:"home/home.view.html",controller:"homeCtrl",controllerAs:"vm"}).when("/register",{templateUrl:"/auth/register/register.view.html",controller:"registerCtrl",controllerAs:"vm"}).when("/login",{templateUrl:"/auth/login/login.view.html",controller:"loginCtrl",controllerAs:"vm"}).when("/closet",{templateUrl:"/closet/closet.view.html",controller:"closetCtrl",controllerAs:"vm"}).when("/customizer",{templateUrl:"/customizer/customizer.view.html",controller:"customizerCtrl",controllerAs:"vm"}).when("/admin",{templateUrl:"/admin/admin.view.html",controller:"adminCtrl",controllerAs:"vm"}).otherwise({redirectTo:"/"}),t.html5Mode(!0),console.log(r),r.set({recognizers:[[Hammer.Pan,{enable:!0}],[Hammer.Tap,{time:250}]]})}function t(e,t,r){e.$on("$routeChangeStart",function(e,o,l){var n=["/closet"];n.indexOf(t.path())>=0&&!r.isLoggedIn()})}angular.module("meanApp",["ngRoute","ngAnimate","angular-gestures"]),angular.module("meanApp").config(["$routeProvider","$locationProvider","hammerDefaultOptsProvider",e]).run(["$rootScope","$location","authentication",t]).filter("spaceless",function(){return function(e){if(e)return e.replace(/\s+/g,"-")}}).filter("scoreToSpace",function(){return function(e){if(e)return e.replace(/_+/g," ")}}).filter("minMax",function(e,t,r){return function(o){return!(e&&o[r]<e)&&!(t&&o[r]>t)}})}();
...
!function(){function e(e,t,a,n,r,i,d,o){function l(){var e=navigator.userAgent.toLowerCase(),t=e.indexOf("android")>-1;if(t){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var u=this;u.landscape=l();var s="onorientationchange"in window,p=s?"orientationchange":"resize";window.addEventListener(p,function(){u.landscape=l(),d.$apply()},!1),u.popups=o,u.form={},u.form.steps=[],u.form.steps[1]={template:"/customizer/form-templates/gender.html",title:"Gender"},u.form.steps[2]={template:"/customizer/form-templates/style.html",title:"Style"},u.form.steps[3]={template:"/customizer/form-templates/build.html",title:"Build"},u.jean=i,u.jean.step=i.step?i.step:1,u.jean.data.gender=1,u.jean.data.style=2,u.jean.step=3,u.form.nextStep=function(){u.jean.step=u.jean.step+1},u.form.selectStyle=function(e){u.jean.data.style=e,u.form.nextStep()},u.jean.data.fabric=u.jean.data.fabric||"1004",u.jean.data.accent_thread=u.jean.data.accent_thread||"1",u.jean.data.top_thread=u.jean.data.top_thread||"1",u.jean.data.bottom_thread=u.jean.data.bottom_thread||"1",u.jean.data.hardware=u.jean.data.hardware||"1",u.builder={},d.drag=function(e){console.log("controller func"),console.log(e),console.log("why not")},u.builder.panelDir="next",u.builder.panel=[],u.builder.panel[1]={panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric",thumbPrefix:"f"},u.builder.panel[2]={panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread",thumbPrefix:"f"},u.builder.panel[3]={panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread",thumbPrefix:"f"},u.builder.panel[4]={panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread",thumbPrefix:"f"},u.builder.panel[5]={panelTemplate:"chooser",dataKey:"hardware",title:"Hardware",jeanKey:"hardware",thumbPrefix:"f"},u.builder.panel[6]={panelTemplate:"list",title:"Overview",dataKey:"hardware",jeanKey:"hardware",thumbPrefix:"f"},u.builder.activeItem=function(){var t=u.builder[u.builder.panel[u.builder.step].dataKey],a=u.jean.data[u.builder.panel[u.builder.step].jeanKey];return e("filter")(t,{id:a})[0]},u.builder.styleByGender=function(e){return function(t){return t["images_"+e]}},u.dataLookup=function(t,a,n){n=n||null;var r="gender"==t||"style"==t?t+"s":e("filter")(u.builder.panel,{jeanKey:t})[0].dataKey,i=u.builder[r];return selected=e("filter")(i,{id:a})[0],n?selected[n]:selected},u.builder.getActiveItemName=function(){var e=u.builder.activeItem().name;return e=e.replace(/Raw Denim/g,"")},u.builder.step=1,u.builder.changeStep=function(e){return!(e>=u.builder.panel.length)&&(!(e<=0)&&(!!e&&void(u.builder.step=e)))},d.dir="next",r.getGenders().then(function(e){u.builder.genders=e.data}),r.getStyles().then(function(e){u.builder.styles=e.data}),r.getThreads().then(function(e){u.builder.threads=e.data}),r.getHardware().then(function(e){u.builder.hardware=e.data}),r.getFabrics().then(function(e){u.builder.fabrics=e.data})}angular.module("meanApp").controller("customizerCtrl",e),e.$inject=["$filter","$timeout","$location","$window","meanData","jean","$scope","popups"]}();
...
!function(){function e(e,t){var o=this;o.jean=t,o.centerPan=!1,o.zoom=!1,o.pan="0% 30% 0",o.isMobile=function(){return e.innerWidth<800},o.toggleZoom=function(){o.zoom=!o.zoom},o.returnPan=function(){return!o.isMobile()&&(o.pan="50% 30% 0",o.centerPan=!0,images=angular.element(document.querySelectorAll("#zoom-frame img")),void setTimeout(function(){images.css({"transform-origin":o.pan})},200))},o.touchStart=function(e){var t=e.touches[0].clientX/e.touches[0].target.clientWidth*100,n=e.touches[0].clientY/e.touches[0].target.clientHeight*100;t>100&&(t=100),t<0&&(t=0),n>100&&(n=100),n<0&&(n=0),o.pan=t+"% "+n+"% 0",images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":o.pan})},o.zoomDrag={x:0,y:0},o.dragTracker={x:0,y:0},o.touchMove=function(e){e.preventDefault(),console.log(e);var t=e.touches[0].clientX/e.touches[0].target.clientWidth*100,n=e.touches[0].clientY/e.touches[0].target.clientHeight*100;t>100&&(t=100),t<0&&(t=0),n>100&&(n=100),n<0&&(n=0),o.pan=100-t+"% "+(100-n)+"% 0",images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":o.pan})},o.zoomDrag={x:0,y:0},o.dragTracker={x:0,y:0},o.panDirection=!1,o.dragPan=function(e,t){if(console.log(t.direction),!o.isMobile())return!1;if(!o.zoom)return!1;var n=angular.element(document.querySelectorAll("#zoom-frame img")),r=(window.innerHeight,n[0].height,{width:t.target.clientWidth,height:t.target.clientHeight}),i={x:t.deltaX,y:t.deltaY},a=i.x-o.dragTracker.x,c=i.y-o.dragTracker.y;console.log(a,c);var a=Math.abs(a)/r.width*100;a=i.x<0?-a:a;var c=Math.abs(c)/r.height*100;c=i.y<0?-c:c,a+=o.zoomDrag.x,c+=o.zoomDrag.y;var l={y:{},x:{}};l.y.top=60,l.y.bottom=-90,l.x.left=-150,l.x.right=60,c>l.y.top&&(c=l.y.top),c<l.y.bottom&&(c=l.y.bottom),a<l.x.left&&(a=l.x.left),a>l.x.right&&(a=l.x.right);var g={x:a,y:c};console.log(g),o.zoomDrag=g;var m=-a+"% "+-c+"% 0";n.css({"transform-origin":m}),o.dragTracker=t.isFinal?{x:0,y:0}:i},o.scanImage=function(t,n){setTimeout(function(){o.centerPan=!1},200),frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(t-offsetL)/fWidth*100,yPosition=(n-offsetT)/fHeight*100,e.innerWidth<o.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",o.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},o.trackMouse=function(e){return!o.isMobile()&&void o.scanImage(e.pageX,e.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","jean"]}();
!function(){function t(){return{restrict:"AE",templateUrl:"/common/directives/image-stack/image-stack.template.html",controller:"istackCtrl as isvm",link:function(t,c,e,i){c.on("touchstart",function(c){t.isvm.touchStart(c)}),c.on("touchmove",function(c){t.isvm.touchMove(c)})}}}angular.module("meanApp").directive("imageStack",t)}();
