...
!function(){function o(o,r,e,t,a,n,p,d,i){var s=this;s.popups=t.get(),e.setup().then(function(o){s.jean=o,s.jean.jeanId&&r.path("/order/"+s.jean.jeanId)}),s.orderForm={},s.orderForm.step=1,s.orderForm.data={},s.chooseFitType=function(o){s.orderForm.data.fitType=o,2!=o||s.orderForm.data.tailor||(s.popups.tailors=!0)},s.tailorLocations=[],s.data=i.getData(),s.orderForm.nextStep=function(){if(console.log("running next step..."),1==s.orderForm.step)return s.orderForm.data.fitType?2!=s.orderForm.data.fitType||s.orderForm.data.tailor?void(s.orderForm.step=2):(console.log("no tailor"),s.popups.tailors=!0,!1):(console.log("no fit type"),!1)};var l=n.getCurrentUserFromLocalStorage();if(l){var u=p.setupHeaders(l);p.usersGet(u).then(function(o){s.user=o.data,d.$apply()},function(o){console.log(o)})}else r.path("/login")}angular.module("bdApp").controller("orderCtrl",o),o.$inject=["$window","$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
...
!function(){angular.module("bdApp").directive("jeanList",["jean","jsonData",function(e,t){return{restrict:"EA",templateUrl:"/directives/jean-list/jean-list.template.html",scope:{fields:"=?"},link:function(a){a.data=t.getData(),a.dataLookup=t.dataLookup,e.setup().then(function(e){a.jean=e}),console.log(a.jean);var n=["fabric","accent_thread","top_thread","bottom_thread","gender","style"];a.fields=a.fields||n,a.filterFields=function(e){matches={};for(var t in e)e.hasOwnProperty(t)&&a.fields.indexOf(t)>=0&&(matches[t]=e[t]);return matches}}}}])}();
