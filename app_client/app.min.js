...
!function(){function t(t,e,a,n){function r(t){switch(t){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function o(t){switch(t){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function s(t,e){return a(function(a,n){var r=new Image;r.src=t,r.onload=function(){e.drawImage(r,0,0,600,696),a(r)},r.onerror=function(t){n(t)}})}data={},set=function(t,e){this.data[t]=e,this.saved=!1},createNew=function(t){t&&t.constructor==Object?this.data={title:"Copy of "+t.data.title,gender:t.data.gender,style:t.data.style,fabric:t.data.fabric,accent_thread:t.data.accent_thread,top_thread:t.data.top_thread,bottom_thread:t.data.bottom_thread}:(this.data={gender:1,style:1,fabric:"1004",accent_thread:"1",top_thread:"1",bottom_thread:"1"},this.saved=!1)};var c=function(){if(t.jean_id&&"copy"==t.action)if(t.jean_id.indexOf(":")>0){this.createNew(),jeanData=t.jean_id.split(":");for(var a=0;a<jeanData.length;a++){var n=jeanData[a].match(/([A-Za-z]+)([0-9]+)/);if(n){var o=r(n[1]);o&&(this.data[o]=parseInt(n[2]))}}}else this.createNew(t.jean_id);else t.jean_id&&!t.action?e.jsonData.getJeanById(t.jean_id,function(t){t?this.data=t:this.createNew()}):0===Object.keys(this.data).length&&this.data.constructor===Object&&this.createNew();return this.data},d=function(){return this.data};createThumb=function(){var t=document.createElement("canvas");t.width=600,t.height=600;for(var e=t.getContext("2d"),n=[],r=["/images/components/fabrics/g"+this.data.gender+"/s2/f"+this.data.fabric+".jpg","/images/components/threads/g"+this.data.gender+"/s2/tb/"+this.data.bottom_thread+".png","/images/components/threads/g"+this.data.gender+"/s2/tt/"+this.data.top_thread+".png","/images/components/threads/g"+this.data.gender+"/s2/ta/"+this.data.accent_thread+".png"],o=0;o<r.length;o++)n.push(s(r[o],e));return a.all(n).then(function(e){var a=t.toDataURL("image/jpeg");return a})},getDataCode=function(){var t="";for(var e in this.data)if(this.data.hasOwnProperty(e)){var a=o(e);a&&(t+="_"+a+this.data[e])}return t=t.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var i=function(){var t=a.defer(),r=this.data;console.log("jean"),console.log(r);var o=this.getDataCode();return o+=".jpg",this.createThumb().then(function(a){var s=n.getCurrentUserFromLocalStorage();e.defaultHeaders_.Authorization=s.idToken.getJwtToken();var c=s.idToken.jwtToken.split(".")[1],d=JSON.parse(atob(c)).sub;console.log(s),s?n.saveImageTos3(a,s,o).then(function(a){r.image=a,console.log(r),r.jeanId?e.jeansUpdate(userId,jeanId,r).then(function(e){t.resolve(e)},function(e){console.log(e),t.reject(e)}):e.jeansCreate(d,r).then(function(e){t.resolve(e)},function(e){console.log(e),t.reject(e)})},function(e){console.log(e),t.reject(e.message)}):t.reject("You are not logged in...")}),t.promise};return{save:i,get:d,setup:c,data:data,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:createThumb}}angular.module("bdApp").service("jean",["$routeParams","bdAPI","$q","aws",t])}();
...
!function(){function e(e,a,r,o,n,s,t,u,i){function l(e){var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.test(e)}function c(e){var a=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(a)}i.show("Getting your profile information...");var d=this;r.closeAll(),d.popups=r.get(),d.messages=u.get(),d.jean=a,d.data=t.getData(),d.jeans=d.data.jeansList,d.onload=function(){s.vm=d},d.userForm={},d.userForm.editing={},d.userForm.saving={},d.userForm.feedback={type:"",message:""},d.userForm.cancel=function(e){console.log(e),d.userForm.editing[e]=!1,d.user[e]=d.userForm.data[e]},d.userForm.validate=function(e,a){return"email"==e?!!l(a)||(u.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!c(a)||(u.set("Please enter a valid phone number","error"),!1))},d.userForm.save=function(e){""==d.user[e]&&(d.user[e]=null),d.userForm.validate(e,d.user[e])&&(d.userForm.saving[e]=!0,n.usersUpdate(d.user.identityId,d.user).then(function(a){d.userForm.saving[e]=!1,d.userForm.editing[e]=!1,d.userForm.data[e]=d.user[e],s.$apply()},function(e){console.log(e)}))};var p=o.getCurrentUserFromLocalStorage();if(p){n.defaultHeaders_.Authorization=p.idToken.getJwtToken();var m=p.idToken.jwtToken.split(".")[1],g=JSON.parse(atob(m)).sub;n.usersGet(g).then(function(e){i.hide(),d.user=e.data,console.log(d.user),d.userForm.data=angular.copy(e.data),s.$apply(),console.log(d.user)},function(e){console.log(e)})}else e.path("/");d.copyJean=function(){d.jean=a.createNew(d.displayJean),e.path("/customizer")},d.displayJean={},d.selectJean=function(e){d.popups.jeanProfile=!0,d.displayJean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","aws","bdAPI","$scope","jsonData","messages","loader"]}();
!function(){function e(e,a,t,n,o,i,l,r,d,p,s,c,u,h){function g(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var f=this;f.loader=h.get(),u.reset(),f.messages=u.get(),p.closeAll(),f.popups=p.get(),f.landscape=g();var v="onorientationchange"in window,w=v?"orientationchange":"resize";window.addEventListener(w,function(){f.landscape=g(),d.$apply()},!1),f.jean={data:r.setup()},f.data=c.getData(),d.$watch(function(){return f.jean.data},function(e,a){f.updateActiveItem()},!0),d.$watch(function(){return f.data},function(e,a){f.updateActiveItem()},!0),f.activeItem={},f.updateActiveItem=function(){var e=f.data[f.panel[f.panelStep].dataKey],t=f.jean.data[f.panel[f.panelStep].jeanKey],n=a("filter")(e,{id:t});n&&(n=n[0]),f.activeItem=n||null},f.panel=[],f.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),f.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),f.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),f.panel.push({panelTemplate:"list",title:"Overview"}),f.panelDir="next",f.panelStep=0,f.changeStep=function(e){return!(e>=f.panel.length)&&(!(e<0)&&(void 0!==e&&(f.panelStep=e,void(e+1!=f.panel.length&&f.updateActiveItem()))))},f.orderCallback=function(){f.saveCallback(function(){n.path("/order")})},f.placeOrder=function(){return s.isLoggedIn()?void f.saveCallback(function(){n.path("/order")}):(f.authCallback=f.orderCallback,p.set("loginOrRegister",!0),!1)},f.savingBar=!1,f.saveCallback=function(e){p.closeAll(),f.savingBar=!0,r.save().then(function(e){f.savingBar=!1,console.log(e)})},f.saveJean=function(){return s.isLoggedIn()?void f.saveCallback():(f.authCallback=f.saveCallback,p.set("loginOrRegister",!0),!1)},f.authCallback=f.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","jsonData","messages","loader"]}();
