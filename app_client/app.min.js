...
!function(){function e(e,a,t,n,r,i,o,d){function l(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var p=this;p.landscape=l();var c="onorientationchange"in window,s=c?"orientationchange":"resize";window.addEventListener(s,function(){p.landscape=l(),o.$apply()},!1),p.popups=d,p.jean=i,p.jean.data.gender=1,p.jean.data.style=1,p.jean.selectStyle=function(e){p.jean.data.style=e},p.jean.data.fabric=p.jean.data.fabric||"1004",p.jean.data.accent_thread=p.jean.data.accent_thread||"1",p.jean.data.top_thread=p.jean.data.top_thread||"1",p.jean.data.bottom_thread=p.jean.data.bottom_thread||"1",p.data={},p.panelDir="next",p.panel=[],p.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),p.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),p.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),p.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),p.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),p.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),p.panel.push({panelTemplate:"list",title:"Overview"}),p.panelStep=0,p.changeStep=function(e){return!(e>=p.panel.length)&&(!(e<0)&&(void 0!==e&&void(p.panelStep=e)))},p.activeItem=function(){var a=p.data[p.panel[p.panelStep].dataKey],t=p.jean.data[p.panel[p.panelStep].jeanKey];return console.log(a,t),e("filter")(a,{id:t})[0]},p.getActiveItemName=function(){var e=p.activeItem().name;return e=e.replace(/Raw Denim/g,"")},p.styleByGender=function(e){return function(a){return a["images_"+e]}},p.dataLookup=function(a,t,n){n=n||null;var r="gender"==a||"style"==a?a+"s":e("filter")(p.panel,{jeanKey:a})[0].dataKey,i=p.data[r];return selected=e("filter")(i,{id:t})[0],n?selected[n]:selected},r.getGenders().then(function(e){p.data.genders=e.data}),r.getStyles().then(function(e){p.data.styles=e.data}),r.getThreads().then(function(e){p.data.threads=e.data}),r.getHardware().then(function(e){p.data.hardware=e.data}),r.getFabrics().then(function(e){p.data.fabrics=e.data})}angular.module("meanApp").controller("customizerCtrl",e),e.$inject=["$filter","$timeout","$location","$window","meanData","jean","$scope","popups"]}();
