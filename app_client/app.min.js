...
!function(){function t(){return data={},set=function(t,a){this.data[t]=a,this.saved=!1},createNew=function(t){t&&t.constructor==Object?this.data={title:"Copy of "+t.data.title,gender:t.data.gender,style:t.data.style,fabric:t.data.fabric,accent_thread:t.data.accent_thread,top_thread:t.data.top_thread,bottom_thread:t.data.bottom_thread,id:Math.floor(1e9*Math.random())}:(this.data={gender:1,style:1,fabric:"1004",accent_thread:"1",top_thread:"1",bottom_thread:"1",id:Math.floor(1e9*Math.random())},this.saved=!1)},{data:data,set:set,createNew:createNew}}angular.module("bdApp").service("jean",t)}();
!function(){function t(t,e,a){for(data={},setupJsonData=function(e){t.get("/data/"+e+".json").then(function(t){data[e]=t.data})},jsonDataKeys=["jeansList","profile","styles","threads","buttons","fabrics","genders","tailors"],d=0;d<jsonDataKeys.length;d++)setupJsonData(jsonDataKeys[d]);var n=function(t){var e=!1;switch(!0){case t.indexOf("thread")>-1:e="threads";break;case"gender"==t||"style"==t||"fabric"==t:e=t+"s"}return e},s=function(t,a,n){if(n=n||null,"undefined"==typeof t||"undefined"==typeof a)return!1;var d=data[t];return dataById=e("filter")(d,{id:a}),"undefined"!=typeof dataById&&(selected=dataById[0],n?selected[n]:selected)};return{getData:function(){return data},jeanKeyToDataKey:n,dataLookup:s}}angular.module("bdApp").service("jsonData",t),t.$inject=["$http","$filter","$timeout"]}();
...
!function(){function e(e,o,n,s){var r=this;console.log(s),r.messages=n.get(),r.credentials={loginEmail:"",loginPassword:""},r.validateLoginForm=function(){function e(e){var o=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return o.test(e)}return e(r.credentials.loginEmail)?!!r.credentials.loginPassword||(n.set("Please enter a password","error"),!1):(n.set("Please enter a valid Email address","error"),!1)},r.login=function(t,a){console.log("loggingin"),n.reset(),r.validateLoginForm()&&(console.log("valid"),o.authenticateCognitoUser(t,a).then(function(o){console.log("res"),s.redirect?e.path(s.redirect):e.path("/closet")},function(e){"Incorrect username or password."==e.message&&(e.message="Incorrect Email address or password."),n.set(e.message,"error")}))},r.loginFB=function(){o.authenticateViaFB().then(function(o){e.path("/closet")},function(e){n.set(e.message,"error")})}}angular.module("bdApp").controller("loginFormCtrl",e),e.$inject=["$location","aws","messages","$scope"]}();
!function(){function r(){return{restrict:"AE",templateUrl:"/directives/login-form/login-form.template.html",controller:"loginFormCtrl as logvm",link:function(r,t,e){r.redirect=e.redirect}}}angular.module("bdApp").directive("loginForm",r)}();
!function(){function o(o,n,t,a,e){var r=this;r.drops={},r.drops.acct=!1,r.mobileMenu=!1,r.isLoggedIn=!!e.localStorage.isLoggedIn&&JSON.parse(e.localStorage.isLoggedIn),r.logout=function(){a.signCurrentUserOut(),"/"==o.path()&&n.reload()}}angular.module("bdApp").controller("navigationCtrl",o),o.$inject=["$location","$route","popups","aws","$window"]}();
...
!function(){function e(e,a,r,s){var t=this;t.messages=s.get(),console.log(t.messages),t.credentials={name:"",email:"",password:""},t.validateRegistrationForm=function(){function e(e){var a=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return a.test(e)}function a(e){var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.test(e)}return t.credentials.email&&t.credentials.name&&t.credentials.password&&t.credentials.passwordConfirm?(e(t.credentials.password)||s.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),t.credentials.password!==t.credentials.passwordConfirm?(s.set("Password and Confirmation do not match","error"),!1):!!a(t.credentials.email)||(s.set("Please Enter a valid E-mail address","error"),!1)):(s.set("All fields are required","error"),!1)},t.registerUser=function(){s.reset(),t.validateRegistrationForm()&&a.signupForApplication(t.credentials.email,t.credentials.password).then(function(){console.log("we are registering...")},function(e){s.set(e.message,"error")})}}angular.module("bdApp").controller("registerFormCtrl",e),e.$inject=["$location","aws","$sce","messages"]}();
!function(){function r(){return{restrict:"AE",templateUrl:"/directives/register-form/register-form.template.html",controller:"registerFormCtrl as regvm"}}angular.module("bdApp").directive("registerForm",r)}();
...
!function(){function e(e,o,n,a,t,s,l,c){var i=this;n.closeAll(),i.popups=n.get(),console.log(i.popups),i.jean=o,i.data=c.getData(),console.log(i.data),i.jeans=i.data.jeansList,i.onload=function(){l.vm=i},t.getCurrentUserFromLocalStorage().then(function(e){s.defaultHeaders_.Authorization=e.idToken.getJwtToken();var o=e.idToken.jwtToken.split(".")[1],n=JSON.parse(atob(o)).sub;s.usersGet(n).then(function(e){i.user=e.data,l.$apply()},function(e){console.log(e)})},function(e){console.log("you are not authenticated..."+e)});i.copyJean=function(){i.jean=o.createNew(i.displayJean),e.path("/customizer")},i.displayJean={},i.selectJean=function(e){i.popups.jeanProfile=!0,i.displayJean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
!function(){function e(e,t,a,n,r,o,i,c,d,s,l,u,p){function h(){var e=navigator.userAgent.toLowerCase(),t=e.indexOf("android")>-1;if(t){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}function f(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function g(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function m(t,a){return e(function(e,n){var r=new Image;r.src=t,r.onload=function(){a.drawImage(r,0,0,600,696),e(r)},r.onerror=function(e){n(e)}})}var w=this;p.reset(),w.messages=p.get(),s.closeAll(),w.popups=s.get(),w.isLoggedIn=!!r.localStorage.isLoggedIn&&JSON.parse(r.localStorage.isLoggedIn),w.landscape=h();var v="onorientationchange"in window,j=v?"orientationchange":"resize";if(window.addEventListener(j,function(){w.landscape=h(),d.$apply()},!1),o.jean_id&&"copy"==o.action)if(o.jean_id.indexOf(":")>0){c.createNew(),jeanData=o.jean_id.split(":");for(var y=0;y<jeanData.length;y++){var b=jeanData[y].match(/([A-Za-z]+)([0-9]+)/);if(b){var I=f(b[1]);I&&(c.data[I]=parseInt(b[2]))}}}else c.createNew(o.jean_id);else o.jean_id&&!o.action?i.jsonData.getJeanById(o.jean_id,function(e){e?c.data=e:c.createNew()}):0===Object.keys(c.data).length&&c.data.constructor===Object&&c.createNew();w.jean=c,w.jeanToUrl=function(){var e=document.location.origin+"/customizer/d";for(var t in w.jean.data)if(w.jean.data.hasOwnProperty(t)){var a=g(t);a&&(e+=":"+a+w.jean.data[t])}e+="/copy",console.log(e)},w.data=u.getData(),w.dataLookup=function(e,t,a){return e=u.jeanKeyToDataKey(e),u.dataLookup(e,t,a)||null},d.$watch(function(){return w.jean.data},function(e,t){w.updateActiveItem()},!0),d.$watch(function(){return w.data},function(e,t){w.updateActiveItem()},!0),w.activeItem={},w.updateActiveItem=function(){var e=w.data[w.panel[w.panelStep].dataKey],a=w.jean.data[w.panel[w.panelStep].jeanKey],n=t("filter")(e,{id:a});n&&(n=n[0]),w.activeItem=n||null},w.panel=[],w.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),w.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),w.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),w.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),w.panel.push({panelTemplate:"list",title:"Overview"}),w.panelDir="next",w.panelStep=0,w.changeStep=function(e){return!(e>=w.panel.length)&&(!(e<0)&&(void 0!==e&&(w.panelStep=e,void(e+1!=w.panel.length&&w.updateActiveItem()))))},w.placeOrder=function(){return w.isLoggedIn?void n.path("/order"):(s.set("orderLogin",!0),!1)},w.saveJean=function(){l.getCurrentUserFromLocalStorage().then(function(e){var t=e;w.createThumb().then(function(e){l.saveImageTos3(e,t).then(function(){console.log("image saved"),w.jean.saved=!0},function(e){console.log(e)})})},function(e){alert("you must be logged in to save!")})},w.createThumb=function(){var t=document.createElement("canvas");t.width=600,t.height=600;for(var a=t.getContext("2d"),n=[],r=document.getElementsByClassName("zoomed-image"),o=0;o<r.length;o++){var i=r[o];n.push(m(i.src,a))}return e.all(n).then(function(e){var a=t.toDataURL("image/jpeg");return a})}}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","jsonData","messages"]}();
!function(){function n(n,a,e){n.jean=a.data}angular.module("bdApp").controller("homeCtrl",n),n.$inject=["$scope","jean","$animate"]}();
!function(){function o(o,t,e,r,n,a,i,s){var d=this;d.popups=e.get(),d.jean=t,d.orderForm={},d.orderForm.step=1,d.orderForm.data={},d.chooseFitType=function(o){d.orderForm.data.fitType=o,2!=o||d.orderForm.data.tailor||(d.popups.tailors=!0)},d.tailorLocations=[],d.data=s.getData(),d.orderForm.nextStep=function(){if(console.log("running next step..."),1==d.orderForm.step)return d.orderForm.data.fitType?2!=d.orderForm.data.fitType||d.orderForm.data.tailor?void(d.orderForm.step=2):(console.log("no tailor"),d.popups.tailors=!0,!1):(console.log("no fit type"),!1)},d.jeans=[],n.getCurrentUserFromLocalStorage().then(function(o){a.defaultHeaders_.Authorization=o.idToken.getJwtToken();var t=o.idToken.jwtToken.split(".")[1],e=JSON.parse(atob(t)).sub;a.usersGet(e).then(function(o){d.user=o.data,i.$apply()},function(o){console.log(o)})},function(o){console.log("you are not authenticated..."+o)})}angular.module("bdApp").controller("orderCtrl",o),o.$inject=["$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
