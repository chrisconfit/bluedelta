...
!function(){function e(e,n,t){var o=this;o.jean=t,o.centerPan=!1,o.zoom=!1,o.pan="0% 30% 0",o.breakPoint=800,o.returnPan=function(){o.pan="50% 30% 0",o.centerPan=!0,images=angular.element(document.querySelectorAll("#zoom-frame img")),setTimeout(function(){images.css({"transform-origin":o.pan})},100)},o.scanImage=function(n,t){setTimeout(function(){o.centerPan=!1},700),frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(n-offsetL)/fWidth*100,yPosition=(t-offsetT)/fHeight*100,e.innerWidth<o.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",o.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},o.trackMouse=function(n){return!(e.innerWidth<o.breakPoint)&&void o.scanImage(n.pageX,n.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","$swipe","jean"]}();
