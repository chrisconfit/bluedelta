...
!function(){function e(e,a,t,n,o,l,r,i,c,s,p,d,u,h){function g(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var f=this;f.loader=u.get(),d.reset(),f.messages=d.get(),s.closeAll(),f.popups=s.get(),console.log("set"),i.setup().then(function(e){console.log("res"),console.log(e),console.log(i.get()),f.jeanData=i.get(),console.log("new JS"),console.log(f.jeanData),c.$watch(function(){return f.jeanData},function(e,a){f.updateActiveItem()},!0),c.$watch(function(){return f.data},function(e,a){f.updateActiveItem()},!0)}),f.landscape=g();var v="onorientationchange"in window,w=v?"orientationchange":"resize";window.addEventListener(w,function(){f.landscape=g(),c.$apply()},!1),f.data=h,f.activeItem={},f.updateActiveItem=function(){if(!f.jeanData)return!1;var e=f.data[f.panel[f.panelStep].dataKey],t=f.jeanData[f.panel[f.panelStep].jeanKey];if("object"==typeof t)f.activeItem=t;else{var n=a("filter")(e,{id:t});n&&(n=n[0]),f.activeItem=n||null}},f.panel=[],f.panel.push({panelTemplate:"gender-chooser",dataKey:"gender",title:"Gender",jeanKey:"gender"}),f.panel.push({panelTemplate:"style-chooser",dataKey:"style",title:"Style",jeanKey:"style"}),f.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabric",title:"Fabric",jeanKey:"fabric"}),f.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Top Thread",jeanKey:"top_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Bottom Thread",jeanKey:"bottom_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"thread",title:"Accent Thread",jeanKey:"accent_thread"}),f.panel.push({panelTemplate:"list",title:"Overview"}),f.panelDir="next",f.panelStep=0,f.changeStep=function(e){return!(e>=f.panel.length)&&(!(e<0)&&(void 0!==e&&(f.panelStep=e,void(e+1!=f.panel.length&&f.updateActiveItem()))))},f.orderCallback=function(){f.saveCallback(function(){n.path("/order")})},f.placeOrder=function(){return p.isLoggedIn()?void f.saveCallback(function(){n.path("/order")}):(f.authCallback=f.orderCallback,s.set("loginOrRegister",!0),!1)},f.savingBar=!1,f.saveCallback=function(e){s.closeAll(),f.savingBar=!0,i.save().then(function(a){f.savingBar=!1;var t=p.getCurrentUserFromLocalStorage(),o=r.setupHeaders(t);n.path("/customizer/"+f.jeanData.jeanId+"/"+o),e&&e(a)})},f.saveJean=function(){return p.isLoggedIn()?void f.saveCallback():(f.authCallback=f.saveCallback,s.set("loginOrRegister",!0),!1)},f.authCallback=f.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","messages","loader","jsonData"]}();
!function(){function n(n,a,e){n.jean=a.data}angular.module("bdApp").controller("homeCtrl",n),n.$inject=["$scope","jean","$animate"]}();
!function(){function r(r,e,o,n,t,a,s,d,l){function p(r){for(var e=0;e<r.length;e++)if(1==r[e].primary)return r[e];return console.log("no address marked as primary... returning first result"),r[0]}var i=this;i.popups=n.get(),o.setup(),i.jean=o.get();var u=a.getCurrentUserFromLocalStorage(),c=s.setupHeaders(u);i.jean.jeanId&&c&&e.path("/order/"+i.jean.jeanId+"/"+c),i.orderForm={},i.orderForm.step=1,i.order={userId:c,price:null,shippingAddress:null,vendor:null,rep:null,status:"New",orderItems:[{jean:i.jean,tracking:null,notes:null}],timeline:null,tailor:null},i.placeOrder=function(){console.log("placing order..."),s.orderCreate(i.order).then(function(r){console.log(r),s.commentsCreate(r.data.orderId,"Order Placed")},function(r){console.log(r)})},i.chooseFitType=function(r){i.order.orderType=r,2!=r||i.order.tailor||(i.popups.tailors=!0)},i.data=l,i.orderForm.nextStep=function(){if(1==i.orderForm.step)return!!i.order.orderType&&(2!=i.order.orderType||i.order.tailor?void(i.orderForm.step=2):(i.popups.tailors=!0,!1))};var g=a.getCurrentUserFromLocalStorage();if(g){var f=s.setupHeaders(g);s.usersGet(f).then(function(r){i.user=r.data,i.order.shippingAddress=p(i.user.address),d.$apply()},function(r){console.log(r)})}else e.path("/login")}angular.module("bdApp").controller("orderCtrl",r),r.$inject=["$window","$location","jean","popups","$filter","aws","bdAPI","$scope","jsonData"]}();
