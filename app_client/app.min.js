...
!function(){function e(e,t,a,r,n,l,i,o){var d=this;d.popups=o,d.form={},d.form.steps=[],d.form.steps[1]={template:"/customizer/form-templates/gender.html",title:"Gender"},d.form.steps[2]={template:"/customizer/form-templates/style.html",title:"Style"},d.form.steps[3]={template:"/customizer/form-templates/build.html",title:"Build"},d.jean=l,d.jean.step=l.step?l.step:1,d.jean.data.gender=1,d.jean.data.style=2,d.jean.step=3,d.form.nextStep=function(){d.jean.step=d.jean.step+1},d.form.selectStyle=function(e){d.jean.data.style=e,d.form.nextStep()},d.jean.data.fabric=d.jean.data.fabric||"1004",d.jean.data.accent_thread=d.jean.data.accent_thread||"1",d.jean.data.top_thread=d.jean.data.top_thread||"1",d.jean.data.bottom_thread=d.jean.data.bottom_thread||"1",d.jean.data.hardware=d.jean.data.hardware||"1",d.builder={},d.builder.panelDir="next",d.builder.panel=[],d.builder.panel[1]={panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric",thumbPrefix:"f"},d.builder.panel[2]={panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread",thumbPrefix:"f"},d.builder.panel[3]={panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread",thumbPrefix:"f"},d.builder.panel[4]={panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread",thumbPrefix:"f"},d.builder.panel[5]={panelTemplate:"chooser",dataKey:"hardware",title:"Hardware",jeanKey:"hardware",thumbPrefix:"f"},d.builder.panel[6]={panelTemplate:"list",title:"Overview",dataKey:"hardware",jeanKey:"hardware",thumbPrefix:"f"},d.builder.activeItem=function(){var t=d.builder[d.builder.panel[d.builder.step].dataKey],a=d.jean.data[d.builder.panel[d.builder.step].jeanKey];return e("filter")(t,{id:a})[0]},d.builder.styleByGender=function(e){return function(t){return t["images_"+e]}},d.dataLookup=function(t,a,r){r=r||null;var n="gender"==t||"style"==t?t+"s":e("filter")(d.builder.panel,{jeanKey:t})[0].dataKey,l=d.builder[n];return selected=e("filter")(l,{id:a})[0],r?selected[r]:selected},d.builder.getActiveItemName=function(){var e=d.builder.activeItem().name;return e=e.replace(/Raw Denim/g,"")},d.builder.step=1,d.builder.changeStep=function(e){return!(e>=d.builder.panel.length)&&(!(e<=0)&&(!!e&&void(d.builder.step=e)))},i.dir="next",d.builder.zoom=!1,d.builder.pan="50%,50%",d.builder.trackMouse=function(e){frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+r.pageYOffset-rootDoc.clientTop,offsetL=rect.left+r.pageXOffset-rootDoc.clientLeft,xPosition=(e.pageX-offsetL)/fWidth*100,yPosition=(e.pageY-offsetT)/fHeight*100,pan=xPosition+"% "+yPosition+"% 0",d.builder.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},d.builder.selectAttr=function(e,a,r,n){var n=angular.element(document.querySelector("#"+r+"-selector")),l=angular.element(e.target).prop("offsetTop"),i=angular.element(e.target).prop("offsetLeft"),o=angular.element(document.querySelectorAll("#item-title"));o.css({right:"-400px",opacity:0}),n.css({top:l+"px",left:i+"px"}),t(function(){o.css({right:"15px",opacity:1}),d.jean.data[r]=a},200)},d.builder.jeanSet=function(e,t){d.jean.data[e]=t},n.getGenders().then(function(e){d.builder.genders=e.data}),n.getStyles().then(function(e){d.builder.styles=e.data}),n.getThreads().then(function(e){d.builder.threads=e.data}),n.getHardware().then(function(e){d.builder.hardware=e.data}),n.getFabrics().then(function(e){d.builder.fabrics=e.data})}angular.module("meanApp").controller("customizerCtrl",e),e.$inject=["$filter","$timeout","$location","$window","meanData","jean","$scope","popups"]}();
...
!function(){function e(e,t,n,r,o,l){function a(e,t,n){e=e[0],t=t-e.offsetWidth/2+40;var r=e.scrollWidth-e.offsetWidth;t>=r&&(t=r-1),t==r&&(t=r-1);var o=Math.ceil(n/15),l=t-e.scrollLeft,a=l/o,c=e.scrollLeft<t?function(e,t){return e<=t-1}:function(e,t){return e>=t+1},i=setInterval(function(){if(c(e.scrollLeft,t)){var n=e.scrollLeft+a;n>=r&&(n=r-1),e.scrollLeft=n}else clearInterval(i)},15)}var c=this;c.popups=l,c.jean=o,c.breakPoint=800,e.$watch("active",function(e,o){return!(r.innerWidth>=c.breakPoint)&&void(1==e&&n(function(){var e=angular.element(t[0].querySelector(".chooser-select")),n=e.prop("offsetLeft"),r=angular.element(t[0].querySelector(".chooser-grid"));n=n-r[0].offsetWidth/2+40,r[0].scrollLeft=n},200))}),c.selectAttr=function(e,t,o,l){var i=angular.element(document.querySelector("#"+o+"-chooser")),l=angular.element(document.querySelector("#"+o+"-selector")),u=angular.element(e.target).prop("offsetTop"),f=angular.element(e.target).prop("offsetLeft"),s=angular.element(document.querySelectorAll("#item-title"));s.css({right:"-400px",opacity:0}),l.css({top:u+"px",left:f+"px"}),r.innerWidth<c.breakPoint&&a(i,f,200),n(function(){s.css({right:"15px",opacity:1}),c.jean.data[o]=t},200)},c.jeanSet=function(e,t){c.jean.data[e]=t}}angular.module("meanApp").controller("chooserCtrl",e),e.$inject=["$scope","$element","$timeout","$window","jean","popups"]}();
