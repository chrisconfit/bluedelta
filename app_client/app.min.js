...
!function(){function e(e,t,n,a,r,i){e._thirdParty=e._thirdParty||{},e._thirdParty.BlueDeltaApi=new API.Client.DefaultApi(angular.injector(["ng"]).get("$http"),angular.injector(["ng"]).get("$httpParamSerializer"),angular.injector(["ng"]));var o=e._thirdParty.BlueDeltaApi;for(o.jsonData={},setupJsonData=function(e){t.get("/data/"+e+".json").then(function(t){o.jsonData[e]=t.data})},jsonDataKeys=["chris-jeans","profile","styles","threads","buttons","fabrics","genders","tailors"],d=0;d<jsonDataKeys.length;d++)setupJsonData(jsonDataKeys[d]);o.jeanKeyToDataKey=function(e){var t=!1;switch(!0){case e.indexOf("thread")>-1:t="threads";break;case"gender"==e||"style"==e||"fabric"==e:t=e+"s"}return t},o.dataLookup=function(e,t,n){if(n=n||null,"undefined"==typeof e||"undefined"==typeof t)return!1;var r=o.jsonData[e];return dataById=a("filter")(r,{id:t}),"undefined"!=typeof dataById&&(selected=dataById[0],n?selected[n]:selected)};var s=function(e){var t=JSON.stringify(e);return t=t.replace(/\"\"/g,null),e=JSON.parse(t)};return o.setupHeaders=function(e){this.defaultHeaders_.Authorization=e.idToken.getJwtToken();var t=e.idToken.jwtToken.split(".")[1],n=JSON.parse(atob(t)).sub;return n},o.saveUser=function(e){var t=r.defer();return e=s(e),e.identityId?o.usersUpdate(e.identityId,e).then(function(e){console.log("got it"),t.resolve(e)},function(e){console.log("Error saving user:"),console.log(e),t.reject(e)}):t.reject("No identity Id"),t.promise},o}angular.module("bdApp").service("bdAPI",e),e.$inject=["$window","$http","$httpParamSerializer","$filter","$q","aws"]}();
...
!function(){function e(e,a,t,n,i,o,r,l,p,c,d,s,u,h){function f(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}var g=this;g.loader=h.get(),u.reset(),g.messages=u.get(),c.closeAll(),g.popups=c.get(),l.setup().then(function(e){g.jean=l.get(),p.$watch(function(){return g.jean.data},function(e,a){g.updateActiveItem()},!0),p.$watch(function(){return g.data},function(e,a){g.updateActiveItem()},!0)}),g.landscape=f();var v="onorientationchange"in window,w=v?"orientationchange":"resize";window.addEventListener(w,function(){g.landscape=f(),p.$apply()},!1),g.data=s.getData(),g.activeItem={},g.updateActiveItem=function(){if(!g.jean)return!1;var e=g.data[g.panel[g.panelStep].dataKey],t=g.jean[g.panel[g.panelStep].jeanKey],n=a("filter")(e,{id:t});n&&(n=n[0]),g.activeItem=n||null},g.panel=[],g.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),g.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),g.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),g.panel.push({panelTemplate:"list",title:"Overview"}),g.panelDir="next",g.panelStep=0,g.changeStep=function(e){return!(e>=g.panel.length)&&(!(e<0)&&(void 0!==e&&(g.panelStep=e,void(e+1!=g.panel.length&&g.updateActiveItem()))))},g.orderCallback=function(){g.saveCallback(function(){n.path("/order")})},g.placeOrder=function(){return d.isLoggedIn()?void g.saveCallback(function(){n.path("/order")}):(g.authCallback=g.orderCallback,c.set("loginOrRegister",!0),!1)},g.savingBar=!1,g.saveCallback=function(e){c.closeAll(),g.savingBar=!0,l.save().then(function(a){g.savingBar=!1,e&&e(a)})},g.saveJean=function(){return d.isLoggedIn()?void g.saveCallback():(g.authCallback=g.saveCallback,c.set("loginOrRegister",!0),!1)},g.authCallback=g.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","jsonData","messages","loader"]}();
