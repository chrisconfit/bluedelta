...
!function(){function e(e,t,n,o,a,s){var u=this;u.popups=n,u.jean=t,u.data={},u.jeans=[],a.getCurrentUserFromLocalStorage().then(function(e){s.defaultHeaders_.Authorization=e.idToken.getJwtToken(),u.setUpClosetData();var t=e.idToken.jwtToken.split(".")[1],n=JSON.parse(atob(t)).sub;s.usersGet(n).then(function(e){u.user=e.data,$scope.$apply()},function(e){console.log(e)})},function(e){console.log("you are not authenticated..."+e)}),u.setupData=function(e,t){s.jsonData[e]().success(function(e){u.data[t]=e}).error(function(e){console.log(e)})};u.setUpClosetData=function(){u.setupData("getGenders","genders"),u.setupData("getStyles","styles"),u.setupData("getFabrics","fabrics"),u.setupData("getThreads","threads"),s.jsonData.getJeansByUser(1).success(function(e){for(x=0;x<e.length;x++)u.jeans.push(e[x])}).error(function(e){console.log(e)})},u.dataLookup=function(e,t,n){if("undefined"==typeof e||"undefined"==typeof t)return!1;n=n||null;var a=e.includes("thread")?"threads":e+"s",s=u.data[a];return selected=o("filter")(s,{id:t})[0],n?selected[n]:selected},u.copyJean=function(){u.jean=t.createNew(u.jean),e.path("/customizer")},u.selectJean=function(e){console.log(e),console.log(u.jean),u.popups.jeanProfile=!0,u.jean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","$filter","aws","bdAPI"]}();
