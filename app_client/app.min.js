...
!function(){function e(e,t,o,n,a,s){var c=this;a.getCurrentUserFromLocalStorage().then(function(e){s.defaultHeaders_.Authorization=e.idToken.getJwtToken(),c.setUpClosetData()},function(e){console.log("you are not authenticated..."+e)}),c.popups=o,c.user={},c.jeans=[],c.jean={},c.data={},c.setupData=function(e,t){s.jsonData[e]().success(function(e){c.data[t]=e}).error(function(e){console.log(e)})},c.setUpClosetData=function(){a.getCurrentUserFromLocalStorage().then(function(e){console.log("user"),console.log(e.idToken);var t=e.idToken.jwtToken.split(".")[1],o=JSON.parse(sjcl.codec.utf8String.fromBits(sjcl.codec.base64url.toBits(t)));console.log(o)},function(e){console.log(e)}),c.setupData("getGenders","genders"),c.setupData("getStyles","styles"),c.setupData("getFabrics","fabrics"),c.setupData("getThreads","threads"),s.jsonData.getJeansByUser(1).success(function(e){for(x=0;x<e.length;x++)c.jeans.push(e[x])}).error(function(e){console.log(e)})},c.jean=t,c.dataLookup=function(e,t,o){if("undefined"==typeof e||"undefined"==typeof t)return!1;o=o||null;var a=e.includes("thread")?"threads":e+"s",s=c.data[a];return selected=n("filter")(s,{id:t})[0],o?selected[o]:selected},c.copyJean=function(){c.jean=t.createNew(c.jean),e.path("/customizer")},c.selectJean=function(e){console.log(e),console.log(c.jean),c.popups.jeanProfile=!0,c.jean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","$filter","aws","bdAPI"]}();
