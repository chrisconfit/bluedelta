...
!function(){function e(e,t,n,o,a,s){var r=this;a.getCurrentUserFromLocalStorage().then(function(e){s.defaultHeaders_.Authorization=e.idToken.getJwtToken(),r.setUpClosetData()},function(e){console.log("you are not authenticated..."+e)}),r.popups=n,r.user={},r.jeans=[],r.jean={},r.data={},r.setupData=function(e,t){s.jsonData[e]().success(function(e){r.data[t]=e}).error(function(e){console.log(e)})},r.setUpClosetData=function(){console.log(s),console.log(s.usersList()),r.setupData("getGenders","genders"),r.setupData("getStyles","styles"),r.setupData("getFabrics","fabrics"),r.setupData("getThreads","threads"),s.jsonData.getJeansByUser(1).success(function(e){for(x=0;x<e.length;x++)r.jeans.push(e[x])}).error(function(e){console.log(e)})},r.jean=t,r.dataLookup=function(e,t,n){if("undefined"==typeof e||"undefined"==typeof t)return!1;n=n||null;var a=e.includes("thread")?"threads":e+"s",s=r.data[a];return selected=o("filter")(s,{id:t})[0],n?selected[n]:selected},r.copyJean=function(){r.jean=t.createNew(r.jean),e.path("/customizer")},r.selectJean=function(e){console.log(e),console.log(r.jean),r.popups.jeanProfile=!0,r.jean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","$filter","aws","bdAPI"]}();
