...
!function(){function e(e,t,n,o){function r(e,t,n){e=e[0],t=t-e.offsetWidth/2+40;var o=e.scrollWidth-e.offsetWidth;t>=o&&(t=o-1),t==o&&(t=o-1);var r=Math.ceil(n/15),l=t-e.scrollLeft,a=l/r,c=e.scrollLeft<t?function(e,t){return e<=t-1}:function(e,t){return e>=t+1},i=setInterval(function(){if(c(e.scrollLeft,t)){var n=e.scrollLeft+a;n>=o&&(n=o-1),e.scrollLeft=n}else clearInterval(i)},15)}var l=this;console.log("data"),l.jean=o,l.breakPoint=800,l.selectAttr=function(e,o,a,c){var i=angular.element(document.querySelector("#"+a+"-chooser")),c=angular.element(document.querySelector("#"+a+"-selector")),f=angular.element(e.target).prop("offsetTop"),s=angular.element(e.target).prop("offsetLeft"),u=angular.element(document.querySelectorAll("#item-title"));u.css({right:"-400px",opacity:0}),c.css({top:f+"px",left:s+"px"}),n.innerWidth<l.breakPoint&&r(i,s,200),t(function(){u.css({right:"15px",opacity:1}),l.jean.data[a]=o},200)},l.jeanSet=function(e,t){l.jean.data[e]=t}}angular.module("meanApp").controller("chooserCtrl",e),e.$inject=["$scope","$timeout","$window","jean"]}();
!function(){function e(){return{restrict:"EA",templateUrl:"/common/directives/choosers/chooser.template.html",controller:"chooserCtrl as chvm",scope:{step:"=",dataset:"="}}}angular.module("meanApp").directive("chooser",e)}();
!function(){angular.module("meanApp").directive("fabricChooser",["$window",function(e){return{restrict:"EA",template:'<div class="fabric-chooser-container" ng-include="viewUrl"></div>',controller:"chooserCtrl as chvm",scope:{step:"=",dataset:"="},link:function(i){function o(){var o=e.innerWidth;o<i.breakPoint?i.viewUrl="/common/directives/choosers/fabric-chooser-mobile.html":o>=i.breakPoint&&(i.viewUrl="/common/directives/choosers/fabric-chooser-desk.html"),console.log(i.viewUrl)}i.breakPoint=800,e.onresize=function(){o(),i.$apply()},o(),i.weightFilter=function(e,i){return function(o){return!(e&&o.weight<e)&&!(i&&o.weight>i)}}}}}])}();
...
!function(){function n(n,o,t){var i=this;i.isLoggedIn=o.isLoggedIn(),i.isAdmin=o.isAdmin(),i.currentUser=o.currentUser(),i.drops={},i.drops.acct=!1,i.mobileMenu=!1,i.logout=function(){o.logout(),"/"==n.path()&&t.reload()}}angular.module("meanApp").controller("navigationCtrl",n),n.$inject=["$location","authentication","$route"]}();
