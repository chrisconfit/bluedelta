...
!function(){function e(e,t,o,n){function r(){var e={UserPoolId:n.USER_POOL_ID,ClientId:n.CLIENT_ID},t=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return t}function s(e,t){var o={Username:e,Password:t},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(o);return n}function a(e,t){var o={Username:e,Pool:t},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(o);return n}function c(e,t){var o={Name:e,Value:t},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(o);return n}function u(e,t){var o,n=[];for(var r in t)o=e(r,t[r]),n.push(o);return n}function l(e){var t=e.split(".")[1];return JSON.parse(atob(t)).sub}function d(e){var t=o.defer(),r={};return r["cognito-idp."+n.REGION+".amazonaws.com/"+n.USER_POOL_ID]=e,AWS.config.update({region:n.REGION,credentials:new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID,Logins:r})}),AWS.config.credentials.needsRefresh()?(AWS.config.credentials.clearCachedId(),AWS.config.credentials.get(function(e){e&&t.reject(e),t.resolve()})):AWS.config.credentials.get(function(e){e&&t.reject(e),t.resolve()}),t.promise}return getUserFromLocalStorage=function(e){var t=a(e,r());null!=t&&t.getSession(function(e,t){return e?void alert(e):void console.log("session validity: "+t.isValid())})},deleteCognitoUser=function(){var e=r().getCurrentUser();e.deleteUser(function(e,t){return e?void alert(e):void console.log("call result: "+t)})},authenticateViaFB=function(){var e=o.defer();return FB.login(function(t){t.authResponse?(AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID,Logins:{"graph.facebook.com":t.authResponse.accessToken}}),e.resolve()):e.reject("There was a problem logging in with Facebook.")}),e.promise},authenticateCognitoUser=function(e,t){var n=s(e,t),i=a(e,r()),c=o.defer();return i.authenticateUser(n,{onSuccess:function(e){c.resolve(e),console.log("access token + "+e.getAccessToken().getJwtToken()),console.log("idToken + "+e.idToken.jwtToken)},onFailure:function(e){c.reject(e)},newPasswordRequired:function(e,t){console.log(e,t)}}),c.promise},signupForApplication=function(e,t){var n=o.defer(),i=u(c,{email:e});return r().signUp(e,t,i,null,function(e,t){e?n.reject(e):n.resolve(t)}),n.promise},updateAttributesOnUser=function(e,t){var o=u(c,t),n=a(e,r());n.updateAttributes(o,function(e,t){return e?void alert(e):void console.log("call result: "+t)})},deleteUserAttributes=function(e,t){e.deleteAttributes(t,function(e,t){return e?void alert(e):void console.log("call result: "+t)})},verifyUserAttribute=function(e,t){e.getAttributeVerificationCode(t,{onSuccess:function(e){console.log("call result: "+e)},onFailure:function(e){alert(e)},inputVerificationCode:function(){var o=prompt("Please input verification code: ","");e.verifyAttribute(t,o,this)}})},retrieveUserAttributes=function(e){e.getUserAttributes(function(e,t){if(e)return void alert(e);for(i=0;i<t.length;i++)console.log("attribute "+t[i].getName()+" has value "+t[i].getValue())})},resendConfirmationCode=function(e){e.resendConfirmationCode||(e=a(e,r())),e.resendConfirmationCode(function(e,t){return!e||void console.log(e)})},confirmRegistration=function(e,t){e.confirmRegistration(t,!0,function(e,t){return e?void alert(e):void alert(t)})},changePassword=function(e,t,o){e.changePassword(t,o,function(e,t){return e?void alert(e):void console.log("call result: "+t)})},forgotPasswordFlow=function(e){e.forgotPassword({onSuccess:function(e){console.log("call result: "+e)},onFailure:function(e){alert(e)},inputVerificationCode:function(){var t=prompt("Please input verification code ",""),o=prompt("Enter new password ","");e.confirmPassword(t,o,this)}})},deleteUser=function(e){e.deleteUser(function(e,t){return e?void alert(e):void console.log("call result: "+t)})},signUserOut=function(e){null!=e&&e.signOut()},signCurrentUserOut=function(){var e=r().getCurrentUser();null!=e&&e.signOut()},signUserOutGlobally=function(e){e.globalSignOut()},getCurrentUserFromLocalStorage=function(){var e=o.defer(),t=r().getCurrentUser();return null!=t?t.getSession(function(t,o){return t?(e.reject(t),e.promise):(AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID}),void e.resolve(o))}):e.reject("User is not logged in..."),e.promise},confirmRegisteredUnauthenticatedUser=function(e,t){var n=a(e,r()),i=o.defer();return n.confirmRegistration(t,!0,function(e,t){e?i.reject(e):i.resolve(t)}),i.promise},changePassword=function(e,t,o){e.changePassword(t,o,function(e,t){return e?void alert(e):void console.log("call result: "+t)})},saveImageTos3=function(e,t){var r=o.defer(),i=l(t.idToken.jwtToken);return console.log("userIdentityID: "+i),d(t.idToken.jwtToken).then(function(){var t="blue-delta-api-development-stack-userdatabucket-12z57hiicf3xy",o=new AWS.S3({region:n.REGION,params:{Bucket:t}});console.log(n.REGION);var s={Key:encodeURIComponent(i+"//")+"myfilename.png",Body:e};console.log(s),o.upload(s,function(e,t){e?(console.log("Failed to upload"),console.log(e),r.reject(e)):(console.log("Successfully uploaded image to S3."),console.log(t))})},function(e){r.reject(e)}),r.promise},{authenticateViaFB:authenticateViaFB,getUserFromLocalStorage:getUserFromLocalStorage,deleteCognitoUser:deleteCognitoUser,authenticateCognitoUser:authenticateCognitoUser,signupForApplication:signupForApplication,updateAttributesOnUser:updateAttributesOnUser,deleteUserAttributes:deleteUserAttributes,verifyUserAttribute:verifyUserAttribute,retrieveUserAttributes:retrieveUserAttributes,resendConfirmationCode:resendConfirmationCode,confirmRegistration:confirmRegistration,changePassword:changePassword,forgotPasswordFlow:forgotPasswordFlow,deleteUser:deleteUser,signUserOut:signUserOut,signUserOutGlobally:signUserOutGlobally,getCurrentUserFromLocalStorage:getCurrentUserFromLocalStorage,confirmRegisteredUnauthenticatedUser:confirmRegisteredUnauthenticatedUser,signCurrentUserOut:signCurrentUserOut,saveImageTos3:saveImageTos3}}angular.module("bdApp").service("aws",e),e.$inject=["$http","$window","$q","AWSConfig"]}();
!function(){function t(t,a,n){t._thirdParty=t._thirdParty||{},t._thirdParty.BlueDeltaApi=new API.Client.DefaultApi(angular.injector(["ng"]).get("$http"),angular.injector(["ng"]).get("$httpParamSerializer"),angular.injector(["ng"]));var e=t._thirdParty.BlueDeltaApi;return e.jsonData={},e.jsonData.getJeansByUser=function(t){return a.get("/data/chris-jeans.json")},e.jsonData.getProfile=function(){return a.get("/data/profile.json")},e.jsonData.getStyles=function(){return a.get("/data/styles.json")},e.jsonData.getThreads=function(){return a.get("/data/threads.json")},e.jsonData.getHardware=function(){return a.get("/data/buttons.json")},e.jsonData.getFabrics=function(){return a.get("/data/fabrics.json")},e.jsonData.getGenders=function(){return a.get("/data/genders.json")},e.jsonData.getJeanById=function(t,n){a.get("/data/chris-jeans.json").then(function(a){a.data;for(j=0;j<a.data.length;j++)if(a.data[j].id==t){console.log("jean found");var e=a.data[j]}n(e)})},e}angular.module("bdApp").service("bdAPI",t),t.$inject=["$window","$http","$httpParamSerializer"]}();
...
!function(){function e(e,t,n,o,a,s,u){var r=this;r.popups=n,r.jean=t,r.data={},r.jeans=[],a.getCurrentUserFromLocalStorage().then(function(e){s.defaultHeaders_.Authorization=e.idToken.getJwtToken(),r.setUpClosetData();var t=e.idToken.jwtToken.split(".")[1],n=JSON.parse(atob(t)).sub;s.usersGet(n).then(function(e){r.user=e.data,u.$apply()},function(e){console.log(e)})},function(e){console.log("you are not authenticated..."+e)}),r.setupData=function(e,t){s.jsonData[e]().success(function(e){r.data[t]=e}).error(function(e){console.log(e)})};r.setUpClosetData=function(){r.setupData("getGenders","genders"),r.setupData("getStyles","styles"),r.setupData("getFabrics","fabrics"),r.setupData("getThreads","threads"),s.jsonData.getJeansByUser(1).success(function(e){for(x=0;x<e.length;x++)r.jeans.push(e[x])}).error(function(e){console.log(e)})},r.dataLookup=function(e,t,n){if("undefined"==typeof e||"undefined"==typeof t)return!1;n=n||null;var a=e.includes("thread")?"threads":e+"s",s=r.data[a];return selected=o("filter")(s,{id:t})[0],n?selected[n]:selected},r.copyJean=function(){r.jean=t.createNew(r.jean),e.path("/customizer")},r.selectJean=function(e){console.log(e),console.log(r.jean),r.popups.jeanProfile=!0,r.jean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","$filter","aws","bdAPI","$scope"]}();
!function(){function e(e,t,a,n,r,o,i,c,d,l,s){function u(){var e=navigator.userAgent.toLowerCase(),t=e.indexOf("android")>-1;if(t){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}function p(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function f(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function h(t,a){return e(function(e,n){var r=new Image;r.src=t,r.onload=function(){a.drawImage(r,0,0,600,696),e(r)},r.onerror=function(e){n(e)}})}var g=this;g.landscape=u();var y="onorientationchange"in window,m=y?"orientationchange":"resize";if(window.addEventListener(m,function(){g.landscape=u(),d.$apply()},!1),g.popups=l,console.log(o),o.jean_id&&"copy"==o.action)if(o.jean_id.indexOf(":")>0){c.createNew(),jeanData=o.jean_id.split(":");for(var v=0;v<jeanData.length;v++){var w=jeanData[v].match(/([A-Za-z]+)([0-9]+)/);if(w){var j=p(w[1]);j&&(c.data[j]=parseInt(w[2]))}}}else c.createNew(o.jean_id);else o.jean_id&&!o.action?i.jsonData.getJeanById(o.jean_id,function(e){e?c.data=e:c.createNew()}):0===Object.keys(c.data).length&&c.data.constructor===Object&&c.createNew();g.jean=c,g.jeanToUrl=function(){var e=document.location.origin+"/customizer/d";for(var t in g.jean.data)if(g.jean.data.hasOwnProperty(t)){var a=f(t);a&&(e+=":"+a+g.jean.data[t])}e+="/copy",console.log(e)},g.panel=[],g.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),g.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),g.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),g.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),g.panel.push({panelTemplate:"list",title:"Overview"}),g.panelDir="next",g.panelStep=0,g.changeStep=function(e){return!(e>=g.panel.length)&&(!(e<0)&&(void 0!==e&&(g.panelStep=e,void(e+1!=g.panel.length&&g.updateActiveItem()))))},g.activeItem={},g.updateActiveItem=function(){var e=g.data[g.panel[g.panelStep].dataKey],a=g.jean.data[g.panel[g.panelStep].jeanKey],n=t("filter")(e,{id:a})[0];g.activeItem=n},g.styleByGender=function(e){return function(t){return t["images_"+e]}},g.dataLookup=function(e,a,n){if("undefined"==typeof e||"undefined"==typeof a)return!1;n=n||null;var r=t("filter")(g.panel,{jeanKey:e});if(r.length<1)return!1;var o="gender"==e||"style"==e?e+"s":t("filter")(g.panel,{jeanKey:e})[0].dataKey,i=g.data[o];return dataById=t("filter")(i,{id:a}),"undefined"!=typeof dataById&&(selected=dataById[0],n?selected[n]:selected)},g.data={},g.getData=function(t,a){var n=e.defer();return i.jsonData[t]().then(function(e){g.data[a]=e.data,n.resolve(!0)}),n.promise},e.all([g.getData("getGenders","genders"),g.getData("getStyles","styles"),g.getData("getFabrics","fabrics"),g.getData("getThreads","threads")]).then(function(e){d.$watch(function(){return g.jean.data},function(e,t){g.updateActiveItem()},!0)}),g.saveJean=function(){console.log("save"),s.getCurrentUserFromLocalStorage().then(function(e){var t=e;g.createThumb().then(function(e){s.saveImageTos3(e,t).then(function(){console.log("creds refreshed")},function(e){console.log(e)})})},function(e){alert("you must be logged in to save!")})},g.createThumb=function(){var t=document.createElement("canvas");t.width=600,t.height=600;for(var a=t.getContext("2d"),n=[],r=document.getElementsByClassName("zoomed-image"),o=0;o<r.length;o++){var i=r[o];n.push(h(i.src,a))}return e.all(n).then(function(e){var a=t.toDataURL("image/jpeg");return a})}}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws"]}();
!function(){function n(n,a,e){n.jean=a.data}angular.module("bdApp").controller("homeCtrl",n),n.$inject=["$scope","jean","$animate"]}();
!function(){function e(e,s){var a=this;a.credentials={name:"",email:"",password:""},a.messages={message:"",type:"",set:function(e,s){a.messages.message=e,a.messages.type=s},reset:function(){a.messages.message="",a.messages.type=""}},a.validateLoginForm=function(){function e(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}return e(a.credentials.email)?!!a.credentials.password||(a.messages.set("Please enter a password","error"),!1):(a.messages.set("Please enter a valid Email address","error"),!1)},a.login=function(t,n){a.messages.reset(),a.validateLoginForm()&&s.authenticateCognitoUser(t,n).then(function(s){e.path("/closet")},function(e){"Incorrect username or password."==e.message&&(e.message="Incorrect Email address or password."),a.messages.set(e.message,"error")})},a.loginFB=function(){s.authenticateViaFB().then(function(s){e.path("/closet")},function(e){a.messages.set(e.message,"error")})},a.onSubmit=function(){a.errors.message="",authentication.login(a.credentials).error(function(e){console.log(e),a.errors.message=e.message}).then(function(){e.path("closet")})}}angular.module("bdApp").controller("loginCtrl",e),e.$inject=["$location","aws"]}();
!function(){function e(e,s,a){var t=this;t.credentials={name:"",email:"",password:""},t.formStep=1,t.messages={message:"",type:"",set:function(e,s){t.messages.message=e,t.messages.type=s},reset:function(){t.messages.message="",t.messages.type=""}},t.setMessage=function(e,s){t.messages.message=e,t.messages.type=s},t.resetMessage=function(){t.messages.message="",t.messages.type=""},t.validateRegistrationForm=function(){function e(e){var s=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return s.test(e)}function s(e){var s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return s.test(e)}return console.log("validatingf..."),t.credentials.email&&t.credentials.name&&t.credentials.password&&t.credentials.passwordConfirm?(e(t.credentials.password)||t.messages.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),t.credentials.password!==t.credentials.passwordConfirm?(t.messages.set("Password and Confirmation do not match","error"),!1):!!s(t.credentials.email)||(t.messages.set("Please Enter a valid E-mail address","error"),!1)):(console.log("this one!"),console.log(t.credentials),t.messages.set("All fields are required","error"),!1)},t.registerUser=function(){t.messages.reset(),t.validateRegistrationForm()&&s.signupForApplication(t.credentials.email,t.credentials.password).then(function(){t.formStep=2},function(e){t.messages.set(e.message,"error")})},t.confirmUser=function(){t.resetMessage(),s.confirmRegisteredUnauthenticatedUser(t.credentials.email,t.credentials.code).then(function(e){t.setMessage(a.trustAsHtml("Your Account has been confirmed. <a href='/login'>Click here to login</a>"),"success")},function(e){"Missing required key 'ConfirmationCode' in params"==e.message&&(e.message="Please enter confirmation code"),t.setMessage(e.message,"error")})},t.resendCode=function(){s.resendConfirmationCode(t.credentials.email),t.setMessage("A new confirmation code has been sent to "+t.credentials.email+". Enter the code above to confirm your account","success")}}angular.module("bdApp").controller("registerCtrl",e),e.$inject=["$location","aws","$sce"]}();
