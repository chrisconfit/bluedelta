...
!function(){function e(e,n,o,t){var r=o.createUserPool(t.poolInfo);console.log(r);var i=function(e){n.localStorage["mean-token"]=e},s=function(){return n.localStorage["mean-token"]},a=function(){var e,o=s();return!!o&&(e=o.split(".")[1],e=n.atob(e),e=JSON.parse(e),e.exp>Date.now()/1e3)},l=function(){if(a()){var e=s();console.log(e);var o=e.split(".")[1];return o=n.atob(o),o=JSON.parse(o),{email:o.email,name:o.name}}},c=function(){if(a()){var e=s(),o=e.split(".")[1];o=n.atob(o),o=JSON.parse(o),console.log(o);var t=o.permissions;return t.indexOf("admin")!==-1}};return awsRegisterUser=o.registerUser,register=function(n){return e.post("/api/register",n).success(function(e){console.log("register ran. Data => ",e),i(e.token)})},login=function(n){return e.post("/api/login",n).success(function(e){i(e.token)})},logout=function(){n.localStorage.removeItem("mean-token")},{awsRegisterUser:awsRegisterUser,isAdmin:c,currentUser:l,saveToken:i,getToken:s,isLoggedIn:a,register:register,login:login,logout:logout}}angular.module("bdApp").service("authentication",e),e.$inject=["$http","$window","aws","awsConfig"]}();
!function(){function t(t,e){return userAttributeConstructor=AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute,createUserAttributeList=function(t,e,r){var i=[];for(var o in t)r.indexOf(o)!==-1&&i.push(new e({Name:o,Value:t[o]}));return i},createUserPool=function(t){var e=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(t);return e},registerUser=function(t,e,r,i){var o=null;t.signUp(e,r,i,o,function(t,e){if(t)return void alert(t);e.user})},{userAttributeConstructor:userAttributeConstructor,createUserAttributeList:createUserAttributeList,createUserPool:createUserPool,registerUser:registerUser}}angular.module("bdApp").service("aws",t),t.$inject=["$http","$window"]}();
...
!function(){function e(e,r,t,o){var s=this,i=t.createUserPool(o.poolInfo);s.credentials={name:"",email:"",password:""},s.errors={message:""},s.onSubmit=function(){var o,n;n=["email"],o=t.createUserAttributeList(s.credentials,t.userAttributeConstructor,n),t.registerUser(i,s.credentials.email,s.credentials.password,o),console.log("Submitting registration"),r.register(s.credentials).error(function(e){console.log(e),s.errors.message=e.message}).then(function(){e.path("profile")})}}angular.module("bdApp").controller("registerCtrl",e),e.$inject=["$location","authentication","aws","awsConfig"]}();
