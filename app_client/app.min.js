...
!function(){function e(e,o,t,n){function r(){var e={UserPoolId:n.USER_POOL_ID,ClientId:n.CLIENT_ID},o=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(e);return o}function s(e,o){var t={Username:e,Password:o},n=new AWSCognito.CognitoIdentityServiceProvider.AuthenticationDetails(t);return n}function a(e,o){var t={Username:e,Pool:o},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUser(t);return n}function u(e,o){var t={Name:e,Value:o},n=new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(t);return n}function c(e,o){var t,n=[];for(var r in o)t=e(r,o[r]),n.push(t);return n}function l(e){logins={};var o="cognito-idp."+n.REGION+".amazonaws.com/"+n.USER_POOL_ID;return logins[o]=e,AWS.config.update({region:n.REGION}),AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID,Logins:logins}),AWS.config.credentials.getPromise()}return getUserFromLocalStorage=function(e){var o=a(e,r());null!=o&&o.getSession(function(e,o){return e?void alert(e):void console.log("session validity: "+o.isValid())})},deleteCognitoUser=function(){var e=r().getCurrentUser();e.deleteUser(function(e,o){return e?void alert(e):void console.log("call result: "+o)})},authenticateViaFB=function(){var e=t.defer();return FB.login(function(o){o.authResponse?(AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID,Logins:{"graph.facebook.com":o.authResponse.accessToken}}),e.resolve()):e.reject("There was a problem logging in with Facebook.")}),e.promise},authenticateCognitoUser=function(e,n){var i=s(e,n),u=a(e,r()),c=t.defer();return u.authenticateUser(i,{onSuccess:function(e){c.resolve(e),o.localStorage.isLoggedIn=!0},onFailure:function(e){c.reject(e)},newPasswordRequired:function(e,o){console.log(e,o)}}),c.promise},signupForApplication=function(e,o,n){var i=t.defer(),s=c(u,{email:e,name:o});console.log(s);return r().signUp(e,n,s,null,function(e,o){e?i.reject(e):i.resolve(o)}),i.promise},updateAttributesOnUser=function(e,o){var t=c(u,o),n=a(e,r());n.updateAttributes(t,function(e,o){return e?void alert(e):void console.log("call result: "+o)})},deleteUserAttributes=function(e,o){e.deleteAttributes(o,function(e,o){return e?void alert(e):void console.log("call result: "+o)})},verifyUserAttribute=function(e,o){e.getAttributeVerificationCode(o,{onSuccess:function(e){console.log("call result: "+e)},onFailure:function(e){alert(e)},inputVerificationCode:function(){var t=prompt("Please input verification code: ","");e.verifyAttribute(o,t,this)}})},retrieveUserAttributes=function(e){e.getUserAttributes(function(e,o){if(e)return void alert(e);for(i=0;i<o.length;i++)console.log("attribute "+o[i].getName()+" has value "+o[i].getValue())})},resendConfirmationCode=function(e){e.resendConfirmationCode||(e=a(e,r())),e.resendConfirmationCode(function(e,o){return!e||void console.log(e)})},confirmRegistration=function(e,o){e.confirmRegistration(o,!0,function(e,o){return e?void alert(e):void alert(o)})},changePassword=function(e,o,t){e.changePassword(o,t,function(e,o){return e?void alert(e):void console.log("call result: "+o)})},forgotPassword=function(e){var o=t.defer(),n=a(e,r());return n.forgotPassword({onSuccess:function(e){console.log("call result: "),console.log(e),o.resolve(e)},onFailure:function(e){o.reject(e),console.log(e)},inputVerificationCode:function(){var e=prompt("Please input verification code ",""),o=prompt("Enter new password ","");n.confirmPassword(e,o,this)}}),o.promise},setNewPassword=function(e,o,n){console.log("args"),console.log(e,o,n);var i=a(e,r());console.log("user"),console.log(i);var s=t.defer();return console.log(i.confirmPassword),i.confirmPassword(o,n,{onSuccess:function(e){console.log("setNewPass success!!"),console.log(e),s.resolve(e)},onFailure:function(e){console.log("setNewPass error!!"),console.log(e),s.reject(e)}}),s.promise},deleteUser=function(e){e.deleteUser(function(e,o){return e?void alert(e):void console.log("call result: "+o)})},signUserOut=function(e){null!=e&&e.signOut()},signCurrentUserOut=function(){var e=r().getCurrentUser();null!=e&&(e.signOut(),o.localStorage.isLoggedIn=!1)},signUserOutGlobally=function(e){o.localStorage.isLoggedIn=!1,e.globalSignOut()},getCurrentUserFromLocalStorage=function(){var e=r().getCurrentUser();return null!=e?e.getSession(function(e,o){return e?(console.log(e),!1):o}):(console.log("You are not logged in"),!1)},isLoggedIn=function(){var e=r().getCurrentUser();return!!e},agetCurrentUserFromLocalStorage=function(){var e=r().getCurrentUser();return null!=e&&void e.getSession(function(e,o){return!e&&(AWS.config.credentials=new AWS.CognitoIdentityCredentials({IdentityPoolId:n.IDENTITY_POOL_ID}),o)})},confirmRegisteredUnauthenticatedUser=function(e,o){var n=a(e,r()),i=t.defer();return n.confirmRegistration(o,!0,function(e,o){e?i.reject(e):i.resolve(o)}),i.promise},changePassword=function(e,o,t){e.changePassword(o,t,function(e,o){return e?void alert(e):void console.log("call result: "+o)})},saveImageTos3=function(e,o){function r(e){for(var o=atob(e.split(",")[1]),t=[],n=0;n<o.length;n++)t.push(o.charCodeAt(n));return new Blob([new Uint8Array(t)],{type:"image/jpeg"})}var i=t.defer();return l(o.idToken.jwtToken).then(function(){var o=r(e),t="blue-delta-api-development-stack-userdatabucket-12z57hiicf3xy",s=new AWS.S3({region:n.REGION,params:{Bucket:t}}),a={Key:AWS.config.credentials.identityId+"/myfilename.png",Body:o};s.upload(a,function(e,o){e?i.reject(e):i.resolve(o.Location)})},function(e){i.reject(e)}),i.promise},{authenticateViaFB:authenticateViaFB,getUserFromLocalStorage:getUserFromLocalStorage,deleteCognitoUser:deleteCognitoUser,authenticateCognitoUser:authenticateCognitoUser,signupForApplication:signupForApplication,updateAttributesOnUser:updateAttributesOnUser,deleteUserAttributes:deleteUserAttributes,verifyUserAttribute:verifyUserAttribute,retrieveUserAttributes:retrieveUserAttributes,resendConfirmationCode:resendConfirmationCode,confirmRegistration:confirmRegistration,changePassword:changePassword,forgotPassword:forgotPassword,setNewPassword:setNewPassword,deleteUser:deleteUser,signUserOut:signUserOut,signUserOutGlobally:signUserOutGlobally,getCurrentUserFromLocalStorage:getCurrentUserFromLocalStorage,confirmRegisteredUnauthenticatedUser:confirmRegisteredUnauthenticatedUser,signCurrentUserOut:signCurrentUserOut,saveImageTos3:saveImageTos3,isLoggedIn:isLoggedIn}}angular.module("bdApp").service("aws",e),e.$inject=["$http","$window","$q","AWSConfig"]}();
...
!function(){function e(e,t,a,r){function o(e){var t=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return t.test(e)}function n(e){var t=/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,50}$/;return t.test(e)}var s=this;console.log(r),s.messages=a.get(),s.credentials={loginEmail:"",loginPassword:""},s.login=function(o,n){a.reset(),s.validateLoginForm()&&(console.log("valid"),t.authenticateCognitoUser(o,n).then(function(t){r.callback&&r.callback(),r.redirect&&e.path(r.redirect),r.callback||r.redirect||e.path("/customizer")},function(e){"Incorrect username or password."==e.message&&(e.message="Incorrect Email address or password."),a.set(e.message,"error")}))},s.validateLoginForm=function(){return o(s.credentials.loginEmail)?!!s.credentials.loginPassword||(a.set("Please enter a password","error"),!1):(a.set("Please enter a valid Email address","error"),!1)},s.forgotPassword=!1,s.forgotPassword2=!1,s.forgot=function(){a.reset(),s.validateForgot()&&t.forgotPassword(s.credentials.loginEmail).then(function(e){s.forgotPassword2=!0},function(e){"Username/client id combination not found"==e.message&&(e.message="We don't have an account registered for that emial"),a.set(e.message,"error")})},s.validateForgot=function(){return!!o(s.credentials.loginEmail)||(a.set("Please enter a valid Email address","error"),!1)},s.forgot2=function(){a.reset(),s.validateForgot2()&&t.setNewPassword(s.credentials.loginEmail,s.credentials.loginVerifcation,s.credentials.newPassword).then(function(e){console.log(e)},function(e){a.set(e.message,"error")})},s.validateForgot2=function(){return o(s.credentials.loginEmail)?s.credentials.loginVerifcation?(n(s.credentials.newPassword)||a.set('A valid password must: <ul><li>Be between 6 and 50 characters</li><li>Contain at least one number</li><li>Contain at least one uppercase letter</li><li>Contain at least one lowercase letter</li><li>Contain at least one special character ("!,@,#,$,%,^,&, or *")</li>'),s.credentials.newPassword===s.credentials.newPasswordConfirm||(a.set("Password and Confirmation do not match","error"),!1)):(a.set("Please enter your verifcation code","error"),!1):(a.set("Please enter a valid Email address","error"),!1)},s.loginFB=function(){t.authenticateViaFB().then(function(t){e.path("/closet")},function(e){a.set(e.message,"error")})}}angular.module("bdApp").controller("loginFormCtrl",e),e.$inject=["$location","aws","messages","$scope"]}();
...
!function(){function o(o,e,r,a,n,t){var l=this;l.loader=t.get("loader"),l.saver=t.get("saver"),l.drops={},l.drops.acct=!1,l.mobileMenu=!1,l.isLoggedIn=JSON.parse(n.localStorage.isLoggedIn),l.logout=function(){a.signCurrentUserOut(),"/"==o.path()&&e.reload()}}angular.module("bdApp").controller("navigationCtrl",o),o.$inject=["$location","$route","popups","aws","$window","loader"]}();
...
!function(){function e(e,a,o,r,n,s,t,u,i){function l(e){var a=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return a.test(e)}function c(e){var a=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return e.match(a)}i.show("Getting your profile information...");var d=this;o.closeAll(),d.popups=o.get(),d.messages=u.get(),d.jean=a,d.data=t.getData(),d.jeans=d.data.jeansList,d.onload=function(){s.vm=d},d.userForm={},d.userForm.editing={},d.userForm.saving={},d.userForm.feedback={type:"",message:""},d.userForm.cancel=function(e){console.log(e),d.userForm.editing[e]=!1,d.user[e]=d.userForm.data[e]},d.userForm.validate=function(e,a){return"email"==e?!!l(a)||(u.set("Please enter a valid email address","error"),!1):"phoneNumber"!=e||(!!c(a)||(u.set("Please enter a valid phone number","error"),!1))},d.userForm.save=function(e){d.userForm.validate(e,d.user[e])&&(d.userForm.saving[e]=!0,n.usersUpdate(d.user.identityId,d.user).then(function(a){d.userForm.saving[e]=!1,d.userForm.editing[e]=!1,d.userForm.data[e]=d.user[e],s.$apply()},function(e){console.log(e)}))};var p=r.getCurrentUserFromLocalStorage();if(p){n.defaultHeaders_.Authorization=p.idToken.getJwtToken();var m=p.idToken.jwtToken.split(".")[1],g=JSON.parse(atob(m)).sub;n.usersGet(g).then(function(e){i.hide(),d.user=e.data,console.log(d.user),d.userForm.data=angular.copy(e.data),s.$apply(),console.log(d.user)},function(e){console.log(e)})}else e.path("/");d.copyJean=function(){d.jean=a.createNew(d.displayJean),e.path("/customizer")},d.displayJean={},d.selectJean=function(e){d.popups.jeanProfile=!0,d.displayJean.data=e}}angular.module("bdApp").controller("closetCtrl",e),e.$inject=["$location","jean","popups","aws","bdAPI","$scope","jsonData","messages","loader"]}();
!function(){function n(n,a,e){n.jean=a.data}angular.module("bdApp").controller("homeCtrl",n),n.$inject=["$scope","jean","$animate"]}();
!function(){function e(e,a,t,n,o,r,i,l,s,c,d,p,u,h){function g(){var e=navigator.userAgent.toLowerCase(),a=e.indexOf("android")>-1;if(a){if(0==window.orientation||180==window.orientation)return!0;if(90==window.orientation||window.orientation==-90)return!1}else{if(90==window.orientation||window.orientation==-90)return!0;if(0==window.orientation||180==window.orientation)return!1}}function v(a,t){return e(function(e,n){var o=new Image;o.src=a,o.onload=function(){t.drawImage(o,0,0,600,696),e(o)},o.onerror=function(e){n(e)}})}var f=this;f.loader=h.get(),u.reset(),f.messages=u.get(),c.closeAll(),f.popups=c.get(),f.landscape=g();var m="onorientationchange"in window,w=m?"orientationchange":"resize";window.addEventListener(w,function(){f.landscape=g(),s.$apply()},!1),f.jean={data:l.setup()},f.data=p.getData(),s.$watch(function(){return f.jean.data},function(e,a){f.updateActiveItem()},!0),s.$watch(function(){return f.data},function(e,a){f.updateActiveItem()},!0),f.activeItem={},f.updateActiveItem=function(){var e=f.data[f.panel[f.panelStep].dataKey],t=f.jean.data[f.panel[f.panelStep].jeanKey],n=a("filter")(e,{id:t});n&&(n=n[0]),f.activeItem=n||null},f.panel=[],f.panel.push({panelTemplate:"gender-chooser",dataKey:"genders",title:"Gender",jeanKey:"gender"}),f.panel.push({panelTemplate:"style-chooser",dataKey:"styles",title:"Style",jeanKey:"style"}),f.panel.push({panelTemplate:"fabric-chooser",dataKey:"fabrics",title:"Fabric",jeanKey:"fabric"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Top Thread",jeanKey:"top_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Bottom Thread",jeanKey:"bottom_thread"}),f.panel.push({panelTemplate:"chooser",dataKey:"threads",title:"Accent Thread",jeanKey:"accent_thread"}),f.panel.push({panelTemplate:"list",title:"Overview"}),f.panelDir="next",f.panelStep=0,f.changeStep=function(e){return!(e>=f.panel.length)&&(!(e<0)&&(void 0!==e&&(f.panelStep=e,void(e+1!=f.panel.length&&f.updateActiveItem()))))},f.orderCallback=function(){f.saveCallback(function(){n.path("/order")})},f.placeOrder=function(){return d.isLoggedIn()?void f.saveCallback(function(){n.path("/order")}):(f.authCallback=f.orderCallback,c.set("loginOrRegister",!0),!1)},f.createThumb=function(){var a=document.createElement("canvas");a.width=600,a.height=600;for(var t=a.getContext("2d"),n=[],o=document.getElementsByClassName("zoomed-image"),r=0;r<o.length;r++){var i=o[r];n.push(v(i.src,t))}return e.all(n).then(function(e){var t=a.toDataURL("image/jpeg");return t})},f.saveCallback=function(e){c.closeAll(),h.show("saver"),f.createThumb().then(function(a){var t=d.getCurrentUserFromLocalStorage();t?(console.log("U:"+t),d.saveImageTos3(a,t).then(function(a){h.hide("saver"),l.set("saved",!0),l.set("saved_at",new Date),l.set("image",a),l.save(),e&&e(a)},function(e){console.log(e)})):(f.savingBar=!1,f.authCallback=f.saveCallback,c.set("loginOrRegister",!0))})},f.saveJean=function(){return d.isLoggedIn()?void f.saveCallback():(f.authCallback=f.saveCallback,c.set("loginOrRegister",!0),!1)},f.authCallback=f.orderCallback}angular.module("bdApp").controller("customizerCtrl",e),e.$inject=["$q","$filter","$timeout","$location","$window","$routeParams","bdAPI","jean","$scope","popups","aws","jsonData","messages","loader"]}();
