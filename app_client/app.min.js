...
!function(){function e(e,t,o,r){var n=this;o.createUserPool(r.poolInfo);n.credentials={name:"",email:"",password:""},n.errors={message:""},n.onSubmit=function(){console.log("testing aws method"),o.createUserAttributeList(n.credentials,o.createUserAttribute),console.log("Submitting registration"),t.register(n.credentials).error(function(e){console.log(e),n.errors.message=e.message}).then(function(){e.path("profile")})}}angular.module("bdApp").controller("registerCtrl",e),e.$inject=["$location","authentication","aws","awsConfig"]}();
