...
!function(){function e(e,t,a,n,r,o){function c(e){switch(e){case"g":return"gender";case"s":return"style";case"f":return"fabric";case"tt":return"top_thread";case"tb":return"bottom_thread";case"ta":return"accent_thread";default:return!1}}function s(e){switch(e){case"gender":return"g";case"style":return"s";case"fabric":return"f";case"top_thread":return"tt";case"bottom_thread":return"tb";case"accent_thread":return"ta";default:return!1}}function d(e,t){return n(function(a,n){var r=new Image;r.src=e,r.onload=function(){t.drawImage(r,0,0,600,696),a(r)},r.onerror=function(e){n(e)}})}var u=function(e,t){var a=o[e];if(!a)return!1;for(i=0;i<a.length;i++)if(a[i][e+"Id"]==t)return a[i]};jeanData={},set=function(e,t){jeanData[e]=t,this.saved=!1},createNew=function(e){e&&e.constructor==Object?jeanData={gender:e.gender,style:e.style,fabric:e.fabric.fabricId,accent_thread:e.accent_thread.threadId,top_thread:e.top_thread.threadId,bottom_thread:e.bottom_thread.threadId}:(jeanData={gender:1,style:1,fabric:u("fabric",1004),accent_thread:u("thread",1),top_thread:u("thread",1),bottom_thread:u("thread",1)},jeanData.saved=!1)};var l=function(t){var n=this;if(t)jeanData=t;else if(e.jeanId&&!e.userId){if(e.jeanId.indexOf(":")>0){createNew(),jeanData=e.jeanId.split(":");for(var o=0;o<jeanData.length;o++){var s=jeanData[o].match(/([A-Za-z]+)([0-9]+)/);if(s){var d=c(s[1]);d&&(jeanData[d]=parseInt(s[2]))}}}}else e.jeanId&&e.userId?(console.log(e.jeanId,e.userId),a.jeansGet(e.userId,e.jeanId).then(function(t){console.log("result"),console.log(t.data);var o=t.data,c=r.getCurrentUserFromLocalStorage();if(c){var s=a.setupHeaders(c);s==e.userId?(console.log(o),console.log(n.jeanData),n.jeanData=o,console.log(n.jeanData)):createNew(o)}else createNew(o)},function(e){console.log(e),createNew()})):0===Object.keys(jeanData).length&&jeanData.constructor===Object&&createNew()},g=function(){return jeanData};createThumb=function(e){console.log(e);var t=document.createElement("canvas");t.width=600,t.height=600;var a=t.getContext("2d"),r=[],o=["/images/components/fabric/g"+e.gender+"/s2/f"+e.fabric.fabricId+".jpg","/images/components/thread/g"+e.gender+"/s2/tb/"+e.bottom_thread.threadId+".png","/images/components/thread/g"+e.gender+"/s2/tt/"+e.top_thread.threadId+".png","/images/components/thread/g"+e.gender+"/s2/ta/"+e.accent_thread.threadId+".png"];console.log(o);for(var c=0;c<o.length;c++)r.push(d(o[c],a));return n.all(r).then(function(e){var a=t.toDataURL("image/jpeg");return a},function(e){console.log(e)})},getDataCode=function(){var e="";for(var t in jeanData)if(jeanData.hasOwnProperty(t)){var a=jeanData[t];if("object"==typeof a){var n=t+"Id";n.indexOf("Thread")>-1&&(n="threadId"),a=a[n]}var r=s(t);r&&(e+="_"+r+a)}return e=e.replace(/(^[_\s]+)|([_\s]+$)/g,"")};var f=function(e,t,n){console.log(e,t,n);var o=r.getCurrentUserFromLocalStorage();a.defaultHeaders_.Authorization=o.idToken.getJwtToken(),a.jeansDelete(e,t).then(function(e){n&&n(e)},function(e){console.log(e)})},h=function(){console.log("save");var e=n.defer(),t=this;console.log(this);var o=t.get();console.log(o);var c=t.getDataCode();return c+=".jpg",this.createThumb(o).then(function(n){var s=r.getCurrentUserFromLocalStorage();a.defaultHeaders_.Authorization=s.idToken.getJwtToken();var d=s.idToken.jwtToken.split(".")[1],u=JSON.parse(atob(d)).sub;s?r.saveImageTos3(n,s,c).then(function(n){t.set("imageURL",n),o.jeanId?(console.log("update"),a.jeansUpdate(u,o.jeanId,o).then(function(t){e.resolve(t)},function(t){console.log(t),e.reject(t)})):(console.log("create"),console.log(o),a.jeansCreate(u,o).then(function(a){console.log(a),t.set("jeanId",a.data.jeanId),e.resolve(a)},function(t){console.log(t),e.reject(t)}))},function(t){console.log(t),e.reject(t.message)}):e.reject("You are not logged in...")}),e.promise};return{dataLookup:u,deleter:f,save:h,get:g,setup:l,set:set,createNew:createNew,getDataCode:getDataCode,createThumb:createThumb}}angular.module("bdApp").service("jean",["$routeParams","$http","bdAPI","$q","aws","jsonData",e])}();
