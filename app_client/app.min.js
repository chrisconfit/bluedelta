...
!function(){function e(e,t){var o=this;o.jean=t,o.centerPan=!1,o.zoom=!1,o.pan="0% 30% 0",o.isMobile=function(){return e.innerWidth<800},o.toggleZoom=function(){o.zoom=!o.zoom},o.returnPan=function(){return!o.isMobile()&&(o.pan="50% 30% 0",o.centerPan=!0,images=angular.element(document.querySelectorAll("#zoom-frame img")),void setTimeout(function(){images.css({"transform-origin":o.pan})},200))},o.touchStart=function(e){var t=e.touches[0].clientX/e.touches[0].target.clientWidth*100,n=e.touches[0].clientY/e.touches[0].target.clientHeight*100;t>100&&(t=100),t<0&&(t=0),n>100&&(n=100),n<0&&(n=0),o.pan=t+"% "+n+"% 0",images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":o.pan})},o.touchMove=function(e){var t=e.touches[0].clientX/e.touches[0].target.clientWidth*100,n=e.touches[0].clientY/e.touches[0].target.clientHeight*100;t>100&&(t=100),t<0&&(t=0),n>100&&(n=100),n<0&&(n=0),o.pan=t+"% "+n+"% 0",images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":o.pan})},o.zoomDrag={x:0,y:0},o.dragTracker={x:0,y:0},o.panDirection=!1,o.dragPan=function(e,t){if(console.log(t.direction),!o.isMobile())return!1;if(!o.zoom)return!1;var n=angular.element(document.querySelectorAll("#zoom-frame img")),i=(window.innerHeight,n[0].height,{width:t.target.clientWidth,height:t.target.clientHeight}),r={x:t.deltaX,y:t.deltaY},a=r.x-o.dragTracker.x,c=r.y-o.dragTracker.y;console.log(a,c);var a=Math.abs(a)/i.width*100;a=r.x<0?-a:a;var c=Math.abs(c)/i.height*100;c=r.y<0?-c:c,a+=o.zoomDrag.x,c+=o.zoomDrag.y;var m={y:{},x:{}};m.y.top=60,m.y.bottom=-90,m.x.left=-150,m.x.right=60,c>m.y.top&&(c=m.y.top),c<m.y.bottom&&(c=m.y.bottom),a<m.x.left&&(a=m.x.left),a>m.x.right&&(a=m.x.right);var l={x:a,y:c};console.log(l),o.zoomDrag=l;var g=-a+"% "+-c+"% 0";n.css({"transform-origin":g}),o.dragTracker=t.isFinal?{x:0,y:0}:r},o.scanImage=function(t,n){setTimeout(function(){o.centerPan=!1},200),frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(t-offsetL)/fWidth*100,yPosition=(n-offsetT)/fHeight*100,e.innerWidth<o.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",o.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},o.trackMouse=function(e){return!o.isMobile()&&void o.scanImage(e.pageX,e.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","jean"]}();
