...
!function(){function e(e,t,o,r,l,n){function c(e,t,o){e=e[0],t=t-e.offsetWidth/2+40;var r=e.scrollWidth-e.offsetWidth;t>=r&&(t=r-1),t==r&&(t=r-1);var l=Math.ceil(o/15),n=t-e.scrollLeft,c=n/l,s=e.scrollLeft<t?function(e,t){return e<=t-1}:function(e,t){return e>=t+1},a=setInterval(function(){if(s(e.scrollLeft,t)){var o=e.scrollLeft+c;o>=r&&(o=r-1),e.scrollLeft=o}else clearInterval(a)},15)}var s=this;s.popups=n,s.jean=l,s.breakPoint=800,s.selectorCoords={top:0,left:0},e.$watch("active",function(e,l){1==e&&(console.log(s.selectorCoords),o(function(){var e=angular.element(t[0].querySelector(".chooser-select")),o=angular.element(t[0].querySelector(".chooser-grid"));if(console.log(s.selectorCoords),r.innerWidth<s.breakPoint){var l=e.prop("offsetLeft");l=l-o[0].offsetWidth/2+40,o[0].scrollLeft=l}else{var n=e.prop("offsetTop");console.log(n),console.log(e[0].offsetTop),o[0].scrollTop=e.offsetTop}},200))}),s.selectAttr=function(e,t,l,n){var a=angular.element(document.querySelector("#"+l+"-chooser")),n=angular.element(document.querySelector("#"+l+"-selector")),f=angular.element(e.target).prop("offsetTop"),i=angular.element(e.target).prop("offsetLeft"),u=angular.element(document.querySelectorAll("#item-title"));u.css({right:"-400px",opacity:0}),n.css({top:f+"px",left:i+"px"}),s.selectorCoords[l]={top:f,left:i},r.innerWidth<s.breakPoint&&c(a,i,200),o(function(){u.css({right:"15px",opacity:1}),s.jean.data[l]=t},200)},s.jeanSet=function(e,t){s.jean.data[e]=t}}angular.module("meanApp").controller("chooserCtrl",e),e.$inject=["$scope","$element","$timeout","$window","jean","popups"]}();
