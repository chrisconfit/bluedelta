...
!function(){function e(e,t){var o=this;o.jean=t,o.centerPan=!1,o.zoom=!1,o.pan="0% 30% 0",o.breakPoint=800,o.toggleZoom=function(){left=o.zoom?"50%":"0",o.zoom=!o.zoom;var e=angular.element(document.querySelectorAll("#zoom-frame img"));e.css("left",left),e.css("bottom","-175px")},o.returnPan=function(){o.pan="50% 30% 0",o.centerPan=!0,images=angular.element(document.querySelectorAll("#zoom-frame img")),setTimeout(function(){images.css({"transform-origin":o.pan})},200)},o.drag=function(e){console.log("dragger"),console.log(e)},o.scale=1,o.xImage=0,o.yImage=0,o.zoomDrag={x:0,y:0},o.dragTracker={x:0,y:0},o.yLast=0,o.myDrag=function(e,t){var n=angular.element(document.querySelectorAll("#zoom-frame img")),r=({width:t.target.clientWidth,height:t.target.clientHeight},window.innerHeight,n[0].height),a=1.7*r,i={y:{},x:{}};if(console.log(a),i.y.bottom=-(.225*a),i.y.top=a/2+175,i.x.left=-(t.target.clientWidth-.05*t.target.clientWidth),i.x.right=t.target.clientWidth-.05*t.target.clientWidth,console.log(i.y),!o.zoom)return!1;var c={x:t.deltaX,y:t.deltaY},l=c.x-o.dragTracker.x,m=c.y-o.dragTracker.y;l+=o.zoomDrag.x,m+=o.zoomDrag.y,console.log(m),m>i.y.top&&(m=i.y.top),m<i.y.bottom&&(m=i.y.bottom),l<i.x.left&&(l=i.x.left),l>i.x.right&&(l=i.x.right);var g={x:l,y:m};o.zoomDrag=g,console.log("move:"),n.css("left",g.x+"px"),n.css("bottom",-g.y+"px"),o.dragTracker=t.isFinal?{x:0,y:0}:c},o.scanImage=function(t,n){setTimeout(function(){o.centerPan=!1},200),frame=angular.element(document.querySelector("#zoom-frame"))[0],fWidth=frame.clientWidth,fHeight=frame.clientHeight,rect=frame.getBoundingClientRect(),rootDoc=frame.ownerDocument.documentElement,offsetT=rect.top+e.pageYOffset-rootDoc.clientTop,offsetL=rect.left+e.pageXOffset-rootDoc.clientLeft,xPosition=(t-offsetL)/fWidth*100,yPosition=(n-offsetT)/fHeight*100,e.innerWidth<o.breakPoint?pan=100-xPosition+"% "+(100-yPosition)+"% 0":pan=xPosition+"% "+yPosition+"% 0",o.pan=pan,images=angular.element(document.querySelectorAll("#zoom-frame img")),images.css({"transform-origin":pan})},o.trackMouse=function(t){return!(e.innerWidth<o.breakPoint)&&void o.scanImage(t.pageX,t.pageY)}}angular.module("meanApp").controller("istackCtrl",e),e.$inject=["$window","jean"]}();
